...
`rustfmt` does not format code inside macro invocations. This applies to any macro that contains Rust code,
such as `lazy_static!`, `stream!`, etc. Make sure the code inside the macro is formatted correctly.
