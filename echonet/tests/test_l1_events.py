...
class TestL1Events(unittest.TestCase):
    ...
    def test_decode_log_success(self):
        ...
        self.assertEqual(decoded_log_result.from_address, "0x23a2aac5d0fa69e3243994672822ba43e34e5c9")
        self.assertEqual(
            decoded_log_result.to_address,
            0x07C76A71952CE3ACD1F953FD2A3FDA8564408B821FF367041C89F44526076633,
        )
        self.assertEqual(
            decoded_log_result.selector, 0x02D757788A8D8D6F21D1CD40BCE38A8222D70654214E96FF95D8086E684FBEE5
        )
