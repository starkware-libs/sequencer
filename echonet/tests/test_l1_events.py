...
class TestDecodeLog(unittest.TestCase):
    def test_decode_log_message_to_l2_success(self):
        # Fetched log of block 0x13e51a0 (20,861,344) using eth_getLogs with Starknet contract address.
        log = {
        ...
        # Verify non-indexed params (from data, decoded via eth_abi)
