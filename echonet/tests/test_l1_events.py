...
class TestL1Events(unittest.TestCase):
    ...
    L1_EVENT_SAMPLE = L1Events.L1Event(
    ...
    DECODED_LOG = L1Events.DecodedLogMessageToL2(
        from_address="0x23a2aac5d0fa69e3243994672822ba43e34e5c9",
        to_address="0x7c76a71952ce3acd1f953fd2a3fda8564408b821ff367041c89f44526076633",
        ...
        nonce=0x195C23,
        fee=1,
        l1_tx_hash="0x66c2ef5ae6708ede5e47daaabfc4b54a53c423160ec27eac06524ea3cd939622",
        block_timestamp=0x66FA358F,
    )

    L1_EVENT = L1Events.L1Event(
        tx=L1Events.L1HandlerTransaction(
            contract_address="0x7c76a71952ce3acd1f953fd2a3fda8564408b821ff367041c89f44526076633",
            entry_point_selector=0x02D757788A8D8D6F21D1CD40BCE38A8222D70654214E96FF95D8086E684FBEE5,
            calldata=[
                0x23A2AAC5D0FA69E3243994672822BA43E34E5C9,
                0x001E220C4AC08B2F247D45721E08AF1B2D8D65B640CEA780534C8F20DC6EA981,
                0x000000000000000000000000000000000000000000001C468E3281804CCA0000,
                0,
            ],
