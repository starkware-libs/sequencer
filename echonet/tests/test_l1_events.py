...
class TestL1Events(unittest.TestCase):
    ...
    SAMPLE_DECODED_LOG = L1Client.Log(
        address="0xc662c410c0ecf747543f5ba90660f6abebd9c8c4",
        topics=[
            "0xdb80dd488acf86d17c747445b0eabb5d57c541d3bd7b6b87af987858e5066b2b",
            "0x000000000000000000000000023a2aac5d0fa69e3243994672822ba43e34e5c9",
    ...
    def test_decode_log_success(self):
        decoded_log_result = L1Events.decode_log(self.SAMPLE_DECODED_LOG)
    ...
    def test_decode_log_wrong_signature_raises_error(self):
        log = copy.deepcopy(self.SAMPLE_DECODED_LOG)
    ...
    def test_parse_event_success(self):
        result = L1Events.parse_event(self.SAMPLE_DECODED_LOG)

        self.assertIsInstance(result, L1Events.L1Event)
        self.assertIsInstance(result.tx, L1Events.L1HandlerTransaction)
        self.assertEqual(
