...
class TestL1Manager(unittest.TestCase):
    ...
    def _process_feeder_tx_and_store_l1_block(self, l1_block_number: int):
        """Simulates processing a feeder transaction and storing its matched L1 block data."""
    ...
    def test_multiple_blocks(self):
        ...
        for block_num in [10, 20, 30]:
            self._process_feeder_tx_and_store_l1_block(block_num)
