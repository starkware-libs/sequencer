...
# ≥6 workers to clear the queue. Memory budget (post cende-commitment-delta:
# p99 blob ~20 MB, typical subprocess ~300 MB, p99 ~2 GB): 6 workers worst-case
# ≈ 12 GiB + flask + cache ≈ 16 GiB, comfortably under the 32 GiB limit when
# the pod lands on an n4-standard-8 node (see deployment.yaml `requests`).
_OS_RUN_PARALLELISM = 6
