...
class _TxTracker:
    ...
    tx_timestamps_and_block_numbers: Dict[
        str, Dict[str, int]
    ...
    def empty(cls) -> "_TxTracker":
        return cls(
            currently_pending={},
            tx_timestamps_and_block_numbers={},
    ...
    def record_committed(self, tx_hash: str, block_number: int) -> None:
        ...
        self.tx_timestamps_and_block_numbers.pop(tx_hash, None)
...
class SharedContext:
    ...
    def record_sent_tx_timestamps_and_block_numbers_for_block(
        self, txs: Sequence[JsonObject], timestamp: int, block_number: int
    ) -> None:
        with self._lock:
            for tx in txs:
                self._tx.tx_timestamps_and_block_numbers[tx["transaction_hash"]] = {
                    "timestamp": timestamp,
                    "block_number": block_number,
                }
    ...
    def get_sent_tx_timestamp_and_block_number(self, tx_hash: str) -> Dict[str, int]:
        with self._lock:
            return self._tx.tx_timestamps_and_block_numbers[tx_hash]
    ...
    def clear_for_resync(self) -> None:
        ...
        with self._lock:
            ...
            self._tx.tx_timestamps_and_block_numbers.clear()
