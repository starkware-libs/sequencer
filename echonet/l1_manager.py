...
class L1Manager:
    def update_cache(self, feeder_gateway_tx: dict) -> None:
        """
        Gets a feeder gateway transaction and updates the cache with info retrieved from L1.
        """
        pass

    def get_logs(self, filter: Any) -> dict:
        """
