    ...
    *,
    ...
    try:
        response = requests.post(
            webhook_url, json=payload, timeout=_SLACK_POST_TIMEOUT_SECONDS
        )
...
def _build_slack_payload(
    *,
    ...
    repeat_marker = " (repeated trigger — previous resync did not clear it)" if is_repeated_trigger else ""
