...
class FeederClientConfig:
    ...
    base_url: str = consts.CONFIG.feeder.base_url
...
class FeederClient:
    ...
    def __init__(
        ...
        *,
        ...
        self._headers: Dict[str, str] = (
            dict(headers) if headers is not None else dict(consts.CONFIG.feeder.headers)
        )
    ...
    def _get_json(self, endpoint: str, *, params: Mapping[str, Any]) -> JsonDict:
    ...
    def get_block(
        ...
        *,
        ...
        return self._get_json(consts.CONFIG.feeder.endpoints.get_block, params=params)

    def get_state_update(self, block_number: int) -> JsonDict:
        return self._get_json(
            consts.CONFIG.feeder.endpoints.get_state_update,
            params={"blockNumber": int(block_number)},
        )

    def get_signature(self, block_number: int | str) -> JsonDict:
        return self._get_json(
            consts.CONFIG.feeder.endpoints.get_signature, params={"blockNumber": block_number}
        )

    def get_transaction(self, transaction_hash: str) -> JsonDict:
        return self._get_json(
            consts.CONFIG.feeder.endpoints.get_transaction,
    ...
    def get_class_by_hash(
        ...
        return self._get_json(consts.CONFIG.feeder.endpoints.get_class_by_hash, params=params)
    ...
    def get_compiled_class_by_class_hash(
        ...
        if block_number:
            params["blockNumber"] = block_number
        return self._get_json(
            consts.CONFIG.feeder.endpoints.get_compiled_class_by_class_hash, params=params
        )
