...
def parse_command_line_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--values_file", action="store", default=None, help="Add additional values file."
    )
    parser.add_argument(
        "--with_alerts",
        action="store_true",
...
def main() -> None:
    ...
    if args.with_alerts:
        assert (
            args.prometheus_uid is not None
        ), "Must provide Prometheus UID when deploying with Grafana."
