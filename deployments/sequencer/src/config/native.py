...
JPATH pointed at `deployments/sequencer/configs/jsonnet`) and selects the requested service (mapping
...
JSONNET_DIR = REPO_ROOT / "deployments" / "sequencer" / "configs" / "jsonnet"
