...
DEFAULT_ROLLING_UPDATE_MAX_SURGE = "25%"
DEFAULT_ROLLING_UPDATE_MAX_UNAVAILABLE = "25%"
DEFAULT_ROLLING_UPDATE_PARTITION = 0
RECREATE_ROLLING_UPDATE_MAX_UNAVAILABLE = "100%"
