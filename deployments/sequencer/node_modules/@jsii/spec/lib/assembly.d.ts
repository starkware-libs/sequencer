 ...
 */
export declare const SPEC_FILE_NAME = ".jsii";
/**
 * Expected file name for compressed assemblies.
 */
export declare const SPEC_FILE_NAME_COMPRESSED = ".jsii.gz";
/**
 * A JSII assembly specification.
 */
export interface Assembly extends AssemblyConfiguration, Documentable, ReadMeContainer {
    /**
     ...
     */
    dependencyClosure?: {
        [assembly: string]: DependencyConfiguration;
    };
    /**
 ...
 */
export type Submodule = ReadMeContainer & SourceLocatable & Targetable & TypeScriptLocatable;
/**
 ...
 * A list of all jsii extension features
 */
export declare const ALL_TYPESYSTEM_ENFORCED_FEATURES: string[];
/**
