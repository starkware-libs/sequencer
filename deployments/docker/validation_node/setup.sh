...
choices = {
    ...
    "validator_id":                 ${VALIDATOR_ID@Q},
    "ordered_l1_endpoint_urls":     ${L1_ENDPOINT_URLS@Q},
    "url_header_list":              ${ETH_TO_STRK_ORACLE_URLS@Q},
    "consensus_advertised_multiaddr": ${CONSENSUS_ADVERTISED_MULTIADDR@Q},
...
collect_user_values() {
  ...
  The 'timestamp' parameter is appended automatically at query time" \
        "|"
