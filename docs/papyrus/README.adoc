...
-----
mkdir data
cargo run --release --package papyrus_node --bin papyrus_node -- --base_layer_url <ethereum_node_url>
-----
+
[NOTE]
====
...
----
cargo run --release --package papyrus_node --bin papyrus_node -- --base_layer_url <ethereum_node_url> --config-file <path_to_custom_configuration_file_1> <path_to_custom_configuration_file___n__>
----
...
[source,bash,subs="verbatim,quotes"]
----
cargo run --release --package papyrus_node --bin papyrus_node -- --base_layer_url <ethereum_node_url> --config-file /config/presets/sepolia_testnet.json
----
...
docker run --rm --name papyrus\
  ...
  --base_layer_url <ethereum_node_url>
----
+
[NOTE]
====
...
cargo run --release --package papyrus_node --bin papyrus_node -- \
        ...
        --network.bootstrap_peer_multiaddr /ip4/<other_peer_ip_address>/tcp/<port>/p2p/<peer_id>
----

You can also use DNS instead of ip4 by typing 
----
        --network.bootstrap_peer_multiaddr /dns/<other_peer_dns_address>/tcp/<port>/p2p/<peer_id>
----
