...
const DEFAULT_LOG_ATTEMPT_INTERVAL: usize = 10;
...
pub struct RemoteClientConfig {
    ...
    pub log_attempt_interval: usize,
...
impl Default for RemoteClientConfig {
    fn default() -> Self {
        Self {
            ...
            log_attempt_interval: DEFAULT_LOG_ATTEMPT_INTERVAL,
...
impl SerializeConfig for RemoteClientConfig {
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        BTreeMap::from_iter([
            ...
            ser_param(
                "log_attempt_interval",
                &self.log_attempt_interval,
    ...
    Response: Send + Serialize + DeserializeOwned + Debug,
{
    async fn send(&self, component_request: Request) -> ClientResult<Response> {
        ...
        for attempt in 1..max_attempts + 1 {
            ...
            let log_attempt_interval = self.config.log_attempt_interval;
