...
pub struct ConsensusDynamicConfig {
    ...
    /// When false, allow decisions without the virtual leader vote.
    #[serde(default)]
    pub require_virtual_leader_vote: bool,
}
    ...
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        let mut config = BTreeMap::from_iter([
            ...
            ser_param(
                ...
                &self.require_virtual_leader_vote,
...
impl Default for ConsensusDynamicConfig {
    fn default() -> Self {
        Self {
            ...
            require_virtual_leader_vote: false,
        }
    }
}
