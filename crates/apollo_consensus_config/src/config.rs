...
impl Timeout {
    ...
    /// Scale the timeout by the given integer factor.
    fn scale_by(&mut self, factor: u32) {
        self.base *= factor;
        self.delta *= factor;
        self.max *= factor;
    }
...
impl TimeoutsConfig {
    ...
    /// Scale all timeouts by the given integer factor.
    pub fn scale_by(&mut self, factor: u32) {
