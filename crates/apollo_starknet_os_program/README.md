...
The OS processes blocks of transactions and produces an output that captures the execution results: state commitment updates, block metadata, L1↔L2 messages, and data availability information.
