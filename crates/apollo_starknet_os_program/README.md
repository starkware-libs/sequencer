...
The full Starknet OS is designed to run in a trusted sequencer environment. The Virtual OS removes or restricts functionality that would be unsafe or impractical for client-side execution:
