...
const META_TX_V0_GAS_COST = 182000;
const META_TX_V0_CALLDATA_FACTOR_GAS_COST = 4850;

// Note the the following costs include `SYSCALL_BASE_GAS_COST` implicitly.
const SECP256K1_ADD_GAS_COST = 41830;
const SECP256K1_GET_POINT_FROM_X_GAS_COST = 40300;
const SECP256K1_GET_XY_GAS_COST = 20270;
const SECP256K1_MUL_GAS_COST = 8142450;
const SECP256K1_NEW_GAS_COST = 46750;
const SECP256R1_ADD_GAS_COST = 62090;
const SECP256R1_GET_POINT_FROM_X_GAS_COST = 53180;
const SECP256R1_GET_XY_GAS_COST = 20470;
const SECP256R1_MUL_GAS_COST = 13510470;
const SECP256R1_NEW_GAS_COST = 59630;

const KECCAK_GAS_COST = 10000;
const KECCAK_ROUND_COST_GAS_COST = 175107;
const SHA256_PROCESS_BLOCK_GAS_COST = 839212;
