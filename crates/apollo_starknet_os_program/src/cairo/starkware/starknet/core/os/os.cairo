...
func execute_blocks{
    ...
    with contract_class_changes {
        migrate_classes_to_v2_casm_hash(n_classes=n_classes, block_context=block_context);
    }
...
// The class hashes are guessed, and should at least cover the classes that will be executed by the block.
