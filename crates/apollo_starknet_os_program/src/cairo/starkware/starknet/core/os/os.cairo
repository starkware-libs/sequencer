...
func get_os_global_context{
    ...
    if (public_keys_hash != DEFAULT_PUBLIC_KEYS_HASH) {
        ...
        assert proof_os_config_hash = hash_without_keys;
    } else {
        assert proof_os_config_hash = starknet_os_config_hash;
    }
    ...
    tempvar os_global_context: OsGlobalContext* = new OsGlobalContext(
        ...
        proof_os_config_hash=proof_os_config_hash,
