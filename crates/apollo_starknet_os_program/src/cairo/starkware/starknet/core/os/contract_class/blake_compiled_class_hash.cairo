...
from starkware.starknet.core.os.hash.hash_state_blake import (
    ...
    hash_init,
    hash_update_single,
    blake_hash_update_with_nested_hash,
)
...
func compiled_class_hash{range_check_ptr}(compiled_class: CompiledClass*) -> (hash: felt) {
    ...
    let hash: felt = blake_hash_finalize{hash_state=hash_state, range_check_ptr=range_check_ptr}();
    return (hash=hash);
}
...
func bytecode_hash_node{range_check_ptr}(data_ptr: felt*, data_length: felt) -> felt {
    ...
    let segmented_hash = blake_hash_finalize{
...
func hash_entry_points{hash_state: HashState, range_check_ptr: felt}(
    ...
    let hash: felt = blake_hash_finalize{
        hash_state=inner_hash_state, range_check_ptr=range_check_ptr
    }();
...
func hash_entry_points_inner{hash_state: HashState, range_check_ptr: felt}(
    ...
    // Hash builtins.
    blake_hash_update_with_nested_hash{hash_state=hash_state, range_check_ptr=range_check_ptr}(
