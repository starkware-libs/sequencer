...
use starknet_api::transaction::fields::{Fee, PROOF_VERSION, Proof, ProofFacts};
...
impl TransactionConverter {
    ...
    fn verify_proof_and_facts(
        ...
        // - Skip the first two elements from ProofFacts (PROOF_VERSION and program variant like
        //   VIRTUAL_SNOS).
