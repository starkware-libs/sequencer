...
pub enum VerifyProofError {
    ...
    #[error("Proof facts too short: expected at least 2 elements, got {length}.")]
...
pub fn reconstruct_output_preimage(
    ...
    let task_content = proof_facts
        .0
        .get(2..)
        .ok_or(VerifyProofError::ProofFactsTooShort { length: proof_facts.0.len() })?;
