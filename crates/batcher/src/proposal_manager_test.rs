...
async fn proposal_generation_success(
    ...
    proposal_manager
        .build_block_proposal(block_number(), 0, None, arbitrary_deadline(), output_content_sender)
        .await
        .unwrap();
...
async fn consecutive_proposal_generations_success(
    ...
    proposal_manager
        .build_block_proposal(block_number(), 1, None, arbitrary_deadline(), output_content_sender)
        .await
        .unwrap();
