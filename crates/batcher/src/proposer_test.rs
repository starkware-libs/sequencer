...
#[case::mempool_client_error(Err(MempoolClientError::ClientError(ClientError::UnexpectedResponse("TEST".to_owned()))))]
#[tokio::test]
async fn test_take_more_transactions(
    ...
    let result = proposer.pop_more_transactions().await;
