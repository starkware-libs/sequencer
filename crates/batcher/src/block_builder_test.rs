...
use crate::proposal_manager::BuildTransactionGetter;
...
fn set_transaction_executor_expectations(
...
) -> (MockTransactionExecutorTrait, BuildTransactionGetter, BlockExecutionArtifacts) {
    ...
    let tx_getter = BuildTransactionGetter { mempool_client: Arc::new(mock_mempool_client) };
