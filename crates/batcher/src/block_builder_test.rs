...
async fn test_build_block(
    ...
    let (mock_transaction_executor, tx_provider, expected_block_artifacts) =
...
fn set_transaction_executor_expectations(
    ...
    let tx_provider = ProposeTransactionProvider { mempool_client: Arc::new(mock_mempool_client) };

    (mock_transaction_executor, tx_provider, expected_block_artifacts)
}
