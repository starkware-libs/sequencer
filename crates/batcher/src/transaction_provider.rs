...
#[cfg_attr(test, automock)]
#[async_trait]
pub trait L1ProviderClientTrait: Send + Sync {
    #[allow(dead_code)]
    fn get_txs(&mut self, n_txs: usize) -> Vec<L1HandlerTransaction>;
}

pub type SharedL1ProviderClient = Arc<dyn L1ProviderClientTrait>;

pub struct DummyL1ProviderClient;

#[async_trait]
impl L1ProviderClientTrait for DummyL1ProviderClient {
