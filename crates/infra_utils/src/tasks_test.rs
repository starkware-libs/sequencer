...
use crate::tasks::{inner_spawn_monitored_task, spawn_monitored_task};

#[rstest]
#[tokio::test]
async fn test_spawn_monitored_task_success() {
...
#[rstest]
#[tokio::test]
async fn test_spawn_monitored_task_failure() {
