...
const PANEL_CONSENSUS_CACHED_MESSAGES: Panel =
    Panel::from_gauge(CONSENSUS_CACHED_MESSAGES, PanelType::Stat);
...
const PANEL_CONSENSUS_PROPOSALS_FAILED: Panel =
    Panel::from_counter(CONSENSUS_PROPOSALS_FAILED, PanelType::Stat);
