...
const PANEL_CONSENSUS_MAX_CACHCED_HEIGHT: Panel = Panel::new(
    CONSENSUS_MAX_CACHED_HEIGHT.get_name(),
    CONSENSUS_MAX_CACHED_HEIGHT.get_description(),
    CONSENSUS_MAX_CACHED_HEIGHT.get_name(),
    PanelType::Stat,
);

const PANEL_CONSENSUS_CACHED_MESSAGES: Panel = Panel::new(
    CONSENSUS_CACHED_MESSAGES.get_name(),
    CONSENSUS_CACHED_MESSAGES.get_description(),
    CONSENSUS_CACHED_MESSAGES.get_name(),
    PanelType::Stat,
);
...
const PANEL_CONSENSUS_PROPOSALS_FAILED: Panel = Panel::new(
    CONSENSUS_PROPOSALS_FAILED.get_name(),
    CONSENSUS_PROPOSALS_FAILED.get_description(),
    CONSENSUS_PROPOSALS_FAILED.get_name(),
    PanelType::Stat,
);
...
const CONSENSUS_ROW: Row<'_> = Row::new(
    ...
    &[
        ...
        PANEL_CONSENSUS_MAX_CACHCED_HEIGHT,
        PANEL_CONSENSUS_CACHED_MESSAGES,
        ...
        PANEL_CONSENSUS_PROPOSALS_FAILED,
    ],
);
