...
impl L1GasPriceProvider {
    ...
    pub fn get_price_info(&self, timestamp: BlockTimestamp) -> L1GasPriceProviderResult<PriceInfo> {
        ...
        L1_GAS_PRICE_LATEST_MEAN_VALUE.set_lossy_u128(price_info_out.base_fee_per_gas.0);
        L1_DATA_GAS_PRICE_LATEST_MEAN_VALUE.set_lossy_u128(price_info_out.blob_fee.0);
        Ok(price_info_out)
    }
}
