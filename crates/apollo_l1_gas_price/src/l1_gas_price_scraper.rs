...
use crate::metrics::{
    L1_GAS_PRICE_SCRAPER_BASELAYER_ERROR_COUNT, L1_GAS_PRICE_SCRAPER_LATEST_SCRAPED_BLOCK,
    L1_GAS_PRICE_SCRAPER_REORG_DETECTED, L1_GAS_PRICE_SCRAPER_SUCCESS_COUNT,
