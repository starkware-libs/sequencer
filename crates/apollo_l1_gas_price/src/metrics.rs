...
define_metrics!(
    Consensus => {
        ...
        MetricCounter { L1_GAS_PRICE_SCRAPER_BASELAYER_SUCCESS_COUNT, "l1_gas_price_scraper_baselayer_success_count", "Number of times the L1 gas price scraper successfully scraped the base layer for gas prices", init=0 },
...
pub(crate) fn register_scraper_metrics() {
    L1_GAS_PRICE_SCRAPER_BASELAYER_SUCCESS_COUNT.register();
