...
use crate::utils::{is_localhost, StreamBTreeMap};
...
pub struct GenericNetworkManager<SwarmT: SwarmTrait> {
    ...
    sqmr_inbound_response_receivers: StreamBTreeMap<InboundSessionId, ResponsesReceiver>,
    sqmr_inbound_payload_senders: HashMap<StreamProtocol, SqmrServerSender>,
    sqmr_outbound_payload_receivers: StreamBTreeMap<String, SqmrClientReceiver>,
    ...
    messages_to_broadcast_receivers: StreamBTreeMap<TopicHash, Receiver<Bytes>>,
...
impl<SwarmT: SwarmTrait> GenericNetworkManager<SwarmT> {
    ...
    pub(crate) fn generic_new(
        ...
        Self {
            ...
            sqmr_inbound_response_receivers: StreamBTreeMap::new(BTreeMap::new()),
            sqmr_inbound_payload_senders: HashMap::new(),
            sqmr_outbound_payload_receivers: StreamBTreeMap::new(BTreeMap::new()),
            sqmr_outbound_response_senders: HashMap::new(),
            sqmr_outbound_report_receivers_awaiting_assignment: HashMap::new(),
            messages_to_broadcast_receivers: StreamBTreeMap::new(BTreeMap::new()),
