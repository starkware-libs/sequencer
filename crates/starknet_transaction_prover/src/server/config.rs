...
pub struct ServiceConfig {
    ...
    /// How long the service must have been continuously rejecting proving requests, in
    /// milliseconds, before `/health` flips to 503. The concurrency limit causes those rejects.
...
pub struct CliArgs {
    ...
    /// How long the service must have been continuously rejecting proving requests before
