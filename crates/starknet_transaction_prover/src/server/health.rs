...
//! (which would 405 a GET). Returns 503 once its `SaturationMonitor` reports that
//! the service has been continuously rejecting requests for the configured
//! threshold. The response body is opaque: no timestamps, counters, or upstream
//! URLs.
