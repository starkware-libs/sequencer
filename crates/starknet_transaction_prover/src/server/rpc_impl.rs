...
pub struct ProvingRpcServerImpl {
    ...
    /// Tracks how long the service has been rejecting requests so `/health` can flip to 503.
...
impl ProvingRpcServer for ProvingRpcServerImpl {
    ...
    async fn prove_transaction(
        ...
        // increment a `rejected_*` outcome so served and shed requests share one denominator.
