...
impl MempoolStateReader for SyncStateReader {
    fn get_block_info(&self) -> StateResult<BlockInfo> {
        ...
        let block_info = BlockInfo {
            ...
            sequencer_address: block.sequencer.0,
            gas_prices: GasPrices {
                eth_gas_prices: GasPriceVector {
                    l1_gas_price: block.l1_gas_price.price_in_wei.try_into()?,
                    l1_data_gas_price: block.l1_data_gas_price.price_in_wei.try_into()?,
                    l2_gas_price: block.l2_gas_price.price_in_wei.try_into()?,
                },
                strk_gas_prices: GasPriceVector {
                    l1_gas_price: block.l1_gas_price.price_in_fri.try_into()?,
                    l1_data_gas_price: block.l1_data_gas_price.price_in_fri.try_into()?,
                    l2_gas_price: block.l2_gas_price.price_in_fri.try_into()?,
                },
            },
            use_kzg_da: matches!(block.l1_da_mode, L1DataAvailabilityMode::Blob),
        };
