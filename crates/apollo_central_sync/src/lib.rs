...
use apollo_state_sync_metrics::metrics::{
    STATE_SYNC_BASE_LAYER_MARKER,
    STATE_SYNC_BODY_MARKER,
    STATE_SYNC_CENTRAL_BLOCK_MARKER,
    ...
    async fn store_base_layer_block(
        ...
        self.perform_storage_writes(move |writer| {
            ...
            if txn.get_base_layer_block_marker()? != block_number.unchecked_next() {
                ...
                STATE_SYNC_BASE_LAYER_MARKER.set_lossy(block_number.unchecked_next().0);
            }
            Ok(())
        })
        .await
...
>(
    ...
    try_stream! {
            ...
            *shared_highest_block.write().await = latest_central_block;
            ...
            STATE_SYNC_CENTRAL_BLOCK_MARKER.set_lossy(central_block_marker.0);
