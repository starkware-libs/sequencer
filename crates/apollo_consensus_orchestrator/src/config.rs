...
pub struct ContextConfig {
    ...
    /// Part Per 1000 of multiplicative factor to apply to the data gas price, to enable
    ...
    /// under-utilization.
    pub part_per_thousand_l1_data_gas_price_multiplier: u128,
}
    ...
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        BTreeMap::from_iter([
            ...
            ser_param(
                ...
                &self.part_per_thousand_l1_data_gas_price_multiplier,
                "Part Per 1000 of multiplicative factor to apply to the data gas price, to enable \
                 fine-tuning of the price charged to end users.",
                ParamPrivacyInput::Public,
            ),
        ])
    }
...
impl Default for ContextConfig {
    fn default() -> Self {
        Self {
            ...
            part_per_thousand_l1_data_gas_price_multiplier: 135,
        }
    }
}
