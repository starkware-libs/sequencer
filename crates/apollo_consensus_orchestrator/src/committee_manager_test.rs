...
#[case::single_staker(vec![
    Staker { address: contract_address!("0x1"), staked_amount: 1000, pubkey: Felt::ONE },
])]
#[case::multiple_stakers(vec![
    Staker { address: contract_address!("0x1"), staked_amount: 1000, pubkey: Felt::ONE },
    Staker { address: contract_address!("0x2"), staked_amount: 2000, pubkey: Felt::TWO },
])]
...
fn staker_try_from_valid() {
    ...
    assert_eq!(staker.staked_amount, 1);
    assert_eq!(staker.pubkey, Felt::ONE);
}
