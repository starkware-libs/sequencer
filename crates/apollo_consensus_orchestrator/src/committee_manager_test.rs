...
#[case::empty(0)]
#[case::two_elements(2)]
fn staker_array_retdata_try_from_valid(#[case] num_elements: usize) {
    let valid_retdata = [
        [Felt::from(num_elements)].as_slice(),
        vec![Felt::ONE; Staker::CAIRO_OBJECT_NUM_FELTS * num_elements].as_slice(),
    ]
    .concat();
...
#[case::missing_num_elements(vec![Felt::ONE; Staker::CAIRO_OBJECT_NUM_FELTS * 2])]
