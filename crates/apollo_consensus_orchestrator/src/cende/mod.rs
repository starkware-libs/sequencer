...
pub(crate) struct AerospikeBlob {
    ...
    class_hashes_to_migrate: HashSet<ClassHash>,
}
...
pub struct BlobParameters {
    ...
    pub(crate) class_hashes_to_migrate: HashSet<ClassHash>,
...
impl AerospikeBlob {
    async fn from_blob_parameters_and_class_manager(
        ...
        Ok(AerospikeBlob {
            ...
            class_hashes_to_migrate: blob_parameters.class_hashes_to_migrate,
        })
    }
}
