...
pub(crate) struct AerospikeBlob {
    ...
    compiled_class_hashes_to_migrate: CentralCompiledClassHashesForMigration,
}
...
impl AerospikeBlob {
    async fn from_blob_parameters_and_class_manager(
        ...
        Ok(AerospikeBlob {
            ...
            compiled_class_hashes_to_migrate: blob_parameters.compiled_class_hashes_to_migrate,
        })
    }
}
