...
fn compiled_class_hashes_for_migration() -> HashMap<CompiledClassHash, CompiledClassHash> {
    HashMap::from([
...
fn central_blob() -> AerospikeBlob {
    ...
    let blob_parameters = BlobParameters {
        ...
        compiled_class_hashes_for_migration: compiled_class_hashes_for_migration(),
    };
