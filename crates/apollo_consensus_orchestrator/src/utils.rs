...
// TODO(Rotem): When we have enough confidence in the Batcher, we can move this logic to the
// Batcher and remove this function (it would be part of `propose_block` inside the Batcher).
        ...
        match result {
            Err(RetrospectiveBlockHashError::NotReady {
                ...
                if effective_retry_interval == Duration::ZERO {
                    warn!("Deadline reached, stopping retries.");
