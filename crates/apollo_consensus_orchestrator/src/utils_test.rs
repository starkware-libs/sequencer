...
#[tokio::test]
async fn wait_for_retrospective_block_hash_succeed() {
...
#[tokio::test]
async fn wait_for_retrospective_block_hash_fails() {
    let (mut test_proposal_args, _proposal_receiver) = create_proposal_build_arguments();
    test_proposal_args.proposal_init.height = CURRENT_BLOCK_NUMBER;
    // Setup batcher client to return an error.
    test_proposal_args
...
#[tokio::test]
async fn wait_for_retrospective_block_hash_not_ready(
