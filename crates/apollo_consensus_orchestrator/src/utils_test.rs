...
#[cfg(feature = "os_input")]
#[rstest]
#[case::stored_on_both_sides(true, STORED_HEIGHT_OFFSET, true)]
#[case::stored_only_on_batcher(true, BEHIND_HEIGHT_OFFSET, true)]
#[case::stored_on_batcher_and_recorder_empty(true, None, true)]
...
async fn retrospective_state_commitment_infos(
    ...
    let res = verify_retrospective_state_commitment_infos(
        Arc::new(mock_batcher_commitment_infos(batcher_has_infos)),
        Arc::new(mock_cende_recorder_height_offset(cende_recorder_height_offset)),
