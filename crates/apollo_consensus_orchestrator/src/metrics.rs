...
define_metrics!(
    Consensus => {
        ...
        MetricCounter { CONSENSUS_CONVERSION_RATE_MISMATCH, "consensus_conversion_rate_mismatch",
            "The number of proposals that failed because the difference between the queried and received eth to fri rates was larger than the allowed margin", init = 0 },
    }
);
...
pub(crate) fn register_metrics() {
    ...
    CONSENSUS_CONVERSION_RATE_MISMATCH.register();
}
