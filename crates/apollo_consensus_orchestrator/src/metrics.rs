...
define_metrics!(
    Consensus => {
        ...
        MetricCounter { CONSENSUS_ETH_TO_STRK_ORACLE_ERROR, "consensus_eth_to_strk_oracle_error", "Number of times the context got an error when querying the ETH to STRK oracle", init=0},
        // Cende metrics
...
pub(crate) fn register_metrics() {
    ...
    CONSENSUS_ETH_TO_STRK_ORACLE_ERROR.register();
