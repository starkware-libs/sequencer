...
const TEMPORARY_GAS_PRICES: GasPrices = GasPrices {
    eth_gas_prices: GasPriceVector {
        l1_gas_price: NonzeroGasPrice::TEMP_ETH_GAS_FEE_IN_WEI,
        l1_data_gas_price: NonzeroGasPrice::TEMP_ETH_BLOB_GAS_FEE_IN_WEI,
...
async fn is_block_info_valid(
    ...
    if block_info.eth_to_fri_rate.abs_diff(eth_to_fri_rate) > allowed_margin {
        CONSENSUS_CONVERSION_RATE_MISMATCH_COUNT.increment(1);
        return false;
    }
    true
}
