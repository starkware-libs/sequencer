...
impl ConsensusContext for SequencerConsensusContext {
    ...
    fn proposer(&self, height: BlockNumber, round: Round) -> Result<ValidatorId, ConsensusError> {
        // TODO(Asmaa): Update this when the committee provider implements actual proposer
        // selection.
        // For now, keep the actual proposer selection identical to the virtual proposer selection.
        self.virtual_proposer(height, round)
    }
