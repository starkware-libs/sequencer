...
use rstest::rstest;
use starknet_api::block::{BlockHash, BlockNumber, NonzeroGasPrice};
...
fn block_info(height: BlockNumber) -> ConsensusBlockInfo {
    ConsensusBlockInfo {
        ...
        l1_gas_price_wei: NonzeroGasPrice::TEMP_ETH_GAS_FEE_IN_WEI.get().0,
        l1_data_gas_price_wei: NonzeroGasPrice::TEMP_ETH_BLOB_GAS_FEE_IN_WEI.get().0,
...
fn setup(
    ...
    gas_price_provider.expect_get_price_info().returning(|_| {
        Ok(PriceInfo {
