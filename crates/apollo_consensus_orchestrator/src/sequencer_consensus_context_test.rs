...
fn setup(
    ...
    let context_deps = SequencerConsensusContextDeps {
        ...
        l1_gas_price_provider: Arc::new(dummy_gas_price_proivder()),
        ..default_deps
    };
...
fn dummy_gas_price_proivder() -> MockL1GasPriceProviderClient {
...
async fn decision_reached_sends_correct_values() {
    ...
    batcher
        ...
        .times(1)
        .return_once(move |_| Ok(dummy_decision_reached_response()));
