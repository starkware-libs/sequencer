...
impl TestDeps {
    fn setup_dummy_deps(&mut self) {
        self.dummy_transaction_converter();
        self.dummy_cende_ambassador();
        self.dummy_gas_price_provider();
        self.dummy_eth_to_strk_oracle_client();
    }

    fn setup_deps_for_build(&mut self, block_number: BlockNumber) {
        self.setup_dummy_deps();
    ...
    fn dummy_eth_to_strk_oracle_client(&mut self) {
