...
fn test_get_min_gas_price_for_height_exact_match() {
    ...
    // Exact match
    assert_eq!(
        get_min_gas_price_for_height(BlockNumber(500), &min_l2_gas_price_per_height, fallback),
...
fn test_get_min_gas_price_for_height_between_entries() {
    ...
    assert_eq!(
        get_min_gas_price_for_height(BlockNumber(300), &min_l2_gas_price_per_height, fallback),
        GasPrice(10_000_000_000)
    );

    // Between 500 and 1000, should use 500's price
    assert_eq!(
        get_min_gas_price_for_height(BlockNumber(750), &min_l2_gas_price_per_height, fallback),
        GasPrice(20_000_000_000)
    );
}
...
fn test_get_min_gas_price_for_height_before_first_entry() {
    ...
    assert_eq!(
        get_min_gas_price_for_height(BlockNumber(50), &min_l2_gas_price_per_height, fallback),
        fallback
    );
}
...
fn test_get_min_gas_price_for_height_after_last_entry() {
    ...
    assert_eq!(
        get_min_gas_price_for_height(BlockNumber(2000), &min_l2_gas_price_per_height, fallback),
...
fn test_get_min_gas_price_for_height_empty_list() {
    ...
    assert_eq!(
        get_min_gas_price_for_height(BlockNumber(100), &min_l2_gas_price_per_height, fallback),
        fallback
    );
}
