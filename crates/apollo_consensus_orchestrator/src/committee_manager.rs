...
// The committee is a subset of nodes that are selected to participate in the consensus at a given
// epoch, responsible for proposing blocks and voting on them.
...
pub struct Staker {
    ...
    // The staker's weight, which determines the staker's influence in the consensus (e.g. voting
    // power).
