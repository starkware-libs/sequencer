...
/// do_something(0);
/// // 2 milliseconds pass.
/// do_something(1); // No log, only 2 milliseconds passed.
/// // 4 milliseconds pass.
/// do_something(2); // Logs: "Processing item: 2" (6 milliseconds passed since last log).
/// // 4 milliseconds pass.
/// do_something(3); // No log, only 4 milliseconds passed since **last** log.
///
/// // This will log twice since these are two different call sites.
...
/// Logs a WARN message once every `n` milliseconds.
...
/// Logs an ERROR message once every `n` milliseconds.
/// See `info_every_n_ms!` for detailed usage and behavior.
#[macro_export]
...
/// Logs a DEBUG message once every `n` milliseconds.
/// See `info_every_n_ms!` for detailed usage and behavior.
#[macro_export]
...
/// Logs a TRACE message once every `n` milliseconds.
/// See `info_every_n_ms!` for detailed usage and behavior.
#[macro_export]
