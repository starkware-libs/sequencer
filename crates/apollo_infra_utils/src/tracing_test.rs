...
fn test_trace_every_n_logs_to_trace_sec() {
    ...
    trace_every_n_ms!(ARBITRARY_TIME_SECS, LOG_MESSAGE);
...
fn test_debug_every_n_logs_to_debug_sec() {
    ...
    debug_every_n_ms!(ARBITRARY_TIME_SECS, LOG_MESSAGE);
...
fn test_info_every_n_logs_to_info_sec() {
    ...
    info_every_n_ms!(ARBITRARY_TIME_SECS, LOG_MESSAGE);
...
fn test_warn_every_n_logs_to_warn_sec() {
    ...
    warn_every_n_ms!(ARBITRARY_TIME_SECS, LOG_MESSAGE);
...
fn test_error_every_n_logs_to_error_sec() {
    ...
    error_every_n_ms!(ARBITRARY_TIME_SECS, LOG_MESSAGE);
