...
#[test]
fn test_get_class_manager_marker_initial_state() {
...
#[test]
fn test_update_class_manager_marker() {
...
fn test_try_revert_class_manager_marker(
    #[case] initial_block_marker: BlockNumber,
    #[case] try_revert_block_marker: BlockNumber,
    ...
    writer
        ...
        .unwrap()
        .try_revert_class_manager_marker(try_revert_block_marker)
        .unwrap()
        .commit()
        .unwrap();
