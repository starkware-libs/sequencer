...
pub type SharedConfigManagerClientWithChannel = Arc<dyn ConfigManagerClientWithChannel>;
...
#[cfg_attr(any(feature = "testing", test), mockall::automock)]
pub trait ConfigManagerClientWithChannel: Send + Sync {
...
impl<ComponentClientType> ConfigManagerClientWithChannel for ComponentClientType
where
    ComponentClientType: Send + Sync + ComponentClientWithChannel<NodeDynamicConfig>,
{
    fn get_consensus_dynamic_config(&self) -> ConfigManagerClientResult<ConsensusDynamicConfig> {
