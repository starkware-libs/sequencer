...
pub type ApolloTestCommitter = Committer<MockForestStorage<ApolloTestStorage>, CommitBlockMock>;
...
async fn new_test_committer() -> ApolloTestCommitter {
    Committer::new(CommitterConfig::default(), || Ok(MapStorage::default())).await.unwrap()
}
