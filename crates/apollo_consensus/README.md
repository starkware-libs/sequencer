...
```
cargo run --package papyrus_node --bin papyrus_node -- --base_layer_url <ETH_NODE_URL> --network.#is_none false --consensus.#is_none false --consensus.validator_id 0x1 --storage.db_config.path_prefix <UNIQUE>
```
