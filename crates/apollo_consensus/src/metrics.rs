...
define_metrics!(
    Consensus => {
        ...
        MetricCounter { CONSENSUS_RESTART_COUNTER, "consensus_restart_counter", "The number of times consensus has been restarted", init=0 },
...
pub(crate) fn register_metrics() {
    ...
    CONSENSUS_RESTART_COUNTER.register();
