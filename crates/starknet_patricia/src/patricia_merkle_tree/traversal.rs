...
/// [OriginalSkeletonTree]. The [UnmodifiedChildTraversal::Traverse] variant indicates that the
/// child must be read since we don't have the data to create an original tree node.
