...
/// This struct represents the structure of the subtree which was modified in the update.
...
impl UpdatedSkeletonTreeImpl {
    ...
    pub(crate) fn get_node(
        &self,
        index: NodeIndex,
    ) -> UpdatedSkeletonTreeResult<&UpdatedSkeletonNode> {
    ...
    pub(crate) fn get_nodes<'a>(
        &'a self,
    ) -> impl Iterator<Item = (NodeIndex, UpdatedSkeletonNode)> + 'a {
