...
mod OsResourcesTestContract {
    ...
    #[external(v0)]
    fn __validate__(self: @ContractState, self_class_hash: ClassHash, self_address: ContractAddress) -> felt252 {
        starknet::VALIDATED
    }
    ...
    fn __execute__(ref self: ContractState, self_class_hash: ClassHash, self_address: ContractAddress) {
        ...
        let _ = secp256k1_get_point_from_x_syscall(X_FOR_K, true).unwrap_syscall();
        ...
        let _ = secp256r1_get_point_from_x_syscall(X_FOR_R, true).unwrap_syscall();
