...
pub fn create_small_felt() -> Felt {
    // Small value < 2^63, will encode to 2 u32s
    Felt::from(42u64)
}

pub fn create_big_felt() -> Felt {
    // Large value >= 2^63, will encode to 8 u32s
    Felt::from_hex_unchecked("8000000000000001") // Just above 2^63
}
