...
fn expected_validate_call_info(
    ...
    let retdata = match cairo_version {
        ...
        CairoVersion::Cairo1(RunnableCairoVersion::Casm) => retdata!(*constants::VALIDATE_RETDATA),
    ...
    macro_rules! assert_resource_overdraft {
        ($invalid_resource_bounds:expr) => {
            ...
            let contract_to_declare =
                FeatureContract::Empty(CairoVersion::Cairo1(RunnableCairoVersion::Casm));
...
#[case(TransactionVersion::TWO, CairoVersion::Cairo1(RunnableCairoVersion::Casm))]
#[case(TransactionVersion::THREE, CairoVersion::Cairo1(RunnableCairoVersion::Casm))]
fn test_declare_tx(
    default_all_resource_bounds: ValidResourceBounds,
    #[values(CairoVersion::Cairo0, CairoVersion::Cairo1(RunnableCairoVersion::Casm))]
    account_cairo_version: CairoVersion,
...
fn test_validate_accounts_tx(
    ...
    if let CairoVersion::Cairo1(RunnableCairoVersion::Casm) = cairo_version {
