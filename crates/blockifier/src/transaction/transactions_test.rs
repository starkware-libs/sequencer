        ...
        (
            ...
            AllResourceBounds {
                l1_gas: ResourceBounds {
                    ...
                    max_price_per_unit: u128::from(actual_strk_l1_gas_price.get().0) - 1,
                },
        ...
        (
            ...
            AllResourceBounds {
                l2_gas: ResourceBounds {
                    ...
                    max_price_per_unit: u128::from(actual_strk_l2_gas_price.get().0) - 1,
                },
                ..default_resource_bounds
            },
        ),
        (
            ...
            AllResourceBounds {
                l1_data_gas: ResourceBounds {
                    ...
                    max_price_per_unit: u128::from(actual_strk_l1_data_gas_price.get().0) - 1,
                },
                ..default_resource_bounds
            },
        ),
...
fn test_insufficient_resource_bounds(
    ...
    let insufficient_max_l1_gas_price = GasPrice(actual_strk_l1_gas_price.get().0 - 1);
