...
// This gas amount should be sufficient to avoid execution failure due to step limits,
// but still trigger a post-execution failure from exceeding resource bounds.
