...
use crate::transaction::test_utils::{
    ...
    create_gas_amount_bounds_default_price,
...
#[rstest]
#[case::small_user_bounds(create_gas_amount_bounds_default_price(GasAmount(1652), versioned_constants.validate_max_sierra_gas, GasAmount(0)))]
#[case::user_bounds_between_validate_and_execute(create_gas_amount_bounds_default_price(GasAmount(1652), versioned_constants.validate_max_sierra_gas + GasAmount(123456), GasAmount(0)))]
...
fn test_invoke_max_sierra_gas_validate_execute(
    ...
    let expected_inner_call_initial_gas = if contract_tracked_resource == TrackedResource::SierraGas
        && account_tracked_resource == TrackedResource::SierraGas
    {
