...
use crate::fee::gas_usage::{compute_discounted_gas_from_tx_context, estimate_minimal_gas_vector};
use crate::retdata;
...
impl AccountTransaction {
    ...
    fn check_fee_bounds(
        ...
        let minimal_l1_gas_amount =
            compute_discounted_gas_from_tx_context(&minimal_l1_gas_amount_vector, tx_context);
