    ...
    pub fn from_api(
        ...
        match tx {
            ...
            StarknetApiTransaction::Declare(declare) => {
                ...
                let executable_declare_tx = starknet_api::executable_transaction::Transaction::Declare(starknet_api::executable_transaction::DeclareTransaction{
                    tx: declare,
                    tx_hash,
            ...
            StarknetApiTransaction::DeployAccount(deploy_account) => {
                ...
                let executable_deploy_account_tx = starknet_api::executable_transaction::Transaction::DeployAccount(starknet_api::executable_transaction::DeployAccountTransaction{
                    tx: deploy_account,
                    tx_hash,
                    contract_address
                });
            ...
            StarknetApiTransaction::Invoke(invoke) => {
                let executable_invoke_tx = starknet_api::executable_transaction::Transaction::Invoke(starknet_api::executable_transaction::InvokeTransaction{
                    tx: invoke,
                    tx_hash,
                });
