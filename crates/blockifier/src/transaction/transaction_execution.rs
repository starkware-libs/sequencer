...
impl<U: UpdatableState> ExecutableTransaction<U> for L1HandlerTransaction {
    fn execute_raw(
        ...
        FeeCheckReport::check_all_resources_within_bounds(
            &GasVector {
                l2_gas: l1_handler_bounds.l2_gas,
                l1_gas: l1_handler_bounds.l1_gas,
                l1_data_gas: l1_handler_bounds.l1_data_gas,
            },
            &receipt.gas,
        )?;
