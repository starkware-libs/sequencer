...
fn test_simulate_validate_charge_fee_mid_execution(
    ...
    let (gas_bound, fee_bound) = gas_and_fee(6242_u32.into(), validate, &fee_type);
    ...
    let (limited_gas_used, limited_fee) = gas_and_fee(7894_u32.into(), validate, &fee_type);
...
fn test_simulate_validate_charge_fee_post_execution(
    ...
    let base_gas_bound = 9010_u32.into();
