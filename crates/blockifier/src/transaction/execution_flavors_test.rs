...
fn test_simulate_validate_charge_fee_mid_execution(
    ...
    let (gas_bound, fee_bound) = gas_and_fee(6305_u32.into(), validate, &fee_type);
    ...
    let (limited_gas_used, limited_fee) = gas_and_fee(7957_u32.into(), validate, &fee_type);
