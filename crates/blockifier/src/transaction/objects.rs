...
impl StarknetResources {
    ...
    pub fn get_l2_archival_data_cost(
        ...
        let l2_gas = versioned_constants
            .convert_l2_to_l1_gas(self.get_calldata_and_signature_cost(versioned_constants))
            + versioned_constants.convert_l2_to_l1_gas(self.get_code_cost(versioned_constants))
            + versioned_constants.convert_l2_to_l1_gas(self.get_events_cost(versioned_constants));
        match mode {
            GasVectorComputationMode::All => GasVector::from_l2_gas(l2_gas),
            GasVectorComputationMode::NoL2Gas => GasVector::from_l1_gas(l2_gas),
        }
    }
