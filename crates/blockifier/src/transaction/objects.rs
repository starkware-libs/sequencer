...
impl StarknetResources {
    ...
    pub fn to_gas_vector(
        ...
        let current_cost = match gas_vector_computation_mode {
            GasVectorComputationMode::AllGasAmounts => GasVector::from_l2_gas(
        ...
        current_cost + self.get_state_changes_cost(use_kzg_da) + self.get_messages_cost()
    }
