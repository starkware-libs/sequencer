...
pub fn all_resource_bounds(
    #[default(DEFAULT_L1_GAS_MAX_AMOUNT)] l1_max_amount: u64,
    #[default(DEFAULT_ETH_L1_GAS_PRICE)] l1_max_price: u128,
    #[default(DEFAULT_L2_GAS_MAX_AMOUNT)] l2_max_amount: u64,
    #[default(DEFAULT_ETH_L2_GAS_PRICE)] l2_max_price: u128,
    #[default(DEFAULT_L1_DATA_GAS_MAX_AMOUNT)] l1_data_max_amount: u64,
    #[default(DEFAULT_ETH_L1_DATA_GAS_PRICE)] l1_data_max_price: u128,
) -> ValidResourceBounds {
