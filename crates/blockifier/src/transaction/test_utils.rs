...
pub fn get_resource_bounds(computation_mode: &GasVectorComputationMode) -> ValidResourceBounds {
    match computation_mode {
        GasVectorComputationMode::NoL2Gas => {
            l1_resource_bounds(MAX_L1_GAS_AMOUNT, MAX_L1_GAS_PRICE)
        }
        GasVectorComputationMode::All => get_all_resource_bounds(
            MAX_L1_GAS_AMOUNT,
            MAX_L1_GAS_PRICE,
            DEFAULT_L2_GAS_MAX_AMOUNT,
            DEFAULT_STRK_L2_GAS_PRICE,
