...
fn test_fail_deploy_account(
    ...
    let charge_fee = deploy_account_tx.create_tx_info().unwrap().enforce_fee();
...
fn test_max_fee_to_max_steps_conversion(
    ...
    let charge_fee1 = account_tx1.create_tx_info().unwrap().enforce_fee(); // aviv:  new
    ...
    let charge_fee2 = account_tx2.create_tx_info().unwrap().enforce_fee(); // aviv:  new
