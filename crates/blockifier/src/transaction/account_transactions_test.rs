...
fn test_max_fee_to_max_steps_conversion(
    ...
    let execution_context1 = EntryPointExecutionContext::new_execute(tx_context1, true);
    ...
    let execution_context2 = EntryPointExecutionContext::new_execute(tx_context2, true);
