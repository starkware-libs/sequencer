...
fn test_max_fee_limit_validate(
    ...
    let grindy_validate_account = FeatureContract::AccountWithLongValidate(
        RunnableContractVersion::Cairo1Casm,
    );
...
#[cfg_attr(
    feature = "cairo_native",
    case(RunnableContractVersion::Cairo1(RunnableCairo1ContractVersion::Native))
)]
...
fn test_fail_declare(block_context: BlockContext, max_fee: Fee) {
    ...
    let contract_class = FeatureContract::Empty(RunnableContractVersion::Cairo1Casm)
    .get_class();
...
#[cfg_attr(
    feature = "cairo_native",
    case::native(RunnableContractVersion::Cairo1(RunnableCairo1ContractVersion::Native))
)]
