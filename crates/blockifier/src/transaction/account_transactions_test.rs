...
#[rstest]
// TODO (Meshi): Add a native case once native feature contracts will support get class.
#[case::cairo1(CairoVersion::Cairo1(RunnableCairo1::Casm))]
...
fn test_initial_gas(
    ...
    #[case] runnable_cairo1: RunnableCairo1,
    default_all_resource_bounds: ValidResourceBounds,
) {
    let block_context = BlockContext::create_for_account_testing();
    let account_version = CairoVersion::Cairo1(runnable_cairo1); // AvivG - cairo_version;
