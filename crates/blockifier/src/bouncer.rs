...
impl CasmHashMigrationData {
    ...
    /// - Else: iterates over `executed_class_hashes`, selecting classes that should migrate using
    /// `should_migrate` and accumulates per-class migration resources into a single aggregate.
