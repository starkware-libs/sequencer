...
impl Bouncer {
    ...
    fn update(
        ...
        // charged for them.
        // Also, `get_patricia_update_resources` relies on this property - each write must
        // be counted at most once.
...
///   3. In practice, the OS performs a multi-update, which is more efficient than performing
