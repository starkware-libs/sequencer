...
impl Bouncer {
    ...
    pub fn try_update<S: StateReader>(
        ...
        tx_builtin_counters: &ResourceCounterMap,
...
pub fn vm_resources_to_gas(
    ...
    let builtins_gas_cost = resources_to_gas(
        &resources.prover_builtins().into_resource_counter_map(),
        builtin_gas_cost,
    );
...
pub fn get_tx_weights<S: StateReader>(
    ...
    let mut vm_resources_builtins_for_proving_gas_computation = (&patrticia_update_resources
        + &tx_resources.computation.os_vm_resources)
        .prover_builtins()
