...
impl Bouncer {
    ...
    pub fn try_update<S: StateReader>(
        ...
        if !self
            .bouncer_config
            .has_room(self.accumulated_weights.checked_add(tx_weights).expect("Addition overflow"))
        {
            log::debug!(
    ...
    fn update(
        ...
        self.accumulated_weights =
            self.accumulated_weights.checked_add(tx_weights).expect("Addition overflow");
