...
// Question to self(AvivG): impl std::fmt::Display for BuiltinCounterMap?
...
fn vm_resources_to_sierra_gas(
    ...
    let builtins_gas_cost = builtins_to_sierra_gas(&resources.prover_builtins(), versioned_constants);
