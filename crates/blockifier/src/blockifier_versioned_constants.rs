...
pub struct OsConstants {
    ...
    // `l1_handler_resource_bounds.l1_data_gas` is not enforced (default 0).
    pub l1_handler_resource_bounds: GasVector,
}
...
impl TryFrom<OsConstantsRawJson> for OsConstants {
    ...
    fn try_from(raw_json_data: OsConstantsRawJson) -> Result<Self, Self::Error> {
        ...
        let l1_handler_resource_bounds = raw_json_data.l1_handler_resource_bounds;
