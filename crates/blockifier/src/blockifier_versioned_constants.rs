...
pub struct RawOsConstants {
    ...
    pub syscall_gas_costs: Option<HashMap<SyscallSelector, RawSyscallGasCost>>,
...
impl GasCosts {
    fn from_raw(os_constants: &RawOsConstants, os_resources: &RawOsResources) -> Self {
        ...
        let base_costs = BaseGasCosts {
            ...
            default_initial_gas_cost: step_gas_cost
                * os_constants.default_initial_gas_cost.step_gas_cost.0,
            entry_point_initial_budget: step_gas_cost
                * os_constants.entry_point_initial_budget.step_gas_cost.0,
            syscall_base_gas_cost: step_gas_cost
                * os_constants.syscall_base_gas_cost.step_gas_cost.0,
        };
        ...
        Self { syscalls, base: base_costs, builtins: os_constants.builtin_gas_costs.clone() }
    }

    fn old_syscall_gas_cost_summary(
        base_costs: &BaseGasCosts,
        selector: SyscallSelector,
        syscall_gas_costs: &HashMap<SyscallSelector, RawSyscallGasCost>,
        ...
        SyscallGasCost::new_from_base_cost(match raw_cost {
            ...
            RawSyscallGasCost::Structured(RawStructuredSyscallGasCost {
                step_gas_cost,
                range_check,
                bitwise,
...
impl OsConstants {
    fn from_raw(raw_constants: &RawOsConstants, raw_resources: &RawOsResources) -> Self {
        Self {
            ...
            validate_rounding_consts: raw_constants.validate_rounding_consts.clone(),
