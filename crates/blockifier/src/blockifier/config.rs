...
impl ContractClassManagerConfig {
    #[cfg(any(test, feature = "testing", feature = "native_blockifier"))]
    pub fn create_for_testing(cairo_native_run_mode: CairoNativeRunMode) -> Self {
...
pub struct CairoNativeRunConfig {
    pub cairo_native_run_mode: CairoNativeRunMode,
...
impl Default for CairoNativeRunConfig {
    fn default() -> Self {
        Self {
            cairo_native_run_mode: CairoNativeRunMode::default(),
        ...
        BTreeMap::from_iter([
            ser_param(
                ...
                "Cairo native execution mode. 'off' disables native execution, \
                 'synchronouscompilation' compiles synchronously, and 'asynchronouscompilation' \
...
pub enum CairoNativeRunMode {
    Off,
    SynchronousCompilation,
    AsynchronousCompilation,
}

impl Default for CairoNativeRunMode {
    fn default() -> Self {
        #[cfg(feature = "cairo_native")]
        return Self::AsynchronousCompilation;
