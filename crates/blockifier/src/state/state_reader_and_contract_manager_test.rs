...
#[rstest]
#[case::no_cairo_native(NativeExecutionMode::Disabled)]
#[cfg_attr(feature = "cairo_native", case::cairo_native_no_wait(NativeExecutionMode::Async))]
#[cfg_attr(feature = "cairo_native", case::cairo_native_and_wait(NativeExecutionMode::Sync))]
fn test_get_compiled_class_without_native_in_cache(
    ...
    let contract_manager_config = ContractClassManagerConfig::create_for_testing(execution_mode);
