...
use crate::metrics::CacheMetricsTrait;
...
pub struct StateReaderAndContractManager<S: FetchCompiledClasses, M: CacheMetricsTrait> {
    pub state_reader: S,
    pub contract_class_manager: ContractClassManager,
    pub class_cache_metrics: M,
}

impl<S: FetchCompiledClasses, M: CacheMetricsTrait> StateReaderAndContractManager<S, M> {
...
impl<S: FetchCompiledClasses, M: CacheMetricsTrait> StateReader
