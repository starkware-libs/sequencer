...
// Test that `allocated_keys` collects zero -> nonzero updates, where the TransactionalState holds
// the previous state as base.
#[rstest]
...
fn test_allocated_keys_two_transactions(
    #[case] is_base_empty: bool,
    #[case] first_value: Felt,
    #[case] second_value: Felt,
    #[case] charged: bool,
) {
    let contract_address = contract_address!(CONTRACT_ADDRESS);
    let storage_key = StorageKey::from(0x10_u16);
