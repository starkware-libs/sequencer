...
use starknet_sierra_multicompile::config::{SierraCompilationConfig, DEFAULT_MAX_CPU_TIME};
...
fn test_process_compilation_request(
    ...
    if should_pass {
        ...
        assert_matches!(res.unwrap_err(), ContractClassManagerError::CompilationError(_));
        assert_matches!(
