...
pub trait StateReader {
    ...
    fn get_sierra_class(&self, class_hash: ClassHash) -> StateResult<SierraContractClass> {
        // Only implement if the reader supports compilation.
        // Sierra and CASM (from 'RunnableCompiledClass') are required to get 'CachedClass', which
        // is needed for class compilation.
        unimplemented!()
    }
}
