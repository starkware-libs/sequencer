...
impl TransactionContext {
    ...
    /// Returns initial sierra gas to limit the transaction's run. Returns the L2 gas the user
    /// signed on if it exists, or the default gas amount otherwise (should be very high to avoid
    /// limiting with this resource).
