...
impl FeeCheckReport {
    ...
    fn check_actual_cost_within_bounds(
        ...
        match tx_info {
            TransactionInfo::Current(context) => {
                Ok(FeeCheckReport::check_all_resources_within_bounds(
    ...
    fn check_gas_within_all_resource_bounds(
        ...
        match () {
            _ if gas_vector.l1_gas > l1_gas_max_amount => {
            ...
            _ if gas_vector.l2_gas > l2_gas_max_amount => {
                Err(FeeCheckError::MaxGasAmountExceeded {
            ...
            _ if gas_vector.l1_data_gas > l1_data_gas_max_amount => {
                Err(FeeCheckError::MaxGasAmountExceeded {
    ...
    fn check_all_resources_within_bounds(
        ...
        match valid_resource_bounds {
            ValidResourceBounds::AllResources(all_resource_bounds) => {
                FeeCheckReport::check_gas_within_all_resource_bounds(
                    all_resource_bounds,
                    gas_vector,
                )
            }
