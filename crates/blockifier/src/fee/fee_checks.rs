...
impl FeeCheckReport {
    ...
    fn check_all_resources_within_bounds(
        ...
        for (resource, max_amount, actual_amount) in izip!(
            [Resource::L1Gas, Resource::L2Gas, Resource::L1DataGas],
            [
            ...
            [gas_vector.l1_gas, gas_vector.l2_gas, gas_vector.l1_data_gas]
        ) {
