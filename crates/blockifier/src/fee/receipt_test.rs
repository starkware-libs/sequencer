...
fn test_calculate_tx_gas_usage_basic<'a>(#[values(false, true)] use_kzg_da: bool) {
    ...
    let deploy_account_tx_starknet_resources = StarknetResources::new(
        ...
        signature_length,
        0,
        StateResources { state_changes_for_fee: deploy_account_state_changes_count },
        None,
        ExecutionSummary::default(),
    );
    ...
    let l2_to_l1_starknet_resources = StarknetResources::new(
        ...
        0,
        0,
        StateResources { state_changes_for_fee: l2_to_l1_state_changes_count },
        None,
    ...
    let manual_sharp_gas_usage = message_segment_length
        * eth_gas_constants::SHARP_GAS_PER_MEMORY_WORD
        + usize_from_u128(l2_to_l1_starknet_resources.state.to_gas_vector(use_kzg_da).l1_gas)
            .unwrap();
    ...
    let storage_writes_starknet_resources = StarknetResources::new(
        ...
        0,
        0,
        StateResources { state_changes_for_fee: storage_writes_state_changes_count },
        None,
        ExecutionSummary::default(),
    );
    ...
    let combined_cases_starknet_resources = StarknetResources::new(
        ...
        signature_length,
        0,
        StateResources { state_changes_for_fee: combined_state_changes_count },
        Some(l1_handler_payload_size),
        execution_summary.clone(),
    );
...
fn test_calculate_tx_gas_usage(
    ...
    let starknet_resources = StarknetResources::new(
        ...
        signature_length,
        0,
        StateResources { state_changes_for_fee: state_changes_count },
        None,
        ExecutionSummary::default(),
    );
