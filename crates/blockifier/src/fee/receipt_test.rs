...
fn assert_starknet_gas_matches_execution(
    expected_starknet_resources: &StarknetResources,
    actual_starknet_resources: &StarknetResources,
    versioned_constants: &VersionedConstants,
    use_kzg_da: bool,
    mode: &GasVectorComputationMode,
) {
    assert_eq!(
        expected_starknet_resources.to_gas_vector(versioned_constants, use_kzg_da, mode),
        actual_starknet_resources.to_gas_vector(versioned_constants, use_kzg_da, mode)
    );
}
...
fn test_calculate_tx_gas_usage(
    ...
    assert_starknet_gas_matches_execution(
        ...
        &trivial_tx_execution_info.receipt.resources.starknet_resources,
        versioned_constants,
        use_kzg_da,
        &gas_vector_computation_mode,
    );
    ...
    assert_starknet_gas_matches_execution(
        ...
        &transfer_tx_execution_info.receipt.resources.starknet_resources,
...
fn test_proof_facts_included_in_os_resources(#[values(false, true)] use_kzg_da: bool) {
    ...
    assert_starknet_gas_matches_execution(
        &starknet_resources,
        &tx_execution_info.receipt.resources.starknet_resources,
        &block_context.versioned_constants,
        use_kzg_da,
