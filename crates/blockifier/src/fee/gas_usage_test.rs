...
fn test_gas_computation_regression_test(
    ...
    let expected_gas_vector = match (&gas_vector_computation_mode, has_client_side_proof) {
        (GasVectorComputationMode::NoL2Gas, false) => match use_kzg_da {
            true => GasVector {
        ...
        (GasVectorComputationMode::NoL2Gas, true) => unreachable!(),
        (GasVectorComputationMode::All, false) => match use_kzg_da {
            true => GasVector {
        ...
        (GasVectorComputationMode::All, true) => match use_kzg_da {
            true => GasVector {
                l1_gas: GasAmount(21543),
                l1_data_gas: GasAmount(2720),
                l2_gas: GasAmount(1125514),
            },
            false => GasVector {
                l1_gas: GasAmount(62834),
                l1_data_gas: GasAmount(0),
