...
#[rstest]
#[case::l1_bound_overdraft(2*DEFAULT_L1_GAS_MAX_AMOUNT, DEFAULT_L2_GAS_MAX_AMOUNT, DEFAULT_ETH_L1_DATA_GAS_PRICE, Some(Resource::L1Gas))]
#[case::l2_bound_overdraft(DEFAULT_L1_GAS_MAX_AMOUNT, 2* DEFAULT_L2_GAS_MAX_AMOUNT, DEFAULT_L1_DATA_GAS_MAX_AMOUNT, Some(Resource::L2Gas))]
...
#[case::no_overdraft(DEFAULT_L1_GAS_MAX_AMOUNT/2, DEFAULT_L2_GAS_MAX_AMOUNT/2, DEFAULT_L1_DATA_GAS_MAX_AMOUNT/2, None)]
