...
#[rstest]
#[case::default(VersionedConstants::create_for_account_testing().tx_default_initial_gas(),
    GasVectorComputationMode::NoL2Gas
)]
#[case::from_l2_gas(5000, GasVectorComputationMode::All)]
fn test_initial_sierra_gas(
    ...
    let resource_bounds = match gas_mode {
        ...
        GasVectorComputationMode::All => ValidResourceBounds::AllResources(AllResourceBounds {
            l2_gas: ResourceBounds { max_amount: tx_gas_cost + expected, max_price_per_unit: 1 },
            ..Default::default()
        }),
    };
