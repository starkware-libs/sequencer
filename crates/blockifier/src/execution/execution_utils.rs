...
mod blake_cost {
    // U-32 counts
    pub const U32S_MESSAGE: usize = 16;
    pub const U32S_BIG_FELT: usize = 8;
    pub const U32S_SMALL_FELT: usize = 2;
...
fn compute_blake_hash_steps(n_big: usize, n_small: usize) -> usize {
    let total_u32s = n_big * blake_cost::U32S_BIG_FELT + n_small * blake_cost::U32S_SMALL_FELT;
    let rem_u32s = total_u32s % blake_cost::U32S_MESSAGE;
    ...
    n_big * blake_cost::STEPS_BIG_FELT + n_small * blake_cost::STEPS_SMALL_FELT + base
}
