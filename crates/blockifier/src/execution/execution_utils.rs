...
fn compute_blake_hash_steps(n_big_felts: usize, n_small_felts: usize) -> usize {
    let total_u32s =
        n_big_felts * blake_encoding::N_U32S_BIG_FELT + n_small_felts * blake_encoding::N_U32S_SMALL_FELT;
    ...
    let base_steps = if rem_u32s == 0 {
        ...
        // u32s.
        blake_estimation::BASE_STEPS_PARTIAL_MSG + blake_estimation::STEPS_PER_2_U32_REMINDER * (rem_u32s / 2)
    };
...
fn count_blake_opcode(n_big_felts: usize, n_small_felts: usize) -> usize {
    ...
    let full_msgs = total_u32s / blake_encoding::N_U32S_MESSAGE;
    let has_partial = total_u32s % blake_encoding::N_U32S_MESSAGE != 0;
