...
fn test_stack_trace(
    ...
    test_stack_trace_fn(block_context, cairo_version);
}
...
fn test_stack_trace_fn(block_context: BlockContext, cairo_version: CairoVersion) {
    let chain_info = ChainInfo::create_for_testing();
    let account = FeatureContract::AccountWithoutValidations(cairo_version);
    let test_contract = FeatureContract::TestContract(cairo_version);
    let mut state = test_state(&chain_info, BALANCE, &[(account, 1), (test_contract, 2)]);
...
"
    ...
    let expected_trace = match cairo_version {
        ...
        #[cfg(feature = "cairo_native")]
        CairoVersion::Native => expected_trace_cairo1,
    };
...
#[cfg_attr(
    ...
    case(CairoVersion::Native, "invoke_call_chain", "0x4469766973696f6e2062792030 ('Division by 0')", (0_u16, 0_u16))
)]
#[cfg_attr(
    feature = "cairo_native",
    case(CairoVersion::Native, "fail", "0x6661696c ('fail')", (0_u16, 0_u16))
)]
...
#[cfg_attr(
    feature = "cairo_native",
    case(CairoVersion::Native, "invoke_call_chain", "0x4469766973696f6e2062792030 ('Division by 0')", 1_u8, 0_u8, (9631_u16, 9631_u16, 0_u16, 0_u16))
)]
#[cfg_attr(
    feature = "cairo_native",
    case(CairoVersion::Native, "invoke_call_chain", "0x4469766973696f6e2062792030 ('Division by 0')", 1_u8, 1_u8, (9631_u16, 9700_u16, 0_u16, 0_u16))
)]
#[cfg_attr(
    feature = "cairo_native",
    case(CairoVersion::Native, "fail", "0x6661696c ('fail')", 0_u8, 0_u8, (9631_u16, 9631_u16, 0_u16, 0_u16))
)]
#[cfg_attr(
    feature = "cairo_native",
    case(CairoVersion::Native, "fail", "0x6661696c ('fail')", 0_u8, 1_u8, (9631_u16, 9700_u16, 0_u16, 0_u16))
)]
...
fn test_validate_trace_fn(
    ...
    let expected_error_cairo_1 = format!(
...
",
        ...
        CairoVersion::Cairo1 => expected_error_cairo_1,
        #[cfg(feature = "cairo_native")]
        CairoVersion::Native => expected_error_cairo_1,
    };
...
fn test_account_ctor_frame_stack_trace(
    ...
    test_account_ctor_frame_stack_trace_fn(block_context, cairo_version)
}
...
fn test_account_ctor_frame_stack_trace_fn(
    block_context: BlockContext,
    cairo_version: CairoVersion,
) {
...
fn test_contract_ctor_frame_stack_trace(
    ...
    test_contract_ctor_frame_stack_trace_fn(
        block_context,
        default_all_resource_bounds,
        cairo_version,
    )
...
/// point selector).
fn test_contract_ctor_frame_stack_trace_fn(
    block_context: BlockContext,
    default_all_resource_bounds: ValidResourceBounds,
    cairo_version: CairoVersion,
) {
...
",
        ...
        #[cfg(feature = "cairo_native")]
        CairoVersion::Native => {
            let frame_2_native = format!(
                "Error in the contract class {} constructor (selector: {:?}, address: {:?}): \
                 Execution failed. Failure reason:",
                faulty_class_hash.0.to_u64().unwrap(),
                Some(ctor_selector),
