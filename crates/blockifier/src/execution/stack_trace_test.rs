...
use crate::test_utils::{create_calldata, CairoVersion, RunnableCairoVersion, BALANCE};
...
"
    ...
    let expected_trace = match cairo_version {
        ...
        CairoVersion::Cairo1(RunnableCairoVersion::Casm) => expected_trace_cairo1,
...
#[case(CairoVersion::Cairo1(RunnableCairoVersion::Casm), "invoke_call_chain", "0x4469766973696f6e2062792030 ('Division by 0')", (0_u16, 0_u16))]
#[case(CairoVersion::Cairo1(RunnableCairoVersion::Casm), "fail", "0x6661696c ('fail')", (0_u16, 0_u16))]
...
#[case(CairoVersion::Cairo1(RunnableCairoVersion::Casm), "invoke_call_chain", "0x4469766973696f6e2062792030 ('Division by 0')", 1_u8, 0_u8, (9631_u16, 9631_u16, 0_u16, 0_u16))]
#[case(CairoVersion::Cairo1(RunnableCairoVersion::Casm), "invoke_call_chain", "0x4469766973696f6e2062792030 ('Division by 0')", 1_u8, 1_u8, (9631_u16, 9700_u16, 0_u16, 0_u16))]
#[case(CairoVersion::Cairo1(RunnableCairoVersion::Casm), "fail", "0x6661696c ('fail')", 0_u8, 0_u8, (9631_u16, 9631_u16, 0_u16, 0_u16))]
#[case(CairoVersion::Cairo1(RunnableCairoVersion::Casm), "fail", "0x6661696c ('fail')", 0_u8, 1_u8, (9631_u16, 9700_u16, 0_u16, 0_u16))]
...
",
        ...
        CairoVersion::Cairo1(RunnableCairoVersion::Casm) => format!(
