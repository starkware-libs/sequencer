...
pub fn call_contract(
    ...
    let entry_point = CallEntryPoint {
        ...
        initial_gas: syscall_handler.context.gas_costs().base_gas_costs.default_initial_gas_cost,
    };
    let retdata_segment =
...
pub fn deploy(
    ...
    let mut remaining_gas = syscall_handler.context.gas_costs().base_gas_costs.default_initial_gas_cost;
