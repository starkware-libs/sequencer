...
use crate::execution::syscalls::hint_processor::{EmitEventError, SyscallUsageStatsMap};
...
pub struct DeprecatedSyscallHintProcessor<'a> {
    ...
    pub syscall_usage_map: SyscallUsageStatsMap,
...
impl<'a> DeprecatedSyscallHintProcessor<'a> {
    pub fn new(
        ...
        DeprecatedSyscallHintProcessor {
            ...
            syscall_usage_map: SyscallUsageStatsMap::default(),
    ...
    fn increment_syscall_count(&mut self, selector: &DeprecatedSyscallSelector) {
        self.syscall_usage_map.entry(*selector).or_default().increment_call_count();
    }
