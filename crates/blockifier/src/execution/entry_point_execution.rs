...
fn prepare_program_extra_data(
    ...
    let builtin_price_array = [
        gas_costs.base_gas_costs.pedersen_gas_cost,
        gas_costs.base_gas_costs.bitwise_builtin_gas_cost,
        gas_costs.base_gas_costs.ecop_gas_cost,
        gas_costs.base_gas_costs.poseidon_gas_cost,
        gas_costs.base_gas_costs.add_mod_gas_cost,
        gas_costs.base_gas_costs.mul_mod_gas_cost,
    ];
