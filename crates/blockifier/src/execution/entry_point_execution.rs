...
use crate::execution::contract_class::{ContractClassV1, EntryPointV1, TrackingResource};
...
pub fn execute_entry_point_call(
    ...
    let tracking_resource =
        *context.tracking_resource.last().expect("Unexpected empty tracking resource.");
