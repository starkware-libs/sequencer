...
pub fn keccak(
    ...
    let n_rounds = syscall_base::keccak_base(syscall_handler.context, input_length, remaining_gas)?;
    ...
    for chunk in data.chunks(syscall_base::KECCAK_FULL_RATE_IN_WORDS) {
