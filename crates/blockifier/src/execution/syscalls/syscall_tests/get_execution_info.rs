...
/// Tests backward compatibility of the get_execution_info syscall with the legacy ExecutionInfoV1
/// Cairo struct.
#[rstest]
#[cfg_attr(
...
#[case::legacy_test_contract(FeatureContract::LegacyTestContract)]
