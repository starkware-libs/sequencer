...
#[cfg_attr(feature = "cairo_native", test_case(RunnableCairo1::Native, ExecutionMode::Execute, false; "Native, execute"))]
#[cfg_attr(feature = "cairo_native", test_case(RunnableCairo1::Native, ExecutionMode::Execute, true; "Native, execute, only_query"))]
#[cfg_attr(feature = "cairo_native", test_case(RunnableCairo1::Native, ExecutionMode::Validate, false; "Native, validate"))]
fn test_meta_tx_v0(
