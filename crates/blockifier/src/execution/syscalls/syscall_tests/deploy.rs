...
use crate::test_utils::entry_point_for_deploy;
...
fn no_constructor(runnable_version: RunnableCairo1) {
    ...
    let entry_point_call = entry_point_for_deploy(class_hash, &[], true, deployer_contract);
...
fn no_constructor_nonempty_calldata(runnable_version: RunnableCairo1) {
    ...
    let entry_point_call =
        entry_point_for_deploy(class_hash, &[felt!(1_u8), felt!(1_u8)], true, deployer_contract);
...
fn with_constructor(runnable_version: RunnableCairo1) {
    ...
    let entry_point_call =
        entry_point_for_deploy(class_hash, &constructor_calldata, true, deployer_contract);
...
fn calldata_length(cairo_version: CairoVersion) {
    ...
    let deploy_account_call = entry_point_for_deploy(
    ...
    let deploy_test_call = entry_point_for_deploy(
    ...
    let deploy_empty_call = entry_point_for_deploy(
