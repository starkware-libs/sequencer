...
#[test_case(CairoVersion::Cairo0, false; "cairo0_deploy_rejected")]
#[test_case(CairoVersion::Cairo1(RunnableCairo1::Casm), false; "cairo1_vm_deploy_rejected")]
#[test_case(CairoVersion::Cairo1(RunnableCairo1::Casm), true; "cairo1_vm_deploy_allowed")]
#[cfg_attr(
    feature = "cairo_native",
    test_case(CairoVersion::Cairo1(RunnableCairo1::Native), false; "cairo1_native_deploy_rejected")
)]
fn disable_deploy_in_validate_mode_flag_behavior(cairo_version: CairoVersion, allow_deploy: bool) {
    ...
    if !allow_deploy {
        assert!(
            block_context.versioned_constants.disable_deploy_in_validation_mode,
            "Deploy should be rejected by default in validate mode."
        );
    }
