...
#[cfg_attr(
    ...
    test_case(FeatureContract::TestContract(CairoVersion::Native), 155310;"Native")
)]
...
#[cfg_attr(
    feature = "cairo_native",
    test_case(FeatureContract::TestContract(CairoVersion::Native),173890, 13840;"Native")
)]
fn with_constructor(
