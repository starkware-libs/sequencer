...
#[test_case(CairoVersion::Cairo0, false; "cairo0_disabled")]
#[test_case(CairoVersion::Cairo0, true; "cairo0_allowed")]
#[test_case(CairoVersion::Cairo1(RunnableCairo1::Casm), false; "cairo1_vm_disabled")]
#[test_case(CairoVersion::Cairo1(RunnableCairo1::Casm), true; "cairo1_vm_allowed")]
#[cfg_attr(
    feature = "cairo_native",
    test_case(CairoVersion::Cairo1(RunnableCairo1::Native), false; "cairo1_native_disabled")
)]
#[cfg_attr(
    feature = "cairo_native",
    test_case(CairoVersion::Cairo1(RunnableCairo1::Native), false; "cairo1_native_allowed")
)]
fn disable_deploy_in_validate_mode_flag_behavior(cairo_version: CairoVersion, allow_deploy: bool) {
    // TODO(Yoni): share the init code of the tests in this file.
    ...
    // Ensure default behavior: deploy should be disallowed in validate mode.
    assert!(latest_disable_deploy_in_validation_mode_is_false());
...
/// Deploy is expected to be disabled by default in validate execution mode.
fn latest_disable_deploy_in_validation_mode_is_false() -> bool {
    let latest = VersionedConstants::latest_constants();
    !latest.disable_deploy_in_validation_mode
}
