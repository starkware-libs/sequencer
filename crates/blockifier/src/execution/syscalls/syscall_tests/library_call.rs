...
fn test_nested_library_call(test_contract: FeatureContract, expected_gas: u64) {
    ...
    let main_entry_point = CallEntryPoint {
        ...
        initial_gas: if_native(&test_contract)(9999584180, 9999906600),
        ..trivial_external_entry_point_new(test_contract)
    };
    let nested_storage_entry_point = CallEntryPoint {
        ...
        initial_gas: if_native(&test_contract)(9999255300, 9999597720),
        ..trivial_external_entry_point_new(test_contract)
    };
    let library_entry_point = CallEntryPoint {
        ...
        code_address: None,
        call_type: CallType::Delegate,
        initial_gas: if_native(&test_contract)(9999417480, 9999749900),
        ..trivial_external_entry_point_new(test_contract)
    };
    let storage_entry_point = CallEntryPoint {
        calldata: calldata![felt!(key), felt!(value)],
        initial_gas: if_native(&test_contract)(9999093360, 9999445780),
