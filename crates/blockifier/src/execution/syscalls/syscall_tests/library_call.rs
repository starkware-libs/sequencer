...
fn test_nested_library_call(runnable_version: RunnableCairo1) {
    ...
    expected_nested_gas_consumed
        .assert_debug_eq(&result.inner_calls[0].inner_calls[0].execution.gas_consumed);
    result.inner_calls[0].inner_calls[0].execution.gas_consumed = 0;
    expected_nested_initial_gas
        .assert_debug_eq(&result.inner_calls[0].inner_calls[0].call.initial_gas);
    result.inner_calls[0].inner_calls[0].call.initial_gas = 0;
    expected_library_call_gas_consumed
        .assert_debug_eq(&result.inner_calls[0].execution.gas_consumed);
    result.inner_calls[0].execution.gas_consumed = 0;
    expected_library_initial_gas.assert_debug_eq(&result.inner_calls[0].call.initial_gas);
    result.inner_calls[0].call.initial_gas = 0;
    expected_storage_call_gas_consumed
        .assert_debug_eq(&result.inner_calls[1].execution.gas_consumed);
    result.inner_calls[1].execution.gas_consumed = 0;
    expected_storage_initial_gas.assert_debug_eq(&result.inner_calls[1].call.initial_gas);
    result.inner_calls[1].call.initial_gas = 0;
