...
fn test_nested_library_call(runnable_version: RunnableCairo1) {
    ...
    let library_entry_point = CallEntryPoint {
        ...
        code_address: None,
        call_type: CallType::Delegate,
        initial_gas: 9999185840,
        ..trivial_external_entry_point_new(test_contract)
    };
    let storage_entry_point = CallEntryPoint {
        calldata: calldata![felt!(key), felt!(value)],
        initial_gas: 9998983290,
        ..nested_storage_entry_point
    };

    let storage_entry_point_gas = GasAmount(27690);
    ...
    let library_call_info = CallInfo {
        ...
        charged_resources: ChargedResources::from_gas(GasAmount(127900)),
