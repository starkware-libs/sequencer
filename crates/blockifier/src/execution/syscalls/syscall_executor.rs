...
use crate::blockifier_versioned_constants::{
    GasCosts, GasCostsError, SyscallGasCost, VersionedConstants,
};
...
use crate::execution::syscalls::secp::{
    Secp256r1NewRequest, Secp256r1NewResponse, SecpAddRequest, SecpAddResponse,
    SecpGetPointFromXRequest, SecpGetPointFromXResponse, SecpGetXyRequest, SecpGetXyResponse,
...
use crate::execution::syscalls::vm_syscall_utils::{
    ...
    GetClassHashAtResponse, GetExecutionInfoRequest, GetExecutionInfoResponse, KeccakRequest,
    KeccakResponse, LibraryCallRequest, LibraryCallResponse, MetaTxV0Request, MetaTxV0Response,
    ReplaceClassRequest, ReplaceClassResponse, SendMessageToL1Request, SendMessageToL1Response,
    Sha256ProcessBlockRequest, Sha256ProcessBlockResponse, StorageReadRequest, StorageReadResponse,
    StorageWriteRequest, StorageWriteResponse, SyscallExecutorBaseError, SyscallSelector,
    TryExtractRevert,
};
...
pub trait SyscallExecutor {
    ...
    /// Returns the next available Secp ID, determines at which offset the point will be written.
