...
fn leaf_cost(len: usize, versioned_constants: &VersionedConstants, blake_opcode_gas: usize) -> GasAmount {
...
fn node_cost(segs: &[NestedIntList], versioned_constants: &VersionedConstants, blake_opcode_gas: usize,) -> GasAmount {
    ...
    for seg in segs {
        match seg {
            NestedIntList::Leaf(len) => {
                ...
                gas = gas.checked_add_panic_on_overflow(leaf_cost(*len, versioned_constants, blake_opcode_gas));
            }
