...
pub fn estimate_casm_poseidon_hash_computation_resources(
    ...
    match bytecode_segment_lengths {
        NestedMultipleIntList::Leaf(length, _) => {
        ...
        NestedMultipleIntList::Node(segments) => {
            ...
            for segment in segments {
                let NestedMultipleIntList::Leaf(length, _) = segment else {
                    panic!(
...
fn get_visited_segments(
    segment_lengths: &NestedMultipleIntList,
