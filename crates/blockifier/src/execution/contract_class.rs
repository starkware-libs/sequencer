...
impl ContractClassV0 {
    ...
    pub fn get_entry_point(&self, call: &CallEntryPoint) -> Result<usize, PreExecutionError> {
        match get_entry_point(&ContractClass::V0(self.clone()), call)? {
            EntryPoint::V0(entry_point) => Ok(entry_point.offset.0),
