...
pub struct CallEntryPointEx<ClassHashT> {
    ...
    /// The type is `ClassHash` in the case of [CallEntryPointResolved] and `Option<ClassHash>`
...
impl From<CallEntryPointResolved> for CallEntryPoint {
    fn from(call: CallEntryPointResolved) -> Self {
        Self {
