...
pub trait EstimateCasmHashResources {
    ...
    fn estimated_resources_of_compiled_class_hash(
        ...
        resources += &self.cost_of_hash_entry_points(&entry_points_by_type.l1_handler);
        resources += &self.cost_of_hash_entry_points(&entry_points_by_type.external);
        resources += &self.cost_of_hash_entry_points(&entry_points_by_type.constructor);
    ...
    fn cost_of_hash_entry_points(
        ...
        for entry_point in entry_points {
            resources += &self.cost_of_hash_entry_points_inner(entry_point);
        }
    ...
    fn cost_of_hash_entry_points_inner(
        &self,
