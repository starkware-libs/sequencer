...
pub fn execute_entry_point_call(
    ...
    let mut syscall_handler: NativeSyscallHandler<'_> =
        NativeSyscallHandler::new(call.clone(), state, context);
    ...
    let call_initial_gas = match syscall_handler
        .base
        .call
        .initial_gas
        .checked_sub(syscall_handler.base.context.gas_costs().base.entry_point_initial_budget)
    {
        Some(gas) => gas,
        None => {
            return Ok(CallInfo {
