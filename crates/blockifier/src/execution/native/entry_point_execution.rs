...
fn create_callinfo(
    ...
    let syscall_builtins = version_constants
        ...
        .prover_builtins();
    let mut cairo_primitive_counters =
        builtin_stats_to_primitive_counters(call_result.builtin_stats);
    add_maps(&mut cairo_primitive_counters, &cairo_primitive_counter_map(syscall_builtins));
    ...
    Ok(CallInfo {
        ...
        builtin_counters: cairo_primitive_counters,
