...
fn convert_from_secp_256_k1_point(
    ...
    // Detect that here so cairo-native (which does have the flag) treats it as infinity rather
...
#[cfg(feature = "sierra-emu")]
fn is_u256_zero(x: &sierra_emu::starknet::U256) -> bool {
    x.lo == 0 && x.hi == 0
}
