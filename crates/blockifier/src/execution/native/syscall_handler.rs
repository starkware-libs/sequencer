...
impl StarknetSyscallHandler for &mut NativeSyscallHandler<'_> {
    fn get_block_hash(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.get_block_hash.get_base_syscall_cost(),
        )?;
    ...
    fn get_execution_info(&mut self, remaining_gas: &mut u64) -> SyscallResult<ExecutionInfo> {
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.get_execution_info.get_base_syscall_cost(),
        )?;
    ...
    fn get_class_hash_at(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.get_class_hash_at.get_base_syscall_cost(),
        )?;
    ...
    fn replace_class(&mut self, class_hash: Felt, remaining_gas: &mut u64) -> SyscallResult<()> {
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.replace_class.get_base_syscall_cost())?;
    ...
    fn library_call(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.library_call.get_base_syscall_cost())?;
    ...
    fn call_contract(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.call_contract.get_base_syscall_cost())?;
    ...
    fn storage_read(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.storage_read.get_base_syscall_cost())?;
    ...
    fn storage_write(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.storage_write.get_base_syscall_cost())?;
    ...
    fn emit_event(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.emit_event.get_base_syscall_cost())?;
    ...
    fn send_message_to_l1(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.send_message_to_l1.get_base_syscall_cost())?;
    ...
    fn keccak(&mut self, input: &[u64], remaining_gas: &mut u64) -> SyscallResult<U256> {
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.keccak.get_base_syscall_cost())?;
    ...
    fn secp256k1_new(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_new.get_base_syscall_cost())?;
    ...
    fn secp256k1_add(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_add.get_base_syscall_cost())?;
    ...
    fn secp256k1_mul(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_mul.get_base_syscall_cost())?;
    ...
    fn secp256k1_get_point_from_x(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.secp256k1_get_point_from_x.get_base_syscall_cost(),
        )?;
    ...
    fn secp256k1_get_xy(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_get_xy.get_base_syscall_cost())?;
    ...
    fn secp256r1_new(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_new.get_base_syscall_cost())?;
    ...
    fn secp256r1_add(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_add.get_base_syscall_cost())?;
        Ok(Secp256Point::add(p0.into(), p1.into()).into())
    }
    ...
    fn secp256r1_mul(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_mul.get_base_syscall_cost())?;
    ...
    fn secp256r1_get_point_from_x(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.secp256r1_get_point_from_x.get_base_syscall_cost(),
        )?;
    ...
    fn secp256r1_get_xy(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_get_xy.get_base_syscall_cost())?;
    ...
    fn sha256_process_block(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.sha256_process_block.get_base_syscall_cost(),
        )?;
