...
impl StarknetSyscallHandler for &mut NativeSyscallHandler<'_> {
    fn get_block_hash(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.get_block_hash.base)?;
    ...
    fn get_execution_info(&mut self, remaining_gas: &mut u64) -> SyscallResult<ExecutionInfo> {
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.get_execution_info.base)?;
    ...
    fn get_class_hash_at(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.get_class_hash_at.base)?;
    ...
    fn deploy(
        ...
        let deploy_gas_cost = self.gas_costs().syscalls.deploy;
        // The cost of deploying a contract is the base cost plus the linear cost of the calldata
        // len.
        let total_gas_cost =
            deploy_gas_cost.base + u64_from_usize(calldata.len()) * deploy_gas_cost.linear_factor;
    ...
    fn replace_class(&mut self, class_hash: Felt, remaining_gas: &mut u64) -> SyscallResult<()> {
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.replace_class.base)?;
    ...
    fn library_call(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.library_call.base)?;
    ...
    fn call_contract(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.call_contract.base)?;
    ...
    fn storage_read(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.storage_read.base)?;
    ...
    fn storage_write(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.storage_write.base)?;
    ...
    fn emit_event(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.emit_event.base)?;
    ...
    fn send_message_to_l1(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.send_message_to_l1.base)?;
    ...
    fn keccak(&mut self, input: &[u64], remaining_gas: &mut u64) -> SyscallResult<U256> {
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.keccak.base)?;
    ...
    fn secp256k1_new(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_new.base)?;
    ...
    fn secp256k1_add(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_add.base)?;
    ...
    fn secp256k1_mul(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_mul.base)?;
    ...
    fn secp256k1_get_point_from_x(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.secp256k1_get_point_from_x.base,
        )?;
    ...
    fn secp256k1_get_xy(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256k1_get_xy.base)?;
    ...
    fn secp256r1_new(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_new.base)?;
    ...
    fn secp256r1_add(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_add.base)?;
        Ok(Secp256Point::add(p0.into(), p1.into()).into())
    }
    ...
    fn secp256r1_mul(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_mul.base)?;
    ...
    fn secp256r1_get_point_from_x(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.secp256r1_get_point_from_x.base,
        )?;
    ...
    fn secp256r1_get_xy(
        ...
        self.pre_execute_syscall(remaining_gas, self.gas_costs().syscalls.secp256r1_get_xy.base)?;
    ...
    fn sha256_process_block(
        ...
        self.pre_execute_syscall(
            remaining_gas,
            self.gas_costs().syscalls.sha256_process_block.base,
        )?;
