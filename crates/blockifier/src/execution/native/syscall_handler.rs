...
impl<'state> StarknetSyscallHandler for &mut NativeSyscallHandler<'state> {
    ...
    fn keccak(&mut self, input: &[u64], remaining_gas: &mut u128) -> SyscallResult<U256> {
        self.substract_syscall_gas_cost(remaining_gas, self.context.gas_costs().keccak_gas_cost)?;
        ...
        *remaining_gas -= gas_cost;
        ...
        // TODO: For the keccak system call we want to count the number of rounds rather than the
