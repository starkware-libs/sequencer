...
impl GasCosts {
    ...
    pub fn get_syscall_gas_cost(&self, selector: &SyscallSelector) -> Result<u64, GasCostsError> {
        match selector {
            ...
            SyscallSelector::DelegateCall => Err(GasCostsError::UnvalidSyscall),
            SyscallSelector::DelegateL1Handler => Err(GasCostsError::UnvalidSyscall),
            SyscallSelector::GetBlockNumber => Err(GasCostsError::UnvalidSyscall),
            SyscallSelector::GetBlockTimestamp => Err(GasCostsError::UnvalidSyscall),
            SyscallSelector::GetSequencerAddress => Err(GasCostsError::UnvalidSyscall),
            SyscallSelector::GetTxSignature => Err(GasCostsError::UnvalidSyscall),
            SyscallSelector::LibraryCallL1Handler => Err(GasCostsError::UnvalidSyscall),
        }
    }
}
