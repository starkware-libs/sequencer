    ...
    pub fn create_for_account_testing() -> Self {
        let vm_resource_fee_cost = Arc::new(HashMap::from([
            (
                ...
                ResourceCosts::from_integers(1, 1),
            ),
            (
    ...
    pub fn create_float_for_testing() -> Self {
        let vm_resource_fee_cost = Arc::new(HashMap::from([
            (
                crate::abi::constants::N_STEPS_RESOURCE.to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(25, 10000),
                    l2_gas: ResourceCost::from_integer(100),
                },
            ),
            (
                BuiltinName::pedersen.to_str_with_suffix().to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(8, 100),
                    l2_gas: ResourceCost::from_integer(4049),
                },
            ),
            (
                BuiltinName::range_check.to_str_with_suffix().to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(4, 100),
                    l2_gas: ResourceCost::from_integer(57),
                },
            ),
            (
                BuiltinName::ecdsa.to_str_with_suffix().to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(512, 100),
                    l2_gas: ResourceCost::from_integer(10561),
                },
            ),
            (
                BuiltinName::bitwise.to_str_with_suffix().to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(16, 100),
                    l2_gas: ResourceCost::from_integer(582),
                },
            ),
            (
                BuiltinName::poseidon.to_str_with_suffix().to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(8, 100),
                    l2_gas: ResourceCost::from_integer(490),
                },
            ),
            (
                BuiltinName::output.to_str_with_suffix().to_string(),
                ResourceCosts::from_integers(0, 0),
            ),
            (
                BuiltinName::ec_op.to_str_with_suffix().to_string(),
                ResourceCosts {
                    l1_gas: ResourceCost::new(256, 100),
                    l2_gas: ResourceCost::from_integer(4084),
                },
            ),
        ]));
...
impl ResourceCosts {
    pub fn from_integers(l1_gas: u128, l2_gas: u128) -> Self {
        Self {
            l1_gas: ResourceCost::from_integer(l1_gas),
            l2_gas: ResourceCost::from_integer(l2_gas),
        }
    }
}
