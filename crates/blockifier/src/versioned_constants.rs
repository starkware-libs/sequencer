...
impl GasCosts {
    pub fn get_builtin_gas_cost(&self, builtin: &BuiltinName) -> Result<u64, GasCostsError> {
        let gas_cost = match *builtin {
            BuiltinName::range_check => self.builtins.range_check,
            BuiltinName::pedersen => self.builtins.pedersen,
            BuiltinName::bitwise => self.builtins.bitwise,
            BuiltinName::ec_op => self.builtins.ecop,
            BuiltinName::keccak => self.builtins.keccak,
            BuiltinName::poseidon => self.builtins.poseidon,
            BuiltinName::range_check96 => self.builtins.range_check,
            BuiltinName::add_mod => self.builtins.add_mod,
            BuiltinName::mul_mod => self.builtins.mul_mod,
            BuiltinName::ecdsa => self.builtins.ecdsa,
