...
>>>>>>> d6c671353 (chore(blockifier): create unit tests for contract_class_manager)
    }
    ...
    pub fn get_casm_path(&self) -> String {
        ...
        match self {
            ...
            _ => {
                let (version_dir, extension) = match self.cairo_version() {
                    CairoVersion::Cairo0 => ("0", "_compiled"),
                    CairoVersion::Cairo1(_) => ("1", ".casm"),
                };
                format!(
