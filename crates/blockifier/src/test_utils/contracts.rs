...
impl FeatureContract {
    ...
    fn has_all_versions(&self) -> bool {
        match self {
            ...
            | Self::TestContract(_)
            | Self::ERC20(_) => true,
            Self::SecurityTests | Self::LegacyTestContract(_) | Self::CairoStepsTestContract => {
                false
            }
        }
    }

    fn has_only_casm_and_native(&self) -> bool {
        match self {
            Self::AccountWithLongValidate(_)
            | Self::AccountWithoutValidations(_)
            | Self::Empty(_)
            ...
            | Self::SecurityTests
            | Self::ERC20(_)
            | Self::CairoStepsTestContract => false,
            Self::LegacyTestContract(_) => true,
        }
    }
