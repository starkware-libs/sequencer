...
use crate::blockifier::config::{ContractClassManagerConfig, RunCairoNativeOptions};
...
pub fn test_state_inner_with_contract_manager(
    ...
    let run_cairo_native_options = RunCairoNativeOptions::Off;
    #[cfg(feature = "cairo_native")]
    let run_cairo_native_options = RunCairoNativeOptions::WaitOnCompilation;
