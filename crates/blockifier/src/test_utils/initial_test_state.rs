...
use crate::blockifier::config::{CairoNativeRunMode, ContractClassManagerConfig};
...
pub fn test_state_inner_with_contract_manager(
    ...
    let cairo_native_run_mode = CairoNativeRunMode::Off;
    #[cfg(feature = "cairo_native")]
    let cairo_native_run_mode = CairoNativeRunMode::SynchronousCompilation;
