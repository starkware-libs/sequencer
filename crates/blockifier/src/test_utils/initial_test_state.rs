...
pub fn test_state_inner_with_contract_manager(
    ...
    let execution_mode = NativeExecutionMode::Disabled;
    #[cfg(feature = "cairo_native")]
    let execution_mode = NativeExecutionMode::Sync;

    let manager =
        ContractClassManager::start(ContractClassManagerConfig::create_for_testing(execution_mode));
