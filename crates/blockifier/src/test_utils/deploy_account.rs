...
pub fn deploy_account_tx(
    ...
    AccountTransaction::new(starknet_api::executable_transaction::Transaction::DeployAccount(
        DeployAccountTransaction { tx: deploy_account_tx, tx_hash, contract_address },
    ))
}