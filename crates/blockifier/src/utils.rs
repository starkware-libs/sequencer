...
// TODO(Meshi): Remove this once the trait is complete.
// Returns the compiled class hash v2 of the given class hash.
pub fn get_compiled_class_hash_v2(_state_reader: &impl StateReader, _class_hash: ClassHash) -> StateResult<CompiledClassHash> {
