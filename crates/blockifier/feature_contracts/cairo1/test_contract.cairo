...
mod TestContract {
    ...
    // Used resources in this function- Step: 12, Hole: 5, RangeCheck: 3.
    #[external(v0)]
    ...
    // This function has been taken taken from the compilers repo, and is used there to test successive use of circuits.
