...
///
/// ```bash
/// NODE_URL=https://your-rpc-node cargo test -p starknet_tx_prover -- --ignored
/// ```
#[rstest]
...
///     cargo test -p starknet_tx_prover test_simulate_and_get_initial_reads
///
...
/// # Record:
/// RECORD_RPC_RECORDS=1 NODE_URL=http://<privacy-env-node>/rpc/v0_10 \
///     cargo test -p starknet_tx_prover test_execute_with_prefetch -- --ignored
///
/// # Offline (after recording):
/// cargo test -p starknet_tx_prover test_execute_with_prefetch -- --ignored
/// ```
