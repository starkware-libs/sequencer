...
/// Run with:
/// ```shell
/// rustup run nightly-2025-07-14 cargo test -p starknet_tx_prover --release --features \
...
/// Run manually with:
/// ```bash
/// cargo test -p starknet_tx_prover --features stwo_proving -- --ignored regenerate_proof_fixtures
/// ```
#[tokio::test]
#[ignore]
