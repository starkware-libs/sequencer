// Per-component applicative config.
...
function(chain_params, node_params, replacers)
  ...
  local starknetUrl = chain_params.starknet_url;
  ...
  {
    base_layer_config: {
      bpo1_start_block_number: chain_params.base_layer_config.bpo1_start_block_number,
      bpo2_start_block_number: chain_params.base_layer_config.bpo2_start_block_number,
      fusaka_no_bpo_start_block_number: chain_params.base_layer_config.fusaka_no_bpo_start_block_number,
      ordered_l1_endpoint_urls: 'https://mainnet.infura.io/v3/YOUR_INFURA_API_KEY',
      retry_primary_interval_seconds: 60,
      starknet_contract_address: chain_params.base_layer_config.starknet_contract_address,
      timeout_millis: 1000,
    },
    batcher_config: {
      dynamic_config: {
    ...
    class_manager_config: {
      ...
      static_config: {
        class_manager_config: {
          ...
          max_compiled_contract_class_object_size: std.get(replacers, 'class_manager_config.static_config.class_manager_config.max_compiled_contract_class_object_size', 4089446),
        },
    ...
    gateway_config: {
      ...
      static_config: {
        authorized_declarer_accounts: std.get(replacers, 'gateway_config.static_config.authorized_declarer_accounts', null),
        block_declare: false,
        chain_info: {
          chain_id: chainId,
          fee_token_addresses: {
        ...
        stateful_tx_validator_config: {
          max_allowed_nonce_gap: std.get(replacers, 'gateway_config.static_config.stateful_tx_validator_config.max_allowed_nonce_gap', 200),
        ...
        stateless_tx_validator_config: {
          ...
          max_contract_bytecode_size: std.get(replacers, 'gateway_config.static_config.stateless_tx_validator_config.max_contract_bytecode_size', 81920),
          ...
          min_gas_price: std.get(replacers, 'gateway_config.static_config.stateless_tx_validator_config.min_gas_price', 8000000000),
          min_sierra_version: {
            major: 1,
            minor: 1,
            patch: 0,
    ...
    http_server_config: {
      ...
      static_config: {
        ...
        port: std.get(replacers, 'http_server_config.static_config.port', 8080),
      },
    },
    ...
    mempool_config: {
      dynamic_config: {
        transaction_ttl: std.get(replacers, 'mempool_config.dynamic_config.transaction_ttl', 300),
      },
      static_config: {
        behavior_mode: behaviorMode,
    ...
    mempool_p2p_config: {
      ...
      network_config: {
        ...
        port: std.get(replacers, 'mempool_p2p_config.network_config.port', 53200),
        prune_dead_connections_ping_interval: 15,
        prune_dead_connections_ping_timeout: 20,
        reported_peer_ids_buffer_size: 100000,
        secret_key: '',
    ...
    state_sync_config: {
      ...
      static_config: {
        ...
        central_sync_client_config: optionalStateSyncSubConfig(std.get(replacers, 'state_sync_config.static_config.central_sync_client_config', {}), defaultCentralSyncClientConfig),
        network_config: optionalStateSyncSubConfig(std.get(replacers, 'state_sync_config.static_config.network_config', null), defaultStateSyncNetworkConfig),
        p2p_sync_client_config: optionalStateSyncSubConfig(std.get(replacers, 'state_sync_config.static_config.p2p_sync_client_config', null), defaultP2pSyncClientConfig),
        revert_config: revertConfig,
        rpc_config: {
          ...
          max_events_keys: 100,
          port: std.get(replacers, 'state_sync_config.static_config.rpc_config.port', 8090),
          starknet_url: starknetUrl,
        },
        storage_config: {
          db_config: {
