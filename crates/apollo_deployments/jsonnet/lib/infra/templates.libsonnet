...
// scalar constants used when classifying components. Values mirror the Rust defaults in
// apollo_infra (LocalServerConfig / RemoteServerConfig / RemoteClientConfig) and the retry/idle
// policy in crates/apollo_deployments/src/scale_policy.rs + deployment_definitions.rs.
{
  DISABLED_PORT:: 0,
  LOCALHOST:: 'localhost',
