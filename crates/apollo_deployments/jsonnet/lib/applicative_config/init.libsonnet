...
function(chain_params, node_params, replacers)
  {
    ...
    class_manager_config: classManager(chain_params, replacers),
    ...
    http_server_config: httpServer(replacers),
    ...
    mempool_p2p_config: mempoolP2p(chain_params, replacers),
    monitoring_config: monitoring(),
    monitoring_endpoint_config: monitoringEndpoint(replacers),
