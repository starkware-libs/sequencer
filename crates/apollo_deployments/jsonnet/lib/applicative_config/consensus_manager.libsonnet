  ...
  local behaviorMode = 'starknet';
  {
    ...
    consensus_manager_config: {
      dynamic_config: {
        ...
        require_virtual_proposer_vote: replacers['consensus_manager_config.consensus_manager_config.dynamic_config.require_virtual_proposer_vote'],
        stop_at_height: null,
        ...
        timeouts: {
          ...
          proposal: {
            base: replacers['consensus_manager_config.consensus_manager_config.dynamic_config.timeouts.proposal.base'],
            delta: 0.0,
            max: replacers['consensus_manager_config.consensus_manager_config.dynamic_config.timeouts.proposal.max'],
          },
        },
    ...
    context_config: {
      dynamic_config: {
        build_proposal_margin_millis: replacers['consensus_manager_config.context_config.dynamic_config.build_proposal_margin_millis'],
        compare_retrospective_block_hash: replacers['consensus_manager_config.context_config.dynamic_config.compare_retrospective_block_hash'],
        ...
        min_l2_gas_price_per_height: replacers['consensus_manager_config.context_config.dynamic_config.min_l2_gas_price_per_height'],
        override_eth_to_fri_rate: replacers['consensus_manager_config.context_config.dynamic_config.override_eth_to_fri_rate'],
        override_l1_data_gas_price_fri: replacers['consensus_manager_config.context_config.dynamic_config.override_l1_data_gas_price_fri'],
        override_l1_gas_price_fri: replacers['consensus_manager_config.context_config.dynamic_config.override_l1_gas_price_fri'],
        override_l2_gas_price_fri: replacers['consensus_manager_config.context_config.dynamic_config.override_l2_gas_price_fri'],
    ...
    network_config: {
      ...
      port: replacers['consensus_manager_config.network_config.port'],
    ...
    staking_manager_config: {
      dynamic_config: {
        ...
        override_committee: replacers['consensus_manager_config.staking_manager_config.dynamic_config.override_committee'],
      },
      static_config: {
