...
function(chain_params, node_params)
  {
    ...
    network_config: {
      advertised_multiaddr: utils.advertisedMultiaddr(chain_params.mempool_bootstrap_peer_multiaddr, node_params.node_index, chain_params.nodes_at_same_cluster),
