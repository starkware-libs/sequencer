...
function(chain_params, node_params)
  {
    ...
    network_config: {
      advertised_multiaddr: utils.advertisedMultiaddr(chain_params.consensus_bootstrap_peer_multiaddr, node_params.node_index, chain_params.nodes_at_same_cluster),
    ...
    staking_manager_config: {
      dynamic_config: {
        default_committee: chain_params.staking_default_committee,
