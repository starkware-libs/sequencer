local utils = import 'lib/applicative_config/utils.libsonnet';
...
function(chain_params, node_params)
  {
    ...
    consensus_manager_config: {
      dynamic_config: {
        ...
        timeouts: {
          ...
          proposal: {
            base: chain_params.proposal_timeout_base,
            delta: 0.0,
            max: chain_params.proposal_timeout_max,
          },
        },
        validator_id: node_params.validator_id,
      },
      static_config: {
    ...
    context_config: {
      dynamic_config: {
        ...
        compare_retrospective_block_hash: chain_params.compare_retrospective_block_hash,
        ...
        min_l2_gas_price_per_height: chain_params.min_l2_gas_price_per_height,
        override_eth_to_fri_rate: chain_params.override_eth_to_fri_rate,
        override_l1_data_gas_price_fri: chain_params.override_l1_data_gas_price_fri,
        override_l1_gas_price_fri: chain_params.override_l1_gas_price_fri,
        override_l2_gas_price_fri: chain_params.override_l2_gas_price_fri,
    ...
    network_config: {
      advertised_multiaddr: utils.advertisedMultiaddr(chain_params.consensus_bootstrap_peer_multiaddr, node_params.node_index, chain_params.mandatory.nodes_at_same_cluster),
      bootstrap_peer_multiaddr: chain_params.consensus_bootstrap_peer_multiaddr,
    ...
    staking_manager_config: {
      dynamic_config: {
        default_committee: chain_params.mandatory.staking_default_committee,
