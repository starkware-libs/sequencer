...
function(chain_params, replacers)
  {
    dynamic_config: {
      n_concurrent_txs: replacers['batcher_config.dynamic_config.n_concurrent_txs'],
      native_classes_whitelist: replacers.native_classes_whitelist,
      proposer_idle_detection_delay_millis: replacers['batcher_config.dynamic_config.proposer_idle_detection_delay_millis'],
    ...
    static_config: {
      block_builder_config: {
        bouncer_config: {
          block_max_capacity: {
            ...
            n_events: replacers['batcher_config.static_config.block_builder_config.bouncer_config.block_max_capacity.n_events'],
            n_txs: 500,
            proving_gas: 5000000000,
            receipt_l2_gas: replacers['batcher_config.static_config.block_builder_config.bouncer_config.block_max_capacity.receipt_l2_gas'],
            sierra_gas: 5000000000,
            state_diff_size: replacers['batcher_config.static_config.block_builder_config.bouncer_config.block_max_capacity.state_diff_size'],
          },
        ...
        chain_info: {
          ...
          fee_token_addresses: {
            eth_fee_token_address: replacers.eth_fee_token_address,
            strk_fee_token_address: replacers.strk_fee_token_address,
          },
          is_l3: false,
        },
        execute_config: {
          n_workers: replacers['batcher_config.static_config.block_builder_config.execute_config.n_workers'],
          stack_size: 62914560,
        },
        versioned_constants_overrides: replacers.versioned_constants_overrides,
      },
      ...
      first_block_with_partial_block_hash: replacers['batcher_config.static_config.first_block_with_partial_block_hash'],
      ...
      validation_only: replacers.validation_only,
    },
  }
