...
function(chain_params, replacers)
  ...
  };
  {
    ...
    static_config: {
      ...
      central_sync_client_config: optionalStateSyncSubConfig(replacers['state_sync_config.static_config.central_sync_client_config'], defaultCentralSyncClientConfig),
      network_config: optionalStateSyncSubConfig(replacers['state_sync_config.static_config.network_config'], defaultStateSyncNetworkConfig),
      p2p_sync_client_config: optionalStateSyncSubConfig(replacers['state_sync_config.static_config.p2p_sync_client_config'], defaultP2pSyncClientConfig),
      ...
      rpc_config: {
        ...
        execution_config: {
          ...
          eth_fee_contract_address: replacers.eth_fee_token_address,
          strk_fee_contract_address: replacers.strk_fee_token_address,
        },
        ip: '0.0.0.0',
