...
pub(crate) fn testing_env_2_hybrid_deployments() -> Vec<Deployment> {
    vec![
        testing_env_2_hybrid_deployment_node(0, DeploymentType::New),
        testing_env_2_hybrid_deployment_node(1, DeploymentType::New),
        testing_env_2_hybrid_deployment_node(2, DeploymentType::New),
        testing_env_2_hybrid_deployment_node(3, DeploymentType::New),
    ]
}
