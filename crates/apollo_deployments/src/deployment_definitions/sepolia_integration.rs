...
pub(crate) fn sepolia_integration_hybrid_deployments() -> Vec<Deployment> {
    vec![
        sepolia_integration_hybrid_deployment_node(0, DeploymentType::New),
        sepolia_integration_hybrid_deployment_node(1, DeploymentType::New),
        sepolia_integration_hybrid_deployment_node(2, DeploymentType::New),
        sepolia_integration_hybrid_deployment_node(3, DeploymentType::New),
    ]
}
