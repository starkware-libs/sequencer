...
pub(crate) fn testing_env_3_hybrid_deployments() -> Vec<Deployment> {
    vec![
        testing_env_3_hybrid_deployment_node(0, DeploymentType::New),
        testing_env_3_hybrid_deployment_node(1, DeploymentType::New),
        testing_env_3_hybrid_deployment_node(2, DeploymentType::New),
        testing_env_3_hybrid_deployment_node(3, DeploymentType::New),
    ]
}
