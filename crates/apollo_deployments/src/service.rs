...
pub static KEYS_TO_BE_REPLACED: phf::Set<&'static str> = phf_set! {
    ...
    "consensus_manager_config.network_config.advertised_multiaddr.domain",
    "consensus_manager_config.network_config.advertised_multiaddr.peer_id",
    "consensus_manager_config.network_config.advertised_multiaddr.port",
    "consensus_manager_config.network_config.bootstrap_peer_multiaddr.#is_none",
    "consensus_manager_config.network_config.bootstrap_peer_multiaddr.domain",
    "consensus_manager_config.network_config.bootstrap_peer_multiaddr.peer_id",
    "consensus_manager_config.network_config.bootstrap_peer_multiaddr.port",
    ...
    "mempool_p2p_config.network_config.advertised_multiaddr.domain",
    "mempool_p2p_config.network_config.advertised_multiaddr.peer_id",
    "mempool_p2p_config.network_config.advertised_multiaddr.port",
    "mempool_p2p_config.network_config.bootstrap_peer_multiaddr.#is_none",
    "mempool_p2p_config.network_config.bootstrap_peer_multiaddr.domain",
    "mempool_p2p_config.network_config.bootstrap_peer_multiaddr.peer_id",
    "mempool_p2p_config.network_config.bootstrap_peer_multiaddr.port",
