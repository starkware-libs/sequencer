...
pub static KEYS_TO_BE_REPLACED: phf::Set<&'static str> = phf_set! {
    ...
    "consensus_manager_config.context_config.dynamic_config.override_l1_data_gas_price_wei.#is_none",
    "consensus_manager_config.context_config.dynamic_config.override_l1_data_gas_price_wei",
    "consensus_manager_config.context_config.dynamic_config.override_l1_gas_price_wei.#is_none",
    "consensus_manager_config.context_config.dynamic_config.override_l1_gas_price_wei",
