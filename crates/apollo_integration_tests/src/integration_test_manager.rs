...
impl NodeSetup {
    pub fn new(
        ...
        let http_server_config =
            Self::get_executable_by_component(&executables, ComponentConfigInService::HttpServer)
                .base_app_config
                .get_config()
                .http_server_config
                .as_ref()
    ...
    pub fn get_batcher(&self) -> &ExecutableSetup {
        Self::get_executable_by_component(&self.executables, ComponentConfigInService::Batcher)
    }

    pub fn get_http_server(&self) -> &ExecutableSetup {
        Self::get_executable_by_component(&self.executables, ComponentConfigInService::HttpServer)
    }

    pub fn get_state_sync(&self) -> &ExecutableSetup {
        Self::get_executable_by_component(&self.executables, ComponentConfigInService::StateSync)
    }

    pub fn get_consensus_manager(&self) -> &ExecutableSetup {
        Self::get_executable_by_component(&self.executables, ComponentConfigInService::Consensus)
    }
