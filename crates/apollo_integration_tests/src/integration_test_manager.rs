...
pub const BLOCKS_TO_WAIT_FOR_DECLARE: BlockNumber =
...
impl IntegrationTestManager {
    ...
    pub async fn send_declare_txs_and_verify(&mut self) {
        info!("Sending a declare tx and waiting for block {}.", BLOCKS_TO_WAIT_FOR_DECLARE);
        self.test_and_verify(DeclareTx, DEFAULT_SENDER_ACCOUNT, BLOCKS_TO_WAIT_FOR_DECLARE).await;
    }
