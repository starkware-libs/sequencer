...
fn prepare_state_diff(
    ...
    state_diff_builder.set_contracts(std::slice::from_ref(erc20_contract)).declare(&HashVersion::V2).deploy();
...
impl<'a> ThinStateDiffBuilder<'a> {
    ...
    fn inject_deployed_accounts_into_state(
        ...
        self.set_contracts(deployed_accounts_defined_in_the_test).declare(&HashVersion::V2).deploy().fund();
    ...
    fn inject_undeployed_accounts_into_state(
        ...
        self.set_contracts(undeployed_accounts_defined_in_the_test).declare(&HashVersion::V1).fund();
    }
