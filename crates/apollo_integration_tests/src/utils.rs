...
pub fn create_node_config(
    ...
    let validate_resource_bounds_above_threshold = !allow_bootstrap_txs;
    let mempool_config = create_mempool_config(validate_resource_bounds_above_threshold);
...
pub fn create_mempool_config(validate_resource_bounds_above_threshold: bool) -> MempoolConfig {
    MempoolConfig {
