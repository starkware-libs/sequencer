...
/// Same account class as `create_integration_test_tx_generator`, but registered as already
/// deployed. Used for proof-flow integration that runs a single invoke per block.
