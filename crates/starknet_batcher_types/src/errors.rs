...
pub enum BatcherError {
    ...
    InternalError,
    #[error(
        "Invalid next block number. The active height is {active_height}, got {next_block_number}."
    )]
    InvalidNextBlockNumber { active_height: BlockNumber, next_block_number: BlockNumber },
