...
// impl TryFrom<protobuf::ConsensusTransaction> for (Transaction, TransactionHash) {
//     type Error = ProtobufConversionError;

//     fn try_from(value: protobuf::ConsensusTransaction) -> Result<Self, Self::Error> {
//         let transaction = value.txn.ok_or(ProtobufConversionError::MissingField {
//             field_description: "ConsensusTransaction::txn",
//         })?;
//         let transaction_hash =
//             value.transaction_hash.ok_or(ProtobufConversionError::MissingField {
//                 field_description: "ConsensusTransaction::transaction_hash",
//             })?;
//         match transaction {
//             protobuf::consensus_transaction::Txn::DeclareV3(declare_v3) => {
//                 Ok((
//                     Transaction::Declare(DeclareTransaction::V3(DeclareTransactionV3::try_from(
//                         declare_v3,
//                     )?)),
//                     TransactionHash(transaction_hash),
//                 ))
//             }
//             protobuf::consensus_transaction::Txn::Deploy(deploy) => {
//                 Ok((
//                     Transaction::Deploy(DeployTransaction::try_from(deploy)?),
//                     TransactionHash(transaction_hash),
//                 ))
//             }
//             protobuf::consensus_transaction::Txn::DeployAccountV1(deploy_account_v1) => {
//                 Ok((
//                     Transaction::DeployAccount(DeployAccountTransaction::V1(
//                         DeployAccountTransactionV1::try_from(deploy_account_v1)?,
//                     )),
...
//                 ))
//             }
//             protobuf::consensus_transaction::Txn::DeployAccountV3(deploy_account_v3) => {
//                 Ok((
//                     Transaction::DeployAccount(DeployAccountTransaction::V3(
//                         DeployAccountTransactionV3::try_from(deploy_account_v3)?,
//                     )),
...
//                 ))
//             }
//             protobuf::consensus_transaction::Txn::InvokeV0(invoke_v0) => {
//                 Ok((
//                     Transaction::Invoke(InvokeTransaction::V0(InvokeTransactionV0::try_from(
//                         invoke_v0,
//                     )?)),
//                     TransactionHash(transaction_hash),
//                 ))
//             }
//             protobuf::consensus_transaction::Txn::InvokeV
//         }
//     }
// }
