...
auto_impl_into_and_try_from_vec_u8!(
    RpcTransactionWrapper<RpcTransaction>,
    protobuf::RpcTransaction
);

impl TryFrom<protobuf::RpcTransaction> for RpcTransactionWrapper<RpcTransaction> {
...
impl From<RpcTransactionWrapper<RpcTransaction>> for protobuf::RpcTransaction {
    fn from(value: RpcTransactionWrapper<RpcTransaction>) -> Self {
