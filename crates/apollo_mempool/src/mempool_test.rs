...
fn test_fee_escalation_valid_replacement(
    ...
    for increased_value in increased_values {
        ...
        if in_pending_queue {
            ...
            let gas_price_threshold = if escalte_to_priority { 91 } else { 1000 };
        ...
        // Test and assert.
        let expected_in_priority_queue = in_priority_queue || escalte_to_priority;
        let expected_in_pending_queue = in_pending_queue && !escalte_to_priority;
        add_tx_and_verify_replacement(
            mempool,
            valid_replacement_input,
