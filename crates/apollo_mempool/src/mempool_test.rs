...
fn metrics_correctness() {
    ...
    //    invoke_5  |    4    | Pending queue
    //    declare_1 |    5    | Priority queue
    //    declare_2 |    6    | Delayed declare
    ...
    let invoke_5 = add_tx_input!(tx_hash: 4, address: "0x3", tx_nonce: 0, account_nonce: 0, tip: 100, max_l2_gas_price: 99);
    let declare_1 = declare_add_tx_input(
        declare_tx_args!(resource_bounds: test_valid_resource_bounds(), sender_address: contract_address!("0x4"), tx_hash: tx_hash!(5)),
    );
