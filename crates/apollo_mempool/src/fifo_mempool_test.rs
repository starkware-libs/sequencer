...
fn test_get_txs_returns_in_fifo_order(mut mempool: Mempool) {
    ...
    for i in 1..=5 {
        mempool.update_tx_block_metadata(tx_hash!(i), 1000, BlockNumber(100));
    }
...
fn test_get_txs_more_than_all_eligible_txs(mut mempool: Mempool) {
    ...
    mempool.update_tx_block_metadata(tx_hash!(1), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(2), 1000, BlockNumber(100));
...
fn test_commit_block_rewinds_non_committed_transactions(mut mempool: Mempool) {
    ...
    mempool.update_tx_block_metadata(tx_hash!(1), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(2), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(3), 1000, BlockNumber(100));
...
fn test_commit_block_committed_and_rejected_no_rewind(mut mempool: Mempool) {
    ...
    mempool.update_tx_block_metadata(tx_hash!(11), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(22), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(33), 1000, BlockNumber(100));
...
fn test_get_txs_does_not_return_txs_with_different_timestamp(mut mempool: Mempool) {
    ...
    mempool.update_tx_block_metadata(tx_hash!(1), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(2), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(3), 2000, BlockNumber(200));
    mempool.update_tx_block_metadata(tx_hash!(4), 2000, BlockNumber(200));
...
fn test_rewind_preserves_timestamp_order(mut mempool: Mempool) {
    ...
    mempool.update_tx_block_metadata(tx_hash!(1), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(2), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(3), 1000, BlockNumber(100)); // tx3 also has timestamp 1000
    mempool.update_tx_block_metadata(tx_hash!(4), 2000, BlockNumber(200)); // tx4 has timestamp 2000
...
fn test_timestamp_order_matches_insertion_order(mut mempool: Mempool) {
    ...
    mempool.update_tx_block_metadata(tx_hash!(1), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(2), 2000, BlockNumber(200));
    mempool.update_tx_block_metadata(tx_hash!(3), 1000, BlockNumber(100));
    mempool.update_tx_block_metadata(tx_hash!(4), 2000, BlockNumber(200));
...
fn test_rewind_many_transactions_from_same_address(mut mempool: Mempool) {
    ...
    for i in 0..=4 {
        mempool.update_tx_block_metadata(tx_hash!(10 + i), 1000, BlockNumber(100));
    }
