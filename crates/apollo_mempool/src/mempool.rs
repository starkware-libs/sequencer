...
impl Mempool {
    ...
    /// Perform validation only of an incoming transaction.
    #[instrument(skip(self), err)]
    pub fn validate_tx(&mut self, args: ValidationArgs) -> MempoolResult<()> {
        let tx_reference = TransactionReference::from_validation_args(&args);
...
impl TransactionReference {
    ...
    pub fn from_validation_args(args: &ValidationArgs) -> Self {
        TransactionReference {
