...
define_metrics!(
    Mempool => {
        ...
        MetricHistogram { TRANSACTION_TIME_TO_COMMIT, "mempool_transaction_time_to_commit", "The time (secs) that a transaction spent in the mempool until it was committed" },
    },
);
...
pub(crate) fn register_metrics() {
    ...
    TRANSACTION_TIME_TO_COMMIT.register();
}
