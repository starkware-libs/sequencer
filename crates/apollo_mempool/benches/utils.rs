...
impl TransactionGenerator {
    ...
    fn generate_invoke(&mut self, index: usize) -> AddTransactionArgs {
        ...
        AddTransactionArgs {
            ...
            account_state: AccountState { address: self.sender_address, nonce: Nonce(0.into()) },
        }
    }
}
...
impl BenchTestSetup {
    ...
    pub async fn mempool_add_get_txs(&self) {
        ...
        // Create barrier for task synchronization - 2 parties (add_task + get_task)
