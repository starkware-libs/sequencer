...
async fn test_new_class_execution_info(#[values(true, false)] use_kzg_da: bool) {
    ...
    let expected_execution_info = ExpectedExecutionInfo::new(
        ...
        *NON_TRIVIAL_RESOURCE_BOUNDS,
        ...
        ProofFacts::from(vec![felt!(3_u16), felt!(1_u16), felt!(2_u16), felt!(3_u16)]),
    )
    .to_syscall_result();
    let invoke_tx_args = invoke_tx_args! {
        sender_address: *FUNDED_ACCOUNT_ADDRESS,
        ...
        resource_bounds: *NON_TRIVIAL_RESOURCE_BOUNDS,
        proof_facts: ProofFacts::from(vec![felt!(1_u16), felt!(2_u16), felt!(3_u16)]),
    };
