...
use starknet_patricia::utils::filter_inner_nodes_from_commitments;
...
pub(crate) fn get_previous_and_new_contract_states<I: Iterator<Item = ContractAddress>>(
    ...
    // Leaf modifications are needed to compare and warn for trivial updates; we don't need that.
    let leaf_modifications = LeafModifications::new();
