...
use starknet_committer::block_committer::timing_util::NoTimeMeasurement;
...
pub(crate) async fn commit_state_diff(
    ...
    let filled_forest = CommitBlockImpl::commit_block(input, facts_db, &mut NoTimeMeasurement)
        .await
