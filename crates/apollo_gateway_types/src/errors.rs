...
impl From<GatewaySpecError> for DeprecatedGatewayError {
    fn from(value: GatewaySpecError) -> Self {
        ...
        match value {
            ...
            GatewaySpecError::ContractClassSizeIsTooLarge => {
                ...
                // allowed size: {}".
                message = "Cannot declare contract class, size is too large.".to_string();
            }
            ...
            GatewaySpecError::UnsupportedContractClassVersion => {
                ...
                message = "Unexpected contract class version.".to_string();
            }
            GatewaySpecError::UnsupportedTxVersion => {
                ...
                message =
                    "Transaction version is not supported. Supported versions: [3].".to_string();
            }
        ...
        Self { code: format!("StarknetErrorCode.{code}"), message: message.to_string() }
    }
}
