...
// Version 4 is deploy_account only; the per-type gate is the serde of the transaction enums, so
// this list only shapes the deprecated endpoint's fallback version error.
