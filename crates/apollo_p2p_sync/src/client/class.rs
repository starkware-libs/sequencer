...
impl ClassStreamBuilder {
    ...
    pub fn create_stream(
        mut sqmr_sender: SqmrClientSender<
            ClassQuery,
    ...
    fn parse_data_for_block_with_config<'a>(
        ...
        'a,
        Result<Option<(DeclaredClasses, DeprecatedDeclaredClasses, BlockNumber)>, ParseDataError>,
    > {
        async move {
    ...
    fn get_internal_block_at<'a>(
        internal_blocks_received: &'a mut HashMap<
            BlockNumber,
