// This test is used to test the storage opening in two separate processes.
// It runs as an integration test because forking a process within a unit test acts unexpectedly.
...
use apollo_storage::{StorageConfig, StorageError, StorageReader, StorageScope, open_storage};
...
/// Note: This function is a copy from the private test_utils.rs module.
fn get_test_config_with_path(storage_scope: Option<StorageScope>, path: PathBuf) -> StorageConfig {
