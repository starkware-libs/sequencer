...
pub mod erc_20 {
    ...
    const INITIAL_SUPPLY: u256 = 0x80000000000000000000000000000000;
    ...
    impl StorageImpl of StorageTrait {
        fn transfer_helper(
            ...
            assert(Zero::is_non_zero(@sender), 'ERC20: transfer from 0');
            assert(Zero::is_non_zero(@recipient), 'ERC20: transfer to 0');
        ...
        fn approve_helper(
            ...
            assert(Zero::is_non_zero(@spender), 'ERC20: approve from 0');
