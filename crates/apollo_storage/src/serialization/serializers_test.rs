...
// NOTE: Temporary backward-compatibility test for legacy on-disk InvokeTransactionV3
// records stored before `proof_facts` was added.
//
// Ensures deserialization succeeds and defaults `proof_facts` to empty when missing.
