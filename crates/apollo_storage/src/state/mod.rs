    ...
    Key: Copy + PartialOrd,
{
    ...
    loop {
        ...
        // TODO(yoav): define StorageBlockNumber type that wraps a u32 and use it here, as currently
        // block number is serialized as u32 (see impl StorageSerde for BlockNumber).
