...
macro_rules! scan_cases {
    (
        ...
        #[case::happy_flow(
            $key_macro!(1_u8), $key_macro!("0x6"), BlockNumber(1), usize::MAX,
            vec![
        ...
        #[case::block_in_future(
            $key_macro!(1_u8), $key_macro!("0x6"), BlockNumber(1000), usize::MAX,
            vec![
                ($key_macro!(1_u8), $value_macro!(SCAN_VALUES_BLOCK_1[1])),
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
                ($key_macro!(4_u8), $value_macro!(SCAN_VALUES_BLOCK_1[4])),
        ...
        #[case::state_at_block_zero(
            $key_macro!(1_u8), $key_macro!("0x6"), BlockNumber(0), usize::MAX,
            vec![
        ...
        #[case::range_start_outside_end_inside(
            $key_macro!("0x0"), $key_macro!(4_u8), BlockNumber(1), usize::MAX,
            vec![
                ($key_macro!(1_u8), $value_macro!(SCAN_VALUES_BLOCK_1[1])),
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
            ],
        ...
        #[case::limit_truncates_result(
            $key_macro!("0x2"), $key_macro!("0x6"), BlockNumber(1), 2,
            vec![
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
                ($key_macro!(4_u8), $value_macro!(SCAN_VALUES_BLOCK_1[4])),
            ],
