...
/// Generates `#[rstest]` and shared `#[case]` definitions for `scan_synced_block` tests.
///
...
macro_rules! scan_cases {
    (
        ...
        #[case::happy_flow(
            $key_macro!(1_u8), Some($key_macro!("0x6")), BlockNumber(1), usize::MAX,
            vec![
        ...
        #[case::block_in_future(
            $key_macro!(1_u8), Some($key_macro!("0x6")), BlockNumber(1000), usize::MAX,
            vec![
                ($key_macro!(1_u8), $value_macro!(SCAN_VALUES_BLOCK_1[1])),
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
                ($key_macro!(4_u8), $value_macro!(SCAN_VALUES_BLOCK_1[4])),
        ...
        #[case::state_at_block_zero(
            $key_macro!(1_u8), Some($key_macro!("0x6")), BlockNumber(0), usize::MAX,
            vec![
        ...
        #[case::key_not_yet_in_state(
            $key_macro!(5_u8), Some($key_macro!("0x6")), BlockNumber(0), usize::MAX,
            vec![],
        )]
        // Range [0x6, 0xa) is entirely outside the populated key space.
        #[case::range_both_ends_outside(
            $key_macro!("0x6"), Some($key_macro!("0xa")), BlockNumber(1), usize::MAX,
            vec![],
        )]
        // Range [0x4, 0xa): start inside, end beyond the last key.
        #[case::range_start_inside_end_outside(
            $key_macro!(4_u8), Some($key_macro!("0xa")), BlockNumber(1), usize::MAX,
            vec![
                ($key_macro!(4_u8), $value_macro!(SCAN_VALUES_BLOCK_1[4])),
                ($key_macro!(5_u8), $value_macro!(SCAN_VALUES_BLOCK_1[5])),
            ],
        ...
        #[case::range_start_outside_end_inside(
            $key_macro!("0x0"), Some($key_macro!(4_u8)), BlockNumber(1), usize::MAX,
            vec![
                ($key_macro!(1_u8), $value_macro!(SCAN_VALUES_BLOCK_1[1])),
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
            ],
        ...
        #[case::limit_truncates_result(
            $key_macro!("0x2"), Some($key_macro!("0x6")), BlockNumber(1), 2,
            vec![
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
                ($key_macro!(4_u8), $value_macro!(SCAN_VALUES_BLOCK_1[4])),
            ],
        )]
        // No upper bound — returns all entries at block 1.
        #[case::none_end(
            $key_macro!("0x0"), None, BlockNumber(1), usize::MAX,
            vec![
                ($key_macro!(1_u8), $value_macro!(SCAN_VALUES_BLOCK_1[1])),
                ($key_macro!(3_u8), $value_macro!(SCAN_VALUES_BLOCK_1[3])),
                ($key_macro!(4_u8), $value_macro!(SCAN_VALUES_BLOCK_1[4])),
...
scan_cases!(
    ...
    fn test_scan_synced_block(
        ...
        assert_eq!(
            state_reader
                .scan_contract_class_hashes_in_range(start, end, synced_block, limit)
                .unwrap(),
            expected,
        );
    }
...
scan_cases!(
    ...
    fn test_scan_compiled_class_hashes_in_range(
        ...
        assert_eq!(
            state_reader
                .scan_compiled_class_hashes_in_range(start, end, synced_block, limit)
                .unwrap(),
            expected,
        );
    }
