...
fn write_classes<'env>(
    ...
    // Note: This offset update is part of the MDBX transaction and won't be committed
    // until StorageTxn::commit() is called, which does a synchronous flush of the mmap
    // files before committing. This ensures the mmap data is on disk before the offset
    // is updated, maintaining crash safety.
