...
fn open_storage_internal(
    ...
    let tables = Arc::new(Tables {
        ...
        // Flat state tables.
        flat_contract_storage: db_writer.create_simple_table("flat_contract_storage")?,
...
struct_field_names! {
    ...
    struct Tables {
        ...
        flat_contract_storage: TableIdentifier<(ContractAddress, StorageKey), NoVersionValueWrapper<Felt>, SimpleTable>,
        ...
        // Pre-image tables (sequencer mode, DupSort).
