...
impl StorageWriter {
    ...
    fn new(file_writers: FileHandlers<RW>, scope: StorageScope, shared_state: SharedStorageState) -> Self {
    ...
    pub fn begin_rw_txn(&mut self) -> StorageResult<StorageTxn<'_, RW>> {
        ...
        // Arc<Mutex<SharedState>>, ensuring the transaction remains valid for the
