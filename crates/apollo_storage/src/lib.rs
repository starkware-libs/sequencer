...
pub fn open_storage(
    ...
    let tables = Arc::new(Tables {
        ...
        compiled_class_hash_v2: db_writer.create_simple_table("compiled_class_hash_v2")?,
    });
...
struct_field_names! {
    struct Tables {
        ...
        compiled_class_hash_v2: TableIdentifier<ClassHash, NoVersionValueWrapper<CompiledClassHash>, SimpleTable>
    }
}
