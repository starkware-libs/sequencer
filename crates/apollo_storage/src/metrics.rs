...
define_metrics!(
    Storage => {
        ...
        MetricGauge { SYNC_STORAGE_OPEN_READ_TRANSACTIONS, "storage_open_sync_read_transactions", "The number of open sync  read transactions" },
        MetricGauge { BATCHER_STORAGE_OPEN_READ_TRANSACTIONS, "storage_open_batcher_read_transactions", "The number of open batcher read transactions" },
        MetricGauge { CLASS_MANAGER_STORAGE_OPEN_READ_TRANSACTIONS, "storage_open_class_manager_read_transactions", "The number of open class manager read transactions" },
    },
);
