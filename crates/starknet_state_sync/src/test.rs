...
async fn test_get_storage_at() {
    ...
    // Verify we get ContractNotFound error when trying to call get_storage_at with an unknown
    // contract_address.
...
async fn test_get_nonce_at() {
    ...
    // Verify we get ContractNotFound error when trying to call get_nonce_at with an unknown
    // contract_address.
    let other_address = ContractAddress::from(expected_address_u64 + 1);
    let result =
...
async fn get_class_hash_at() {
    ...
    // Verify we get ContractNotFound error when trying to call get_class_hash_at with an unknown
    // contract_address.
    let other_address = ContractAddress::from(expected_address_u64 + 1);
    let result =
