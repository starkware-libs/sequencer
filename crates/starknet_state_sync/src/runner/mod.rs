...
pub struct StateSyncRunner {
    ...
    // TODO: change client and server to request and responder respectively
    p2p_sync_client_future: BoxFuture<'static, Result<(), P2PSyncClientError>>, // requester
    p2p_sync_server_future: BoxFuture<'static, ()>,                             // responder
}
