...
use crate::class_manager::{increment_deprecated_n_classes_metric, increment_n_classes_metric};
...
impl<S: ClassStorage> ClassStorage for CachedClassStorage<S> {
    ...
    fn set_deprecated_class(
        ...
        increment_deprecated_n_classes_metric();
