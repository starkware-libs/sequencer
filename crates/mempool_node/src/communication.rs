...
use starknet_mempool_p2p_types::communication::{
    ...
    PropagatorRequestAndResponseSender,
...
pub struct SequencerNodeCommunication {
    ...
    propagator_channel: ComponentCommunication<PropagatorRequestAndResponseSender>,
}
...
impl SequencerNodeCommunication {
    ...
    pub fn take_propagator_tx(&mut self) -> Sender<PropagatorRequestAndResponseSender> {
        self.propagator_channel.take_tx()
    }

    pub fn take_propagator_rx(&mut self) -> Receiver<PropagatorRequestAndResponseSender> {
...
pub fn create_node_channels() -> SequencerNodeCommunication {
    ...
    let (tx_propagator, rx_propagator) =
        channel::<PropagatorRequestAndResponseSender>(DEFAULT_INVOCATIONS_QUEUE_SIZE);
    ...
    SequencerNodeCommunication {
        ...
        propagator_channel: ComponentCommunication::new(Some(tx_propagator), Some(rx_propagator)),
    }
}
