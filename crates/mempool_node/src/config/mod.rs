...
impl SerializeConfig for ComponentConfig {
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        ...
        let mut sub_configs = vec![
            ...
            append_sub_config_name(self.sequencer_monitoring.dump(), "sequenser_monitoring"),
        ];
...
pub struct SequencerNodeConfig {
    ...
    #[validate]
    pub sequenser_monitoring_config: SequencerMonitoringEndpointConfig,
}
...
impl SerializeConfig for SequencerNodeConfig {
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        ...
        let mut sub_configs = vec![
            ...
            append_sub_config_name(
                self.sequenser_monitoring_config.dump(),
                "sequenser_monitoring_config",
            ),
        ];
...
impl Default for SequencerNodeConfig {
    fn default() -> Self {
        Self {
            ...
            sequenser_monitoring_config: Default::default(),
        }
    }
}
