...
use crate::metrics::{bundle_local_server_metrics, LocalServerMetrics};
...
const TEST_MSGS_RECEIVED: MetricCounter = MetricCounter::new(
    MetricScope::Infra,
    "test_msgs_received",
    "Test received messages counter",
    0,
);
...
pub fn bundle_testing_local_server_metrics() -> LocalServerMetrics {
    bundle_local_server_metrics(&TEST_MSGS_RECEIVED, &TEST_MSGS_PROCESSED, &TEST_QUEUE_DEPTH)
}
