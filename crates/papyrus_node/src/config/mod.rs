...
pub struct NodeConfig {
    ...
    pub p2p_sync_server: Option<P2pSyncServerConfig>,
...
impl Default for NodeConfig {
    fn default() -> Self {
        NodeConfig {
            ...
            p2p_sync: None,
            p2p_sync_server: Some(P2pSyncServerConfig::default()),
            consensus: None,
            context: None,
            network: None,
...
impl SerializeConfig for NodeConfig {
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        ...
        let mut sub_configs = vec![
            ...
            ser_optional_sub_config(&self.p2p_sync_server, "p2p_sync_server"),
