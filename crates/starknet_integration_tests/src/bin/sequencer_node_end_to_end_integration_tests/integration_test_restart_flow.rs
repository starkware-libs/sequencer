...
async fn main() {
    ...
    integration_test_manager.send_txs_and_verify(N_TXS, BLOCK_TO_SHUTDOWN_AT).await;
    ...
    integration_test_manager.send_txs_and_verify(N_TXS, BLOCK_TO_RESTART_FROM).await;
    ...
    integration_test_manager.send_txs_and_verify(N_TXS, BLOCK_TO_WAIT_FOR_AFTER_RESTART).await;
