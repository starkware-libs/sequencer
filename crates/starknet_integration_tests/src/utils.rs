...
pub fn create_node_config(
    ...
    let base_layer_config_required_params = EthereumBaseLayerConfigRequiredParams {
        node_url: base_layer_config.node_url.clone(),
        port: base_layer_config.port,
    };
    ...
    (
        ...
        RequiredParams {
            ...
            validator_id,
            recorder_url,
            base_layer_config: base_layer_config_required_params,
