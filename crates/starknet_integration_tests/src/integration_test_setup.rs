...
impl ExecutableSetup {
    ...
    pub async fn new(
        ...
        let (eth_to_fri_oracle_url, _join_handle) =
            spawn_local_eth_to_fri_oracle(available_ports.get_next_port());
        consensus_manager_config.eth_to_fri_oracle_config.base_url = eth_to_fri_oracle_url;
