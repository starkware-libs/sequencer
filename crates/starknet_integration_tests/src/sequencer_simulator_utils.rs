...
use crate::utils::{send_consensus_txs, send_message_to_l2, TestScenario};
...
impl SequencerSimulator {
    ...
    pub async fn send_l1_handler_tx(
        ...
        info!("Sending L1 handler: {:?}", send_message_to_l2_args);
        send_message_to_l2(&send_message_to_l2_args, &self.starknet_l1_contract).await;
    ...
    pub async fn send_txs(
        ...
        let send_l1_handler_tx_fn =
            &mut |send_message_to_l2_args| self.send_l1_handler_tx(send_message_to_l2_args);
