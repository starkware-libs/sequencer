...
use apollo_client::reader::objects::block::BlockPostV0_13_1;
...
async fn stream_state_updates() {
    ...
    let client_state_diff1 = apollo_client::reader::StateDiff {
    ...
    let client_state_diff2 = apollo_client::reader::StateDiff::default();
