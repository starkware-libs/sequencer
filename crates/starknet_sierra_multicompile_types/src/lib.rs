...
pub type RawClass = RawClassData<SierraContractClass>;
pub type RawExecutableClass = RawClassData<ContractClass>;
...
pub struct RawClassData<T>(serde_json::Value, std::marker::PhantomData<T>);

impl<T> RawClassData<T> {
