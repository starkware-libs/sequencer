...
impl TryFrom<protobuf::CommitmentParts> for CommitmentParts {
    ...
    fn try_from(value: protobuf::CommitmentParts) -> Result<Self, Self::Error> {
        let next_l2_gas_price_fri = value
            .next_l2_gas_price_fri
            .ok_or(missing("next_l2_gas_price_fri"))?
            .into();
        ...
        let parent_commitment = value
            .parent_commitment
            .ok_or(missing("parent_commitment"))?
            .try_into()?;
        Ok(CommitmentParts {
