...
impl TryFrom<protobuf::ProposalFinExtra> for ProposalFinExtra {
    type Error = ProtobufConversionError;
...
impl From<ProposalFinExtra> for protobuf::ProposalFinExtra {
...
impl TryFrom<protobuf::ProposalFin> for ProposalFin {
    ...
    fn try_from(value: protobuf::ProposalFin) -> Result<Self, Self::Error> {
        ...
        let fin_extra = value.fin_extra.map(TryInto::try_into).transpose()?;
        Ok(ProposalFin { proposal_commitment, executed_transaction_count, fin_extra })
    }
}
...
impl From<ProposalFin> for protobuf::ProposalFin {
    fn from(value: ProposalFin) -> Self {
        protobuf::ProposalFin {
            ...
            fin_extra: value.fin_extra.map(Into::into),
        }
    }
}
