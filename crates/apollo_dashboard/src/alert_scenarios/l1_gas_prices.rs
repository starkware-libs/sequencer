...
pub(crate) fn get_snip35_strk_usd_success_count_alert() -> Alert {
    const ALERT_NAME: &str = "snip35_strk_usd_success_count";
    oracle_success_count_alert(
        ALERT_NAME,
...
pub(crate) fn get_snip35_strk_usd_error_count_alert() -> Alert {
    oracle_error_count_alert(
        "snip35_strk_usd_error_count",
