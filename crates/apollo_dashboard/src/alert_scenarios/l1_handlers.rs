...
/// Fires when a single L1 handler transaction has been pending on L1 (uncommitted to L2) for too
...
pub(crate) fn get_l1_handler_pending_too_long_alert() -> Alert {
    const ALERT_NAME: &str = "l1_handler_pending_too_long";
    ...
    Alert::new(
        ALERT_NAME,
        "L1 handler pending on L1 too long",
        EvaluationRate::Default,
