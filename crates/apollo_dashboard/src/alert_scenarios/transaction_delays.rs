...
use crate::alert_placeholders::ExpressionOrExpressionWithPlaceholder;
use crate::alerts::{
    Alert,
    AlertComparisonOp,
    AlertCondition,
...
fn get_high_empty_blocks_ratio_alert(
    ...
    // TODO(Tsabary): consider how to insert the same placeholder in both locations.
    ...
    Alert::new(
        ...
        ExpressionOrExpressionWithPlaceholder::Placeholder(
            ...
            vec![
                format!("{}-zero_bucket", ALERT_NAME).to_string(),
                format!("{}-total_count", ALERT_NAME).to_string(),
            ],
        ),
