...
fn get_l1_gas_price_scraper_baselayer_success_count_alert() -> Alert {
    Alert {
        name: "l1_gas_price_scraper_baselayer_success_count",
        title: "L1 gas price scraper baselayer success count",
        alert_group: AlertGroup::L1GasPrice,
        expr: format!(
            "increase({}[1h])",
            L1_GAS_PRICE_SCRAPER_BASELAYER_SUCCESS_COUNT.get_name_with_filter()
        ),
        conditions: &[AlertCondition {
            comparison_op: AlertComparisonOp::LessThan,
