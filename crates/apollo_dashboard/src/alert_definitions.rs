...
fn get_consensus_build_proposal_failed_alert_alert() -> Alert {
    Alert {
...
fn get_consensus_validate_proposal_failed_alert_alert() -> Alert {
    Alert {
...
fn get_consensus_inbound_stream_evicted_alert_alert() -> Alert {
    Alert {
...
fn get_consensus_votes_num_sent_messages_alert_alert() -> Alert {
    Alert {
...
fn get_cende_write_blob_failure_alert_alert() -> Alert {
    Alert {
...
fn get_consensus_round_above_zero_alert_alert() -> Alert {
    Alert {
...
fn get_l1_gas_price_scraper_baselayer_error_count_alert_alert() -> Alert {
    Alert {
...
fn get_l1_gas_price_provider_insufficient_history_alert_alert() -> Alert {
    Alert {
...
fn get_l1_message_scraper_baselayer_error_count_alert_alert() -> Alert {
    Alert {
        name: "l1_message_scraper_baselayer_error_count",
        title: "L1 message scraper baselayer error count",
...
pub fn get_apollo_alerts_alert() -> Alerts {
    Alerts::new(vec![
        get_consensus_block_number_stuck_alert(),
        get_consensus_build_proposal_failed_alert_alert(),
        get_consensus_validate_proposal_failed_alert_alert(),
        get_consensus_votes_num_sent_messages_alert_alert(),
        get_consensus_decisions_reached_by_consensus_stuck_alert(),
        get_consensus_inbound_stream_evicted_alert_alert(),
        get_cende_write_prev_height_blob_latency_too_high_alert(),
        get_cende_write_blob_failure_alert_alert(),
        get_consensus_l1_gas_price_provider_error_rate_alert(),
        get_consensus_round_above_zero_alert_alert(),
        get_consensus_conflicting_votes_rate_alert(),
        get_gateway_add_tx_rate_drop_alert(),
        get_gateway_add_tx_latency_increase_alert(),
        get_l1_gas_price_scraper_baselayer_error_count_alert_alert(),
        get_l1_gas_price_provider_insufficient_history_alert_alert(),
        get_l1_message_scraper_baselayer_error_count_alert_alert(),
