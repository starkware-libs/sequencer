...
use crate::panels::consensus::{
    ...
    PANEL_CONSENSUS_ETH_TO_STRK_ORACLE_ERROR,
    ...
    PANEL_CONSENSUS_L1_GAS_PRICE_PROVIDER_ERROR,
...
const CONSENSUS_GAS_PRICE_ROW: Row = Row::new(
    "ConsensusGasPrice",
    "Consensus gas price metrics",
    &[PANEL_CONSENSUS_L1_GAS_PRICE_PROVIDER_ERROR, PANEL_CONSENSUS_ETH_TO_STRK_ORACLE_ERROR],
);
