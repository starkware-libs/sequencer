use apollo_compile_to_casm::metrics::COMPILATION_LATENCY;
...
use crate::panels::consensus::{
    PANEL_CENDE_LAST_PREPARED_BLOB_BLOCK_NUMBER, PANEL_CENDE_PREPARE_BLOB_FOR_NEXT_HEIGHT_LATENCY, PANEL_CENDE_WRITE_BLOB_FAILURE, PANEL_CENDE_WRITE_BLOB_SUCCESS, PANEL_CENDE_WRITE_PREV_HEIGHT_BLOB_LATENCY, PANEL_CONSENSUS_BLOCK_NUMBER, PANEL_CONSENSUS_BUILD_PROPOSAL_FAILED, PANEL_CONSENSUS_BUILD_PROPOSAL_TOTAL, PANEL_CONSENSUS_CACHED_VOTES, PANEL_CONSENSUS_DECISIONS_REACHED_BY_CONSENSUS, PANEL_CONSENSUS_DECISIONS_REACHED_BY_SYNC, PANEL_CONSENSUS_HELD_LOCKS, PANEL_CONSENSUS_MAX_CACHED_BLOCK_NUMBER, PANEL_CONSENSUS_NEW_VALUE_LOCKS, PANEL_CONSENSUS_NUM_BATCHES_IN_PROPOSAL, PANEL_CONSENSUS_NUM_CONNECTED_PEERS, PANEL_CONSENSUS_NUM_TXS_IN_PROPOSAL, PANEL_CONSENSUS_PROPOSALS_INVALID, PANEL_CONSENSUS_PROPOSALS_NUM_RECEIVED_MESSAGES, PANEL_CONSENSUS_PROPOSALS_NUM_SENT_MESSAGES, PANEL_CONSENSUS_PROPOSALS_RECEIVED, PANEL_CONSENSUS_PROPOSALS_VALIDATED, PANEL_CONSENSUS_PROPOSALS_VALID_INIT, PANEL_CONSENSUS_REPROPOSALS, PANEL_CONSENSUS_ROUND, PANEL_CONSENSUS_TIMEOUTS_BY_TYPE, PANEL_CONSENSUS_VOTES_NUM_RECEIVED_MESSAGES, PANEL_CONSENSUS_VOTES_NUM_SENT_MESSAGES
};
...
pub const COMPILE_TO_CASM_ROW: Row =
    Row::new("Compile sierra to casm", "Compile to casm metrics", &[PANEL_COMPILATION_LATENCY]);
