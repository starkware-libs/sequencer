...
use apollo_class_manager::metrics::{
    CLASS_MANAGER_ALL_METRICS, INFRA_ALL_METRICS as CLASS_MANAGER_INFRA_METRICS,
};
use apollo_compile_to_casm::metrics::{
    COMPILE_TO_CASM_ALL_METRICS, INFRA_ALL_METRICS as COMPILE_TO_CASM_INFRA_METRICS,
};
...
use apollo_l1_gas_price::metrics::{
    INFRA_ALL_METRICS as L1_GAS_PRICE_INFRA_METRICS, L1_GAS_PRICE_ALL_METRICS,
};
use apollo_l1_provider::metrics::{
    INFRA_ALL_METRICS as L1_PROVIDER_INFRA_METRICS, L1_PROVIDER_ALL_METRICS,
};
use apollo_mempool::metrics::{INFRA_ALL_METRICS as MEMPOOL_INFRA_METRICS, MEMPOOL_ALL_METRICS};
use apollo_mempool_p2p::metrics::{
    INFRA_ALL_METRICS as MEMPOOL_P2P_INFRA_METRICS, MEMPOOL_P2P_ALL_METRICS,
};
use apollo_state_sync_metrics::metrics::{
    INFRA_ALL_METRICS as STATE_SYNC_INFRA_METRICS, STATE_SYNC_ALL_METRICS,
};
