...
const BLOCK_DURATIONS_LOG_QUERY: &str = "durations in ms (total/read/compute/write):";
const RATES_LOG_QUERY: &str = "rates (read/compute/write):";
const COUNT_MODIFICATIONS_LOG_QUERY: &str =
    "modifications count (storage_tries/contracts_trie/classes_trie/emptied_storage_leaves):";
