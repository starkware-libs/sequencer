...
fn get_panel_consensus_proposals_received() -> Panel {
    Panel::new(
        "Proposals Received",
        "The total number of proposals received from the network",
...
fn get_panel_consensus_proposals_validated() -> Panel {
    Panel::new(
        ...
        "The total number of proposals received and validated successfully",
...
fn get_panel_consensus_proposals_invalid() -> Panel {
    Panel::new(
        ...
        "The total number of proposals received and failed validation",
...
fn get_panel_consensus_build_proposal_total() -> Panel {
    Panel::new(
        "Proposal Build",
        "The total number of proposals that started building",
...
fn get_panel_consensus_build_proposal_failed() -> Panel {
    Panel::new(
        ...
        "The total number of proposals that failed to be built",
...
fn get_panel_consensus_num_batches_in_proposal() -> Panel {
    Panel::new(
        "Number of Batches in Proposal Received",
        "The number of transaction batches in a valid proposal received",
