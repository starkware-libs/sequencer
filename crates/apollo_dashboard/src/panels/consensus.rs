...
use apollo_consensus::metrics::{
    CONSENSUS_BLOCK_NUMBER, CONSENSUS_BUILD_PROPOSAL_FAILED, CONSENSUS_BUILD_PROPOSAL_TOTAL,
    CONSENSUS_CONFLICTING_VOTES, CONSENSUS_DECISIONS_REACHED_AS_PROPOSER,
    CONSENSUS_DECISIONS_REACHED_BY_CONSENSUS, CONSENSUS_DECISIONS_REACHED_BY_SYNC,
    CONSENSUS_PROPOSALS_INVALID, CONSENSUS_PROPOSALS_RECEIVED, CONSENSUS_PROPOSALS_VALIDATED,
    CONSENSUS_ROUND, CONSENSUS_ROUND_ABOVE_ZERO, CONSENSUS_ROUND_ADVANCES, CONSENSUS_TIMEOUTS,
    LABEL_NAME_TIMEOUT_TYPE,
};
use apollo_consensus_manager::metrics::{
    CONSENSUS_NETWORK_EVENTS, CONSENSUS_NUM_CONNECTED_PEERS, CONSENSUS_PING_LATENCY,
    CONSENSUS_PROPOSALS_DROPPED_MESSAGE_SIZE, CONSENSUS_PROPOSALS_NUM_DROPPED_MESSAGES,
    CONSENSUS_PROPOSALS_NUM_RECEIVED_MESSAGES, CONSENSUS_PROPOSALS_NUM_SENT_MESSAGES,
    CONSENSUS_PROPOSALS_RECEIVED_MESSAGE_SIZE, CONSENSUS_PROPOSALS_SENT_MESSAGE_SIZE,
    ...
    CONSENSUS_VOTES_RECEIVED_MESSAGE_SIZE, CONSENSUS_VOTES_SENT_MESSAGE_SIZE,
};
use apollo_consensus_orchestrator::metrics::{
    ...
    CENDE_WRITE_PREV_HEIGHT_BLOB_LATENCY, CONSENSUS_BUILD_PROPOSAL_FAILURE, CONSENSUS_L2_GAS_PRICE,
    CONSENSUS_VALIDATE_PROPOSAL_FAILURE, LABEL_BUILD_PROPOSAL_FAILURE_REASON,
    LABEL_CENDE_FAILURE_REASON, LABEL_VALIDATE_PROPOSAL_FAILURE_REASON,
};
...
use crate::query_builder::{
    DEFAULT_DURATION, DisplayMethod, RANGE_DURATION, increase, sum_by_label,
};

// The key events that are relevant to the consensus panel.
const CONSENSUS_KEY_EVENTS_LOG_QUERY: &str = "\"START_HEIGHT:\" OR \"START_ROUND\" OR textPayload=~\"DECISION_REACHED\" OR \
