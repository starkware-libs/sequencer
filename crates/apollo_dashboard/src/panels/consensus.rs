...
use apollo_consensus_orchestrator::metrics::{
    ...
    CONSENSUS_ETH_TO_STRK_ORACLE_ERROR,
...
pub(crate) const PANEL_CONSENSUS_INBOUND_STREAM_STARTED: Panel =
    Panel::from_counter(CONSENSUS_INBOUND_STREAM_STARTED, PanelType::Stat);
pub(crate) const PANEL_CONSENSUS_INBOUND_STREAM_EVICTED: Panel =
    Panel::from_counter(CONSENSUS_INBOUND_STREAM_EVICTED, PanelType::Stat);
pub(crate) const PANEL_CONSENSUS_INBOUND_STREAM_FINISHED: Panel =
    Panel::from_counter(CONSENSUS_INBOUND_STREAM_FINISHED, PanelType::Stat);
pub(crate) const PANEL_CONSENSUS_OUTBOUND_STREAM_STARTED: Panel =
    Panel::from_counter(CONSENSUS_OUTBOUND_STREAM_STARTED, PanelType::Stat);
pub(crate) const PANEL_CONSENSUS_OUTBOUND_STREAM_FINISHED: Panel =
    Panel::from_counter(CONSENSUS_OUTBOUND_STREAM_FINISHED, PanelType::Stat);
...
pub(crate) const PANEL_CONSENSUS_L1_GAS_PRICE_PROVIDER_ERROR: Panel =
    Panel::from_counter(CONSENSUS_L1_GAS_PRICE_PROVIDER_ERROR, PanelType::Stat);
pub(crate) const PANEL_CONSENSUS_ETH_TO_STRK_ORACLE_ERROR: Panel =
    Panel::from_counter(CONSENSUS_ETH_TO_STRK_ORACLE_ERROR, PanelType::Stat);
