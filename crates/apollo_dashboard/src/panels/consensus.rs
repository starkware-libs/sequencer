...
fn get_panel_consensus_proposals_sent_message_size_bytes() -> Panel {
    Panel::new(
        ...
        "The rate of bytes sent by the consensus p2p component over the Proposals topic (bytes \
         per second)",
        format!(
            "rate({}[{}])",
...
fn get_panel_consensus_proposals_received_message_size_bytes() -> Panel {
    Panel::new(
        ...
        "The rate of bytes received by the consensus p2p component over the Proposals topic \
         (bytes per second)",
        format!(
            "rate({}[{}])",
...
fn get_panel_consensus_proposals_dropped_message_size_bytes() -> Panel {
    Panel::new(
        ...
        "The rate of bytes dropped by the consensus p2p component over the Proposals topic (bytes \
         per second)",
        format!(
            "rate({}[{}])",
