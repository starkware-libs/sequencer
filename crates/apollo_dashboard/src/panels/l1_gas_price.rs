...
fn get_panel_local_queue_depth() -> Panel {
    Panel::new(
        ...
        vec![
            L1_GAS_PRICE_PROVIDER_LOCAL_HIGH_PRIORITY_QUEUE_DEPTH.get_name_with_filter().to_string(),
            L1_GAS_PRICE_PROVIDER_LOCAL_NORMAL_PRIORITY_QUEUE_DEPTH.get_name_with_filter().to_string(),
        ],
