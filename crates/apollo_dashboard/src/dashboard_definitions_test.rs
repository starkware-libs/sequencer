...
const BINARY_NAME: &str = "sequencer_dashboard_generator";
...
fn default_dev_grafana_dashboard() {
    serialize_to_file_test(SEQUENCER_DASHBOARD, DEV_JSON_PATH, BINARY_NAME);
    serialize_to_file_test(SEQUENCER_ALERTS, DEV_ALERTS_JSON_PATH, BINARY_NAME);
}
