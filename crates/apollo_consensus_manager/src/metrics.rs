...
define_metrics!(
    ConsensusManager => {
        ...
        MetricCounter { CONSENSUS_NUM_NO_PEERS_SUBSCRIBED_ERRORS, "apollo_consensus_num_no_peers_subscribed_errors", "The number of NoPeersSubscribedToTopic errors encountered while broadcasting messages", init = 0 },
