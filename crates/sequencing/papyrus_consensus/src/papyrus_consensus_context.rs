...
impl PapyrusConsensusContext {
    ...
    pub async fn get_proposal(
        ...
        let transactions = {
            let active_proposals_lock =
                self.active_proposals.lock().expect("Failed to lock active proposals");
        ...
        let _ = tx.send(transactions).await;
        rx
    }
}
...
impl ConsensusContext for PapyrusConsensusContext {
    ...
    async fn build_proposal(
        ...
        tokio::spawn(
            async move {
                ...
                let mut proposals =
                    active_proposals.lock().expect("Failed to lock active proposals");
    ...
    async fn decision_reached(
        ...
        let mut proposals = self.active_proposals.lock().expect("Failed to lock active proposals");
