...
use papyrus_network::network_manager::BroadcastSender;
...
pub struct PapyrusConsensusContext {
    ...
    network_broadcast_sender: BroadcastSender<ConsensusMessage>,
    validators: Vec<ValidatorId>,
    sync_broadcast_sender: Option<BroadcastSender<Vote>>,
}
