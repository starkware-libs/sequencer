...
#[rstest]
#[case::success(RECORDER_WRITE_BLOB_PATH, 200, Some(9), 1, true)]
#[case::no_prev_block(RECORDER_WRITE_BLOB_PATH, 200, None, 0, false)]
#[case::prev_block_height_mismatch(RECORDER_WRITE_BLOB_PATH, 200, Some(7), 0, false)]
#[case::send_to_recorder_failed("different_recorder_path", 200, Some(9), 0, false)]
#[case::recorder_return_error(RECORDER_WRITE_BLOB_PATH, 500, Some(9), 1, false)]
#[tokio::test]
