...
fn central_invoke_transaction() -> CentralTransactionWritten {
    CentralTransactionWritten {
...
#[case::invoke_tx(serde_json::to_value(central_invoke_transaction()).unwrap(), CENTRAL_INVOKE_TX_JSON_PATH)]
