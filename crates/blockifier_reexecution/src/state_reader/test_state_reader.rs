...
use starknet_api::block::{BlockHash, BlockHashAndNumber, BlockInfo, BlockNumber, GasPricePerToken, StarknetVersion};
    ...
    pub fn get_block_info(&self) -> ReexecutionResult<BlockInfo> {
        ...
        if block_header_map.get("l2_gas_price").is_none() {
            ...
            block_header_map.insert(
                ...
                to_value(GasPricePerToken { price_in_wei: 1_u8.into(), price_in_fri: 1_u8.into() })?,
            );
        }
