use blockifier::blockifier::config::{ContractClassManagerConfig, RunCairoNativeOptions};
...
fn reexecute_block_for_testing(block_number: u64) {
    ...
    if cfg!(feature = "cairo_native") {
        contract_class_manager_config.cairo_native_run_config.run_cairo_native_options =
