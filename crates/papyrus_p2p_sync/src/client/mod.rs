...
type HeaderSender = SqmrClientSender<HeaderQuery, DataOrFin<SignedBlockHeader>>;
type StateDiffSender = SqmrClientSender<StateDiffQuery, DataOrFin<StateDiffChunk>>;
...
pub struct P2PSyncClientChannels {
    ...
    state_diff_sender: StateDiffSender,
    #[allow(dead_code)]
...
impl P2PSyncClientChannels {
    pub fn new(
        header_payload_sender: HeaderSender,
        state_diff_payload_sender: StateDiffSender,
        transaction_payload_sender: TransactionSender,
    ) -> Self {
        Self {
            header_sender: header_payload_sender,
            state_diff_sender: state_diff_payload_sender,
            transaction_sender: transaction_payload_sender,
        }
    }
