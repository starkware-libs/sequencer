...
type HeaderTestPayload = SqmrClientPayloadForTest<HeaderQuery, DataOrFin<SignedBlockHeader>>;
type StateDiffTestPayload = SqmrClientPayloadForTest<StateDiffQuery, DataOrFin<StateDiffChunk>>;
type TransactionTestPayload =
    SqmrClientPayloadForTest<TransactionQuery, DataOrFin<FullTransaction>>;
...
pub struct TestArgs {
    ...
    pub header_receiver: TestReceiver<HeaderTestPayload>,
    pub state_diff_receiver: TestReceiver<StateDiffTestPayload>,
    #[allow(dead_code)]
    pub transaction_receiver: TestReceiver<TransactionTestPayload>,
}
