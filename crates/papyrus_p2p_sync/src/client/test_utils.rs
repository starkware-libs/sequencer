...
pub fn setup() -> TestArgs {
    ...
    let p2p_sync_channels = P2PSyncClientChannels {
        header_payload_sender: SqmrClientSender::new(Box::new(header_payload_sender)),
        state_diff_payload_sender: SqmrClientSender::new(Box::new(state_diff_payload_sender)),
        transaction_payload_sender: SqmrClientSender::new(Box::new(transaction_payload_sender)),
    };
