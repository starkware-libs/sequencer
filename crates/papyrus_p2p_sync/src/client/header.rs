...
use papyrus_network::network_manager::ClientResponseManager;
...
impl DataStreamBuilder<SignedBlockHeader> for HeaderStreamBuilder {
    ...
    fn parse_data_for_block<'a>(
        signed_headers_response_manager: &'a mut ClientResponseManager<
        ...
        async move {
            let maybe_signed_header = tokio::time::timeout(
                NETWORK_DATA_TIMEOUT,
                signed_headers_response_manager.next_response(),
            )
            .await?
