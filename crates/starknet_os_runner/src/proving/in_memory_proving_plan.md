...
### 1. Added git dependencies to workspace `Cargo.toml`

```toml
cairo-program-runner-lib = { git = "https://github.com/starkware-libs/proving-utils", rev = "fba00f69ec36" }
stwo-cairo-adapter = { git = "https://github.com/starkware-libs/stwo-cairo", rev = "87d62124346e53beaf73c5a8396ccaceecd13552" }
stwo_cairo_prover = { git = "https://github.com/starkware-libs/stwo-cairo", rev = "87d62124346e53beaf73c5a8396ccaceecd13552" }
stwo_run_and_prove_lib = { git = "https://github.com/starkware-libs/proving-utils", package = "stwo_run_and_prove", rev = "fba00f69ec36" }
```
...
- [x] Add proving-utils git dependencies to workspace Cargo.toml
