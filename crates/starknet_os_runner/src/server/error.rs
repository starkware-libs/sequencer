...
pub fn invalid_txn_hash(data: String) -> ErrorObjectOwned {
    ErrorObjectOwned::owned(25, "Invalid transaction hash", Some(data))
}
...
impl From<VirtualSnosProverError> for ErrorObjectOwned {
    fn from(err: VirtualSnosProverError) -> Self {
        match &err {
            ...
            VirtualSnosProverError::TransactionHashError(msg) => invalid_txn_hash(msg.clone()),
