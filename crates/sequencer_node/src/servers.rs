...
/// A macro to create a WrapperServer based on the component's execution mode.
///
/// This macro conditionally creates a WrapperServer instance for a given component based on
/// whether the execution mode is enabled or disabled. It expects execution_mode to be passed
/// as a reference.
///
/// # Arguments
///
