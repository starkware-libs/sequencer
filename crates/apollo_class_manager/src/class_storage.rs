...
use apollo_storage::storage_reader_server::{ServerConfig, SharedDynamicConfigProvider};
...
impl ClassHashStorage {
    pub fn new(
        ...
        let storage_reader_server_handle = Some(Arc::new(storage_reader_server.spawn()));
