...
const CONFIG_WITHOUT_METRICS: MonitoringEndpointConfig =
    MonitoringEndpointConfig { ip: DEFAULT_IP, port: DEFAULT_PORT, collect_metrics: false, collect_profiling_metrics: false };
