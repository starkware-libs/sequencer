...
define_gauge_metrics!(
    ...
    MetricScope::Infra => {
        ...
        { L1_GAS_PRICE_PROVIDER_LOCAL_QUEUE_DEPTH, "l1_gas_price_provider_queue_depth", "The depth of the L1 gas price provider's message queue" },
    ...
    MetricScope::PapyrusSync => {
        ...
        { SYNC_CLASS_MANAGER_MARKER, "apollo_sync_class_manager_marker", "The first block number for which sync does not guarantee all of the corresponding classes are stored in the class manager component" },
...
define_counter_metrics!(
    ...
    MetricScope::HttpServer => {
        ...
        { ADDED_TRANSACTIONS_SUCCESS, "http_server_added_transactions_success", "Number of successfully added transactions", 0 },
        { ADDED_TRANSACTIONS_FAILURE, "http_server_added_transactions_failure", "Number of faulty added transactions", 0 }
    },
    MetricScope::Infra => {
        ...
        { L1_GAS_PRICE_PROVIDER_LOCAL_MSGS_RECEIVED, "l1_gas_price_provider_local_msgs_received", "Counter of messages received by L1 gas price provider local server", 0 },
        { L1_GAS_PRICE_PROVIDER_LOCAL_MSGS_PROCESSED, "l1_gas_price_provider_local_msgs_processed", "Counter of messages processed by L1 gas price provider local server", 0 },
        ...
        { L1_GAS_PRICE_PROVIDER_REMOTE_MSGS_RECEIVED, "l1_gas_price_provider_remote_msgs_received", "Counter of messages received by L1 gas price provider remote server", 0 },
        { L1_GAS_PRICE_PROVIDER_REMOTE_VALID_MSGS_RECEIVED, "l1_gas_price_provider_remote_valid_msgs_received", "Counter of valid messages received by L1 gas price provider remote server", 0 },
        { L1_GAS_PRICE_PROVIDER_REMOTE_MSGS_PROCESSED, "l1_gas_price_provider_remote_msgs_processed", "Counter of messages processed by L1 gas price provider remote server", 0 },
