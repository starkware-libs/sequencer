...
define_gauge_metrics!(
    ...
    MetricScope::Infra => {
        ...
        { L1_GAS_PRICE_PROVIDER_QUEUE_DEPTH, "l1_gas_price_provider_queue_depth", "The depth of the L1 gas price provider's message queue" },
...
define_counter_metrics!(
    ...
    MetricScope::Infra => {
        ...
        { L1_GAS_PRICE_PROVIDER_MSGS_RECEIVED, "l1_gas_price_provider_msgs_received", "Counter of messages received by L1 gas price provider component", 0 },
        { L1_GAS_PRICE_PROVIDER_MSGS_PROCESSED, "l1_gas_price_provider_msgs_processed", "Counter of messages processed by L1 gas price provider component", 0 },
