...
pub struct BlockPostV0_13_1 {
    ...
    // Default to V0_9_1 for compatibility with old blocks that don't include this field.
...
impl Block {
    ...
    pub fn to_starknet_api_block_and_version(self) -> ReaderClientResult<starknet_api_block> {
        ...
        // defined in apollo_starknet_client therefore starknet_api::Transaction cannot return it).
