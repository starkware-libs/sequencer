...
pub trait StarknetReader {
    ...
    /// Returns a [`apollo_starknet_client`][`StateUpdate`] corresponding to `block_number`.
    ...
    /// Returns pending [`apollo_starknet_client`][`PendingData`].
...
const SNIP35_INFO_QUERY: &str = "withSnip35Info";
...
impl StarknetFeederGatewayClient {
    ...
    async fn request_block_raw(
        ...
        get_block_url.query_pairs_mut().append_pair(SNIP35_INFO_QUERY, "true");
