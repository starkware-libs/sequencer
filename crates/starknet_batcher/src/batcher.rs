...
impl Batcher {
    ...
    pub async fn propose_block(
        ...
        let (block_builder, output_tx_receiver, abort_signal_sender) = self
    ...
    pub async fn validate_block(
        ...
        let (block_builder, input_tx_sender, abort_signal_sender) = self
    ...
    fn create_builder_for_propose_block(
        ...
        Ok((block_builder, output_tx_receiver, abort_signal_sender))
    }
    ...
    fn create_builder_for_validate_block(
        ...
        Ok((block_builder, input_tx_sender, abort_signal_sender))
    }
}
