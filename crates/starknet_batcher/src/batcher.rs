...
use starknet_batcher_types::batcher_types::{
    BatcherResult, DecisionReachedInput, GetProposalContent, GetProposalContentInput,
    GetProposalContentResponse, ProposalId, ProposalStatus, ProposeBlockInput, SendProposalContent,
...
use crate::proposal_manager::{
    GenerateProposalError, GetProposalResultError, InternalProposalStatus, ProposalManager,
