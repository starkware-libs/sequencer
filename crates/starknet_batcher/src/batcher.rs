...
impl Batcher {
    pub(crate) fn new(
        ...
        Self {
            ...
            mempool_client,
            proposal_manager,
            propose_streams: HashMap::new(),
            validate_streams: HashMap::new(),
        }
    }

    pub async fn start_height(&mut self, input: StartHeightInput) -> BatcherResult<()> {
        self.propose_streams.clear();
        self.validate_streams.clear();
    ...
    pub async fn propose_block(
        ...
        self.propose_streams.insert(proposal_id, output_tx_receiver);
        Ok(())
    }
    ...
    pub async fn validate_block(
        ...
        self.validate_streams.insert(proposal_id, input_tx_sender);
        Ok(())
    }
