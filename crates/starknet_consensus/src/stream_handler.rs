...
use papyrus_network::utils::StreamBTreeMap;
    ...
    StreamId: StreamIdTrait,
{
    ...
    outbound_stream_receivers: StreamBTreeMap<StreamId, mpsc::Receiver<StreamContent>>,
    ...
    OutboundSenderT: BroadcastTopicClientTrait<StreamMessage<StreamContent, StreamId>>,
{
    ...
    pub fn new(
        ...
        Self {
            ...
            outbound_sender,
            outbound_stream_receivers: StreamBTreeMap::new(BTreeMap::new()),
