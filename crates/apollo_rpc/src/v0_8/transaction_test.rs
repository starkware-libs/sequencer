...
use apollo_client::writer::objects::transaction as client_transaction;
...
fn test_gateway_trascation_from_starknet_api_transaction() {
    ...
    let inner_transaction = starknet_api::transaction::DeployTransaction::get_test_instance(&mut rng);
    let _transaction: super::Transaction =
