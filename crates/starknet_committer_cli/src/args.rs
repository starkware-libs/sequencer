...
#[derive(Debug, Args)]
pub struct CachedStorageGlobalArgs {
    #[clap(flatten)]
...
#[derive(Debug, Args)]
pub struct CachedMemoryArgs {
    #[clap(flatten)]
    pub cached_storage_global_args: CachedStorageGlobalArgs,
}

impl StorageFromArgs for CachedMemoryArgs {
    fn storage(&self) -> impl Storage {
        CachedStorage::new(
            MapStorage::default(),
            self.cached_storage_global_args.cached_storage_config(),
        )
    }
}
...
impl StorageFromArgs for CachedMdbxArgs {
    fn storage(&self) -> impl Storage {
        let mdbx_storage = MdbxStorage::open(Path::new(
            &self.file_storage_args.initialize_storage_path(StorageType::CachedMdbx),
        ))
        .unwrap();
        CachedStorage::new(mdbx_storage, self.cached_storage_global_args.cached_storage_config())
    }
}

#[derive(Debug, Args)]
pub struct RocksdbBaseArgs {
    #[clap(flatten)]
    pub file_storage_args: FileStorageArgs,
...
pub struct RocksdbArgs {
    ...
    pub global_args: GlobalArgs,
    #[clap(flatten)]
    pub rocksdb_base_args: RocksdbBaseArgs,
}

impl StorageFromArgs for RocksdbArgs {
    fn storage(&self) -> impl Storage {
        self.rocksdb_base_args.storage()
    }
}

#[derive(Debug, Args)]
pub struct CachedRocksdbArgs {
    #[clap(flatten)]
    pub cached_storage_global_args: CachedStorageGlobalArgs,
    #[clap(flatten)]
    pub rocksdb_base_args: RocksdbBaseArgs,
...
impl StorageFromArgs for CachedRocksdbArgs {
    fn storage(&self) -> impl Storage {
        let rocksdb_storage = self.rocksdb_base_args.storage();
        CachedStorage::new(rocksdb_storage, self.cached_storage_global_args.cached_storage_config())
    }
}

#[derive(Debug, Args)]
pub struct AerospikeBaseArgs {
    #[clap(flatten)]
    pub file_storage_args: FileStorageArgs,
...
impl AerospikeBaseArgs {
    ...
    pub fn aerospike_storage(&self) -> AerospikeStorage {
...
pub struct AerospikeArgs {
    ...
    pub global_args: GlobalArgs,
    #[clap(flatten)]
    pub aerospike_base_args: AerospikeBaseArgs,
}

impl StorageFromArgs for AerospikeArgs {
    fn storage(&self) -> impl Storage {
        self.aerospike_base_args.aerospike_storage()
    }
}

#[derive(Debug, Args)]
pub struct CachedAerospikeArgs {
    #[clap(flatten)]
    pub cached_storage_global_args: CachedStorageGlobalArgs,
    #[clap(flatten)]
    pub aerospike_base_args: AerospikeBaseArgs,
...
impl StorageFromArgs for CachedAerospikeArgs {
    fn storage(&self) -> impl Storage {
        let aerospike_storage = self.aerospike_base_args.aerospike_storage();
        CachedStorage::new(
            aerospike_storage,
            self.cached_storage_global_args.cached_storage_config(),
        )
...
pub enum StorageBenchmarkCommand {
    Memory(MemoryArgs),
    CachedMemory(CachedMemoryArgs),
    Mdbx(MdbxArgs),
    CachedMdbx(CachedMdbxArgs),
    Rocksdb(RocksdbArgs),
    CachedRocksdb(CachedRocksdbArgs),
    Aerospike(AerospikeArgs),
    CachedAerospike(CachedAerospikeArgs),
}
...
impl StorageBenchmarkCommand {
    pub fn global_args(&self) -> &GlobalArgs {
        match self {
            ...
            Self::CachedMemory(args) => &args.cached_storage_global_args.global_args,
            Self::Mdbx(args) => &args.global_args,
            Self::CachedMdbx(args) => &args.cached_storage_global_args.global_args,
            Self::Rocksdb(args) => &args.global_args,
            Self::CachedRocksdb(args) => &args.cached_storage_global_args.global_args,
            Self::Aerospike(args) => &args.global_args,
            Self::CachedAerospike(args) => &args.cached_storage_global_args.global_args,
        }
    }

    pub fn cached_storage_global_args(&self) -> Option<&CachedStorageGlobalArgs> {
        match self {
            Self::Memory(_) | Self::Mdbx(_) | Self::Rocksdb(_) | Self::Aerospike(_) => None,
            Self::CachedMemory(args) => Some(&args.cached_storage_global_args),
            Self::CachedMdbx(args) => Some(&args.cached_storage_global_args),
            Self::CachedRocksdb(args) => Some(&args.cached_storage_global_args),
            Self::CachedAerospike(args) => Some(&args.cached_storage_global_args),
        }
    }
    ...
    pub fn file_storage_args(&self) -> Option<&FileStorageArgs> {
        match self {
            ...
            Self::CachedMdbx(args) => Some(&args.file_storage_args),
            Self::Rocksdb(args) => Some(&args.rocksdb_base_args.file_storage_args),
            Self::CachedRocksdb(args) => Some(&args.rocksdb_base_args.file_storage_args),
            Self::Aerospike(args) => Some(&args.aerospike_base_args.file_storage_args),
            Self::CachedAerospike(args) => Some(&args.aerospike_base_args.file_storage_args),
        }
    }
