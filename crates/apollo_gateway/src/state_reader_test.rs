...
async fn test_get_compiled_class(
    ...
    >,
    #[case] n_calls_to_class_manager_client_get_executable: usize,
    #[case] class_manager_client_get_sierra_result: Option<
        ClassManagerClientResult<Option<SierraContractClass>>,
    >,
    #[case] sync_client_is_class_declared_at_result: StateSyncClientResult<bool>,
    ...
    mock_class_manager_client
        ...
        .times(n_calls_to_class_manager_client_get_executable)
    ...
    mock_state_sync_client
        ...
        .return_once(move |_, _| sync_client_is_class_declared_at_result);
