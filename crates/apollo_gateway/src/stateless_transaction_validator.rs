...
use starknet_api::transaction_stateless_validation::TransactionStatelessValidation;
...
impl StatelessTransactionValidator {
    ...
    pub fn validate<T: TransactionStatelessValidation + Debug>(
        &self,
        tx: &T,
    ...
    fn validate_empty_account_deployment_data<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_empty_paymaster_data<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_resource_bounds<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_tx_size<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_tx_calldata_size<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_tx_signature_size<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_nonce_data_availability_mode<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    /// here in the gateway to prevent transactions from failing the OS.
    fn validate_fee_data_availability_mode<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
    ...
    fn validate_declare_tx<T: TransactionStatelessValidation>(
        &self,
        tx: &T,
    ) -> StatelessTransactionValidatorResult<()> {
        if !tx.is_declare() {
