        ...
        None => {
            ...
            assert_eq!(
                ...
                match rpc_tx {
                    ...
                    RpcTransaction::DeployAccount(_) => GatewayOutput::DeployAccount(
                        DeployAccountGatewayOutput::new(tx_hash, address)
                    ),
                    RpcTransaction::Invoke(_) =>
                        GatewayOutput::Invoke(InvokeGatewayOutput::new(tx_hash)),
                }
            );
        }
    }
