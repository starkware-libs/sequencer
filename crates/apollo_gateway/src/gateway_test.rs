...
use starknet_api::test_utils::{NonceManager, TestingTxArgs, CHAIN_ID_FOR_TESTS};
...
fn invoke() -> Box<dyn TestingTxArgs> {
...
fn deploy_account() -> Box<dyn TestingTxArgs> {
    let account =
...
fn declare() -> Box<dyn TestingTxArgs> {
...
async fn test_add_tx(
    ...
    #[values(invoke(), deploy_account(), declare())] tx_args: Box<dyn TestingTxArgs>,
