...
use blockifier::metrics::{ClassCacheMetrics, ClassCacheMetricsTrait};
...
pub fn class_cache_metrics() -> ClassCacheMetrics {
    ClassCacheMetrics { misses: CLASS_CACHE_MISSES, hits: CLASS_CACHE_HITS }
}
