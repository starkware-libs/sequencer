...
impl Default for RocksDbOptions {
    fn default() -> Self {
        ...
        block.set_bloom_filter(BLOOM_FILTER_NUM_BITS.into(), false);
        ...
        // Forces WAL to be written to disk before returning on set operations. Crucial to guarantee
        // persistence after mset.
