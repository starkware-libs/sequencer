...
pub struct FeeEstimation {
    ...
    // TODO(Tzahi): Add l2_gas_consumed. Verify overall_fee estimation of l1_gas_price only is close
    // enough (as there are roundings) to the fee of both l1_gas_price and l2_gas_price.
