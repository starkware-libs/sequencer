    ...
    let l1_provider = match config.components.l1_provider.execution_mode {
        ...
        | ReactiveComponentExecutionMode::LocalExecutionWithRemoteEnabled => {
            ...
            let provider_startup_height = base_layer
                ...
                .expect("No L2 block at detected at the L1 height the scraper was initailied on. \
                Advance the scraper to start at a height height than the L2 genesis height.");
