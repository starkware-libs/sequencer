...
use crate::clients::create_node_clients;
...
pub fn create_node_modules(config: &SequencerNodeConfig) -> SequencerNodeServers {
    ...
    create_node_servers(config, &mut channels, components)
}
