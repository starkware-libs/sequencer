...
fn test_default_config_file_is_up_to_date() {
    ...
    // The validate function will fail if the data directory does not exist.
    // the data directory is the default directory path for the storage of state sync config.
    // We assert the directory does not exist to prevent deleting a non related folder with the same
    // path.
...
fn test_config_parsing() {
    ...
    // The validate function will fail if the data directory does not exist, so we change the path
    // to point to an existing directory. the data directory is the default directory path for
    // the storage of state sync config.
