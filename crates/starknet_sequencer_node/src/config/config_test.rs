...
#[rstest]
#[case::local(ReactiveComponentExecutionMode::Disabled, None, None, None, VALID_SOCKET)]
#[case::local(
...
#[case::local(LOCAL_EXECUTION_MODE, Some(LocalServerConfig::default()), None, None, VALID_SOCKET)]
#[case::remote(
