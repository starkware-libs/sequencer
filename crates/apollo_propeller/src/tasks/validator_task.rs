        ...
        tokio::select! {
            ...
            _ = sleep_until(deadline) => {
                ...
                let _ = send_non_critical(
                    ...
                    ChannelName::ValidatorToStateManager
                ).await;
            ...
            Some(unit_to_validate) = unit_rx.recv() => {
                ...
                match result {
                    Ok(()) => {
                        ...
                        // this may fail if the message is finalized
                        let _ = send_non_critical(&state_manager_tx, msg, ChannelName::ValidatorToStateManager).await;
