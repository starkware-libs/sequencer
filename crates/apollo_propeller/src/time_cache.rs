    ...
    K: Eq + Hash + Clone,
{
    ...
    /// Check if the cache has no entries, including expired entries that haven't been lazily
    /// evicted yet. For an accurate liveness check, use [`contains`](Self::contains).
