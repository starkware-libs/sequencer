...
const TEST_TIMESTAMP_NS: u64 = 1_700_000_000_000_000_000;

#[rstest]
#[case::matching_params(MessageRoot([1; 32]), TEST_CHANNEL, TEST_TIMESTAMP_NS, true)]
#[case::wrong_root(MessageRoot([2; 32]), TEST_CHANNEL, TEST_TIMESTAMP_NS, false)]
#[case::wrong_channel(MessageRoot([1; 32]), Channel(99), TEST_TIMESTAMP_NS, false)]
#[case::wrong_timestamp(MessageRoot([1; 32]), TEST_CHANNEL, TEST_TIMESTAMP_NS + 1, false)]
fn test_sign_and_verify(
    #[case] verify_root: MessageRoot,
    #[case] verify_channel: Channel,
    #[case] verify_timestamp_ns: u64,
    #[case] expect_valid: bool,
) {
    let keypair = Keypair::generate_ed25519();
    let sign_root = MessageRoot([1; 32]);

    let signature = sign_message_id(&sign_root, TEST_CHANNEL, TEST_TIMESTAMP_NS, &keypair).unwrap();
