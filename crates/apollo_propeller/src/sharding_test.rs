...
fn test_reconstruct_message_from_shards_success() {
    ...
    let (reconstructed_message, my_shards, proof) = reconstruct_message_from_shards(
        received_units,
        message_root,
        MY_SHARD_INDEX,
        NUM_DATA_SHARDS,
