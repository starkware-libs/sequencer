...
#[rstest]
#[case::n2_peer0_receives_from_peer1(2, 0, 1, 0)]
#[case::n3_peer0_receives_from_peer1(3, 0, 1, 0)]
#[case::n4_peer0_receives_from_peer1(4, 0, 1, 0)]
#[case::n4_peer2_receives_from_peer1(4, 2, 1, 1)]
#[case::n4_publisher_is_first(4, 2, 0, 1)]
#[case::n4_publisher_is_last(4, 0, 3, 0)]
#[case::n7_peer2_receives_from_peer3(7, 2, 3, 2)]
#[case::n10_peer5_receives_from_peer3(10, 5, 3, 4)]
#[case::n100_large_network(100, 50, 25, 49)]
fn test_validate_origin_hop1(
    #[case] num_nodes: u8,
    #[case] local_index: u8,
...
#[rstest]
#[case::n3_relay(3, 0, 2, 1, 1)]
#[case::n4_relay_shard1_via_peer2(4, 0, 2, 1, 1)]
#[case::n4_relay_shard0_via_peer0(4, 2, 0, 1, 0)]
#[case::n7_relay_shard1_via_peer1(7, 2, 1, 3, 1)]
#[case::n10_relay_shard5_via_peer6(10, 5, 6, 3, 5)]
fn test_validate_origin_hop2(
    #[case] num_nodes: u8,
    #[case] local_index: u8,
...
#[rstest]
#[case::self_send_n2(2, 0, 0, 1, 0)]
#[case::self_send_n4(4, 1, 1, 2, 0)]
#[case::self_publish_n4(4, 0, 1, 0, 0)]
#[case::wrong_sender_n4(4, 0, 2, 1, 0)]
#[case::wrong_sender_n7(7, 2, 5, 3, 0)]
#[case::hop1_wrong_shard_n4(4, 0, 1, 1, 1)]
#[case::hop1_wrong_shard_n7(7, 2, 1, 1, 0)]
