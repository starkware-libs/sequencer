...
impl Handler {
    ...
    pub fn new(
        protocol_id: libp2p::swarm::StreamProtocol,
        max_shard_size: usize,
        substream_timeout: Duration,
    ) -> Self {
        Self {
            protocol: PropellerProtocol::new(protocol_id, max_shard_size),
    ...
    fn on_connection_event(
        ...
        match event {
            ...
            ConnectionEvent::ListenUpgradeError(ListenUpgradeError { error, .. }) => {
                debug!("Listen upgrade error: {:?}", error);
            }
            _ => {}
        }
    }
...
impl fmt::Debug for Handler {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_struct("Handler")
            ...
            .field("outbound_substream_establishing", &self.outbound_substream_establishing)
            .finish()
    }
}
...
mod tests {
    ...
    fn test_handler_message_queuing() {
        ...
        let message = PropellerMessage::random(&mut rand::thread_rng(), 65536);
