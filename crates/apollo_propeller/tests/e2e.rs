...
use apollo_propeller::{Behaviour, Channel, Config, Event, MessageRoot};
...
fn create_swarm(transport_type: TransportType) -> Swarm<Behaviour> {
    ...
    let config = Config { max_wire_message_size: 1 << 30, ..Default::default() };
    ...
    match transport_type {
        TransportType::Memory => builder
            ...
            .with_behaviour(|keypair| Behaviour::new(keypair.clone(), config))
