...
impl MonitoringEndpoint {
    ...
    fn app(&self) -> Router {
        ...
        let snapshot_timeout = Duration::from_millis(self.config.snapshot_timeout_millis);
        ...
        Router::new()
            ...
            .route(
                ...
                get(move || {
                    get_l1_events_provider_snapshot(l1_events_provider_client, snapshot_timeout)
                }),
            )
            .route(
