...
use axum_07::extract::Path;
use axum_07::http::StatusCode;
use axum_07::response::{IntoResponse, Response};
use axum_07::routing::{get, post};
use axum_07::{async_trait, Json, Router};
...
impl MonitoringEndpoint {
    ...
    pub async fn run(&self) -> Result<(), std::io::Error> {
        ...
        axum_07::serve(listener, app).await
    }
