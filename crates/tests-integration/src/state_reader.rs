...
struct ThinStateDiffBuilder<'a> {
    ...
    chain_info: ChainInfo,
    initial_account_balances: Felt,
}

impl<'a> ThinStateDiffBuilder<'a> {
    const DEFAULT_INITIAL_ACCOUNT_BALANCE: u128 = BALANCE;
    ...
    fn new(chain_info: &ChainInfo) -> Self {
        ...
        Self {
            ...
            initial_account_balances: felt!(Self::DEFAULT_INITIAL_ACCOUNT_BALANCE),
            deployed_contracts,
            ..Default::default()
        }
    }
        ...
        for account in self.accounts {
            ...
            for fee_type in FeeType::iter() {
                self.storage_diffs
                    ...
                    .or_default()
                    .insert(fee_token_address, self.initial_account_balances);
            }
        }
