...
use crate::component_definitions::{RemoteConnectionConfig, APPLICATION_OCTET_STREAM};
...
/// use crate::starknet_mempool_infra::component_definitions::RemoteConnectionConfig;
///
...
{
    pub fn new(config: RemoteConnectionConfig) -> Self {
