...
use apollo_consensus_orchestrator::metrics::{
    CONSENSUS_CONVERSION_RATE_MISMATCH_COUNT,
...
const PANEL_CONSENSUS_CONVERSION_RATE_MISMATCH_COUNT: Panel =
    Panel::from_counter(CONSENSUS_CONVERSION_RATE_MISMATCH_COUNT, PanelType::Stat);
...
const CONSENSUS_ROW: Row = Row::new(
    ...
    &[
        ...
        PANEL_CONSENSUS_CONVERSION_RATE_MISMATCH_COUNT,
    ],
);
