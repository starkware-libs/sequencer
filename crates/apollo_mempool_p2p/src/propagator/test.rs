...
use apollo_transaction_converter::{MockTransactionConverterTrait, TransactionConverterTrait};
...
async fn transaction_batch_broadcasted_on_max_size() {
    ...
    // Assert the first (MAX_TRANSACTION_BATCH_SIZE - 1) transactions do not trigger batch broadcast
