...
define_metrics!(
    MempoolP2p => {
        ...
        MetricHistogram { MEMPOOL_P2P_SENT_MESSAGE_SIZE_BYTES, "apollo_mempool_p2p_sent_message_size_bytes", "The size in bytes of messages sent by the mempool p2p component" },
        ...
        MetricHistogram { MEMPOOL_P2P_RECEIVED_MESSAGE_SIZE_BYTES, "apollo_mempool_p2p_received_message_size_bytes", "The size in bytes of messages received by the mempool p2p component" },
        ...
        MetricHistogram { MEMPOOL_P2P_DROPPED_MESSAGE_SIZE_BYTES, "apollo_mempool_p2p_dropped_message_size_bytes", "The size in bytes of messages dropped by the mempool p2p component" },
        // Histogram
