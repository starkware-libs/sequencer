    ...
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        BTreeMap::from_iter([
            ...
            ser_param(
                ...
                &self.build_proposal_margin.as_secs(),
                "Safety margin in seconds to make sure that the batcher completes building the \
                 proposal with enough time for the Fin to be checked by validators.",
                ParamPrivacyInput::Public,
            ),
            ser_param(
                "validate_proposal_margin",
                &self.validate_proposal_margin.as_secs(),
                "Safety margin in seconds to allow the batcher to successfully validate a \
                 proposal.",
                ParamPrivacyInput::Public,
            ),
        ])
