...
struct BlockInfoValidation {
    ...
    eth_to_fri_rate_margin_ppm: u32,
}
        ...
        match proposal_init.round.cmp(&self.current_round) {
            ...
            std::cmp::Ordering::Equal => {
                ...
                let block_info_validation = BlockInfoValidation {
                    ...
                    eth_to_fri_rate,
                    eth_to_fri_rate_margin_ppm: VersionedConstants::latest_constants()
                        .eth_to_fri_rate_margin_ppm,
                };
...
async fn is_block_info_valid(
    ...
    block_info.height == block_info_validation.height
        ...
        && block_info.eth_to_fri_rate.abs_diff(block_info_validation.eth_to_fri_rate)
            <= (block_info_validation.eth_to_fri_rate
                * u128::from(block_info_validation.eth_to_fri_rate_margin_ppm)
                / 1_000_000)
}
