...
const FINAL_N_EXECUTED_TXS: usize = usize::MAX;
...
async fn validate_block_full_flow() {
    ...
    let finish_proposal = SendProposalContentInput {
        proposal_id: PROPOSAL_ID,
        content: SendProposalContent::Finish(FINAL_N_EXECUTED_TXS),
    };
    assert_eq!(
...
#[case::send_finish(SendProposalContent::Finish(FINAL_N_EXECUTED_TXS))]
...
#[rstest]
#[case::send_txs_after_finish(SendProposalContent::Finish(FINAL_N_EXECUTED_TXS), SendProposalContent::Txs(test_txs(0..1)))]
