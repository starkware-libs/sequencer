...
impl Batcher {
    ...
    pub async fn decision_reached(
        ...
        #[cfg(feature = "os_input")]
        let accessed_keys = self.build_block_accessed_keys(
            block_execution_artifacts
                .execution_data
                .execution_infos_and_signatures
                .values()
    ...
    #[cfg(feature = "os_input")]
    fn build_block_accessed_keys<'a>(
        &self,
        tx_execution_infos: impl IntoIterator<Item = &'a TransactionExecutionInfo>,
...
pub trait BatcherStorageWriter: Send + Sync {
    ...
    /// Accessed keys are only available for blocks that were executed locally (i.e. not for synced
    /// blocks).
    #[cfg(feature = "os_input")]
    fn commit_proposal(
        &mut self,
