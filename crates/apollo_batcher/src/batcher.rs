...
use apollo_storage::metrics::STORAGE_OPEN_BATCHER_READ_TRANSACTIONS;
...
pub fn create_batcher(
    ...
    let (storage_reader, storage_writer) = apollo_storage::open_storage(
        config.storage.clone(),
        Some(&STORAGE_OPEN_BATCHER_READ_TRANSACTIONS),
    )
