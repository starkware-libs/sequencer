...
pub struct Batcher {
    ...
    parent_proposal_commitment: Option<(BlockNumber, ProposalCommitment)>,
}
...
impl Batcher {
    ...
    pub async fn decision_reached(
        ...
        let parent_proposal_commitment = self.get_parent_proposal_commitment(height).await?;
        self.commit_proposal_and_block(
            height,
            state_diff.clone(),
    ...
    async fn commit_proposal_and_block(
        ...
        self.parent_proposal_commitment =
    ...
    async fn get_parent_proposal_commitment(
        ...
        match self.parent_proposal_commitment {
            Some((h, commitment)) => {
