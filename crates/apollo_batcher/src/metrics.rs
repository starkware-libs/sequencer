...
define_metrics!(
    Batcher => {
        ...
        // Commitment manager
        MetricHistogram { COMMITMENT_MANAGER_COMMIT_BLOCK_LATENCY_HIST, "batcher_commitment_manager_commit_block_latency_hist", "The latency of commit task in the commitment manager in milliseconds" },
        MetricHistogram { COMMITMENT_MANAGER_REVERT_BLOCK_LATENCY_HIST, "batcher_commitment_manager_revert_block_latency_hist", "The latency of revert task in the commitment manager in milliseconds" },
        MetricGauge { COMMITMENT_MANAGER_COMMIT_BLOCK_LATENCY, "batcher_commitment_manager_commit_block_latency", "The latency of commit task in the commitment manager in milliseconds" },
        MetricGauge { COMMITMENT_MANAGER_REVERT_BLOCK_LATENCY, "batcher_commitment_manager_revert_block_latency", "The latency of revert task in the commitment manager in milliseconds" },
    },
);
