...
define_metrics!(
    Batcher => {
        ...
        MetricGauge { COMMITMENT_MANAGER_COUNT_COMMIT_RESULTS, "batcher_commitment_manager_count_commit_results", "The number of commit results received from the commitment manager" },
