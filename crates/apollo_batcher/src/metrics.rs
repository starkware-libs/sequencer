...
define_metrics!(
    Batcher => {
        ...
        // Heights
        MetricGauge { STATE_DIFF_HEIGHT, "batcher_state_diff_height", "The height of the batcher's state diff stored in storage." },
...
pub fn register_metrics(storage_height: BlockNumber, global_root_height: BlockNumber) {
    STATE_DIFF_HEIGHT.register();
    STATE_DIFF_HEIGHT.set_lossy(storage_height.0);
