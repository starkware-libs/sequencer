...
/// Determines which channels to drop to simulate different close scenarios.
/// - case 0: drop candidate channel first
/// - case 1: drop pre-confirmed channel first
/// - case 2: drop both channels
fn drop_channels(
    candidate_tx_sender: CandidateTxSender,
    pre_confirmed_tx_sender: PreconfirmedTxSender,
    drop_case: u8,
) {
    match drop_case {
        0 => drop(candidate_tx_sender),
        1 => drop(pre_confirmed_tx_sender),
        _ => {
