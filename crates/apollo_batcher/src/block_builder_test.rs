...
use apollo_l1_provider_types::InvalidValidationStatus::{
    AlreadyIncludedInProposedBlock, AlreadyIncludedOnL2, ConsumedOnL1OrUnknown,
};
...
async fn partial_chunk_execution_with_fail_on_error_flag() {
    ...
    // Block should return BlockFull error since a chunk is not completed, a time constrain on block.
