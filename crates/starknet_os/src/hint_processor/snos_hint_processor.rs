...
impl<S: StateReader> SyscallExecutor for SnosHintProcessor<'_, S> {
    ...
    fn get_gas_cost_from_selector(
        ...
        blockifier::blockifier_versioned_constants::SyscallGasCost,
        blockifier::blockifier_versioned_constants::GasCostsError,
    > {
        todo!()
    }
    ...
    fn update_revert_gas_with_next_remaining_gas(
        &mut self,
        next_remaining_gas: starknet_api::execution_resources::GasAmount,
    ) {
        todo!()
    }
