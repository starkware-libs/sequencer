...
define_string_enum! {
    ...
    pub enum Const {
        ...
        (ProofVersionV2, "starkware.starknet.core.os.virtual_os_output.PROOF_VERSION_V2"),
    }
}
...
define_string_enum! {
    ...
    pub enum CairoStruct {
        ...
        (Sha512ProcessBlockResponsePtr, "starkware.starknet.common.new_syscalls.Sha512ProcessBlockResponse*"),
