...
use crate::hints::hint_implementation::state_diff_encryption::utils::{compute_public_keys, decrypt_state_diff};
...
use crate::hints::hint_implementation::state_diff_encryption::utils::encrypt_symmetric_key;
...
fn test_state_diff_encryption_decryption(#[case] private_keys: &[Felt]) {
    ...
    let encrypted_symmetric_keys = encrypt_symmetric_key(
        &sn_private_keys,
        &public_keys,
        symmetric_key,
    );
