...
use crate::hints::hint_implementation::state_diff_encryption::utils::{decrypt_state_diff, recover_y};

#[test]
fn test_decrypt_state_diff() {
    let private_key = Felt::from_hex_unchecked("0x123456789abcdef");
    let sn_public_key = Felt::from_hex_unchecked(
        "0x8747394510780077664574649897481151382481072868806602",
    );
