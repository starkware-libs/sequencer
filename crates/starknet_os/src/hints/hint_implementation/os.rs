...
pub(crate) fn initialize_class_hashes<S: StateReader>(
    ...
    let class_hash_to_compiled_class_hash =
        hint_processor.execution_helper.cached_state.compiled_class_hashes();
...
pub(crate) fn initialize_state_changes<S: StateReader>(
    ...
    let accesses_addresses = cached_state.accessed_contract_addresses();
    ...
    for contract_address in accesses_addresses {
        ...
        initial_dict.insert(contract_address.0.0.into(), state_entry_base.into());
    }
