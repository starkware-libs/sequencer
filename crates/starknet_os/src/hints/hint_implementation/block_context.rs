...
pub(crate) fn block_number<S: StateReader>(
    ...
    let block_number =
        hint_processor.get_current_execution_helper().os_input.block_info.block_number;
...
pub(crate) fn block_timestamp<S: StateReader>(
    ...
    let block_timestamp =
        hint_processor.get_current_execution_helper().os_input.block_info.block_timestamp;
...
pub(crate) fn chain_id<S: StateReader>(
    ...
    let chain_id = &hint_processor.get_current_execution_helper().os_input.chain_info.chain_id;
...
pub(crate) fn sequencer_address<S: StateReader>(
    ...
    let address =
        hint_processor.get_current_execution_helper().os_input.block_info.sequencer_address;
...
pub(crate) fn write_use_kzg_da_to_memory<S: StateReader>(
    ...
    let use_kzg_da = hint_processor.get_current_execution_helper().os_input.block_info.use_kzg_da
