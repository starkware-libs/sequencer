...
pub(crate) fn prepare_state_entry_for_revert<S: StateReader>(
    ...
    exec_scopes.insert_value(Scope::ContractAddress.into(), contract_address);
    Ok(())
}
...
pub(crate) fn read_storage_key_for_revert<S: StateReader>(
    ...
    let contract_address: &ContractAddress = exec_scopes.get_ref(Scope::ContractAddress.into())?;
