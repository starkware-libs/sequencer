    ...
    assert_eq!(
        ...
        DescentMap::from([
            (
                ...
                Path(
                    PathToBottom::new(EdgePath::new_u128(1), EdgePathLength::new(2).unwrap())
                        .unwrap(),
                ),
            ),
            (
                ...
                Path(
                    PathToBottom::new(EdgePath::new_u128(0), EdgePathLength::new(2).unwrap())
                        .unwrap(),
                ),
            )
        ]),
