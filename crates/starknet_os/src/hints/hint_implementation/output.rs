...
/// Generate a symmetric key and private keys by hashing a random bytes and the compressed state
/// diff to generate a random key seed. Then, the seed is hashed along with a different nonce to
/// generate each unique private key.
