...
macro_rules! define_hint_enum_base {
    ($enum_name:ident, $(($hint_name:ident, $hint_str:expr)),+ $(,)?) => {
        #[cfg_attr(
            ...
            derive(Default, strum_macros::EnumIter, strum_macros::IntoStaticStr)
        )]
        ...
        impl HintImplementation for $enum_name {
            fn execute_hint<S: StateReader>(&self, hint_args: HintArgs<'_, '_, S>) -> OsHintResult {
                match self {
                    $(Self::$hint_name => {
                        #[cfg(feature="testing")]
                        hint_args.hint_processor.used_hints.insert(Self::$hint_name.into());
            ...
            fn execute_hint_extensive<S: StateReader>(
                ...
                match self {
                    $(Self::$hint_name => {
                        ...
                        hint_extension_args
                        .hint_processor
                        .used_hints.insert(Self::$hint_name.into());
