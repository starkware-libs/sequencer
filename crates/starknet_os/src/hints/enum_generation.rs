...
macro_rules! define_hint_enum_helper {
    (
        $enum_name:ident,
        $hp_arg:ident,
        $(($hint_name:ident, $implementation:ident $(::<$generic_type:ident>)?, $hint_str:expr $(, $passed_arg:ident)?)),+ $(,)?
    ) => {
...
macro_rules! define_stateless_hint_enum {
    ($enum_name:ident, $(($hint_name:ident, $implementation:ident $(::<$generic_type:ident>)?, $hint_str:expr)),+ $(,)?) => {
