...
pub fn compute_cairo_hinted_class_hash(
    ...
    add_backward_compatibility_space(
        &mut raw_json_output,
        contract_definition.program.compiler_version.is_none(),
    );
...
pub fn add_backward_compatibility_space(input: &mut String, compiler_version_is_none: bool) {
    if compiler_version_is_none {
