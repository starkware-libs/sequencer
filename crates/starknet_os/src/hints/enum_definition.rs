...
use crate::hints::hint_implementation::execution::implementation::{
    ...
    load_next_tx,
    load_tx_nonce_account,
    load_tx_nonce_l1_handler,
...
define_hint_enum!(
    ...
    (EscapePedersenImageWitness, escape_pedersen_image_witness),
    ...
    (LoadTxNonceAccount, load_tx_nonce_account),
    (LoadTxNonceL1Handler, load_tx_nonce_l1_handler),
