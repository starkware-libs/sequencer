...
#[case((0..150_u8).map(|i| Felt::from(128) + Felt::TWO.pow(i)).chain((0..150_u8).map(|i| Felt::from(128) + Felt::TWO.pow(i))).collect::<Vec<_>>(),
    (0..150_u128).map(|i| i + 128).chain((0..150_u128).map(|i| i + 128)).collect::<Vec<_>>(),
    HashMap::from_iter(
        (0..150_u128)
