...
pub struct EntryPointRunnerConfig {
    ...
    layout: LayoutName,
    proof_mode: bool,
    add_main_prefix_to_entrypoint: bool, // If true, the entrypoint will be prefixed with __main__.
}
...
pub fn run_cairo_0_entry_point(
    ...
    let mut cairo_runner =
        CairoRunner::new(&program, runner_config.layout, runner_config.proof_mode, trace_enabled)
            .unwrap();
