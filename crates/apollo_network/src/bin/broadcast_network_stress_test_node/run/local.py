...
class ExperimentRunner:
    ...
    def compile_network_stress_test_node(self):
        ...
        run_cmd(
            f"cargo build --release --bin broadcast_network_stress_test_node",
...
def main():
    ...
    parser.add_argument(
        "--profile-timeout",
        help="The timeout in seconds for the profiling. If the experiment runs for longer than this, it will be killed.",
        type=int,
