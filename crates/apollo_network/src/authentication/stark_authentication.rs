...
impl StarkAuthNegotiator {
    async fn negotiate_connection(
        ...
        let (_, other_stark_auth) = tokio::try_join!(
        ...
        match verify_identity(other_peer_id, my_challenge, other_signature, other_public_key)? {
...
impl Negotiator for StarkAuthNegotiator {
    ...
    async fn negotiate_connection(
        ...
        self.negotiate_connection(my_peer_id, other_peer_id, connection_sender, connection_receiver)
            .await
    }
}
