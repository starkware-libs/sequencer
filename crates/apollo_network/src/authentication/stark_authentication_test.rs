...
async fn stark_authentication_protocol(
    ...
    let initiator_future =
        initiator.negotiate(initiator_peer_id, responder_peer_id, initiator_connection);
    let responder_future =
        responder.negotiate(responder_peer_id, initiator_peer_id, responder_connection);
