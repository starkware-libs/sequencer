...
use crate::l1_scraper::{start_block_from_config, L1Scraper, L1ScraperConfig, L1ScraperError};
...
async fn scraper(
    ...
    let l1_start_block = start_block_from_config(&base_layer, &l1_scraper_config).await.unwrap();
