...
use crate::l1_scraper::{find_start_block, L1Scraper, L1ScraperConfig, L1ScraperError};
...
async fn scraper(
    ...
    let l1_start_block = find_start_block(&base_layer, &l1_scraper_config).await.unwrap();
