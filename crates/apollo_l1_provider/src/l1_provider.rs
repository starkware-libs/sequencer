...
impl L1Provider {
    ...
    /// Upon successfully committing a block, commit all staged transactions, and put provider back
    /// in Pending state.
    #[instrument(skip(self), err)]
    pub fn commit_block(
        &mut self,
        ...
        // TODO(guyn): this debug message is misleading, this checks start_height, not
        // current_height. TODO(guyn): maybe we should indeed ignore all blocks below
        // current_height? See other todo in bootstrap().
