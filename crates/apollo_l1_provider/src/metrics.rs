...
define_metrics!(
    L1ToL2Message => {
        MetricCounter { L1_MESSAGE_SCRAPER_BASELAYER_SUCCESS_COUNT, "l1_message_scraper_baselayer_success_count", "Number of times the L1 message scraper successfully scraped the base layer for messages", init=0 },
...
pub(crate) fn register_scraper_metrics() {
    L1_MESSAGE_SCRAPER_BASELAYER_SUCCESS_COUNT.register();
