...
pub struct TransactionRecord {
    ...
    /// State: use for queries about the state.
...
impl TransactionRecord {
    ...
    pub fn mark_rejected(&mut self) {
        ...
        self.current_state = TransactionState::Rejected;
        self.rejected = true;
    }
    ...
    pub fn is_proposable(&self) -> bool {
        matches!(self.current_state, TransactionState::Pending)
    }

    pub fn is_committed(&self) -> bool {
        matches!(self.current_state, TransactionState::Committed)
    }
