...
pub(crate) const COOLDOWN_MILLIS: u64 = 1000;
pub(crate) const SMALL_DELAY_MILLIS: u64 = 10;
...
const LAST_L1_BLOCK_NUMBER: L1BlockNumber = START_L1_BLOCK.number + NUMBER_OF_BLOCKS_TO_MINE + 1;
...
pub(crate) async fn setup_scraper_and_provider(
    ...
    let l1_provider_config = L1ProviderConfig {
        ...
        l1_handler_cancellation_timelock_seconds: Duration::from_millis(COOLDOWN_MILLIS),
        ..Default::default()
    };
    ...
    let l1_scraper_config = L1ScraperConfig {
        polling_interval_seconds: Duration::from_millis(SMALL_DELAY_MILLIS),
        chain_id: CHAIN_ID,
        ..Default::default()
    };
...
pub(crate) async fn send_message_from_l1_to_l2(
    ...
    let message_to_l2 = contract.sendMessageToL2(
