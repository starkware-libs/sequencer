...
///   - `<COMPONENT>_LOCAL_QUEUE_DEPTH`
///   - `<COMPONENT>_REMOTE_MSGS_RECEIVED`
///   - `<COMPONENT>_REMOTE_VALID_MSGS_RECEIVED`
///   - `<COMPONENT>_REMOTE_MSGS_PROCESSED`
///   - `<COMPONENT>_REMOTE_NUMBER_OF_CONNECTIONS`
///   - `<COMPONENT>_REMOTE_CLIENT_SEND_ATTEMPTS`
/// - A constant `InfraMetrics` bundle named `<COMPONENT>_INFRA_METRICS` that wires the above
///   metrics into `LocalClientMetrics`, `RemoteClientMetrics`, `LocalServerMetrics`, and
///   `RemoteServerMetrics`.
///
/// Usage:
