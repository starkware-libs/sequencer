...
/// Returns the path to a file in the "resources" directory of the current working directory,
/// assuming it exists. The value for file_path should be the path to the required file in the
/// "resources" folder.
