...
mod constants {
    ...
    pub const SIGNATURE_R: &str =
        "0x7d24ef879c52be17c0f71be8a05d3cc584b50954d8f28af597d4872fa1876b3";
    pub const SIGNATURE_S: &str =
        "0x108f3c671965a81bdf047ee5217275f0ac329e6c862f4f46edef1806b504b2";

    pub const NONCE: &str = "0x0";
    pub const TIP: &str = "0x0";

    // Resource bounds
    pub const L1_GAS_MAX_AMOUNT: &str = "0x186a0";
    pub const L1_GAS_MAX_PRICE: &str = "0x5af3107a4000";
    pub const L2_GAS_MAX_AMOUNT: &str = "0x989680";
    pub const L2_GAS_MAX_PRICE: &str = "0x174876e800";
    pub const L1_DATA_GAS_MAX_AMOUNT: &str = "0x186a0";
    pub const L1_DATA_GAS_MAX_PRICE: &str = "0x5af3107a4000";
