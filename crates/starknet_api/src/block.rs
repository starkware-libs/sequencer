...
pub struct Block {
    // TODO(AlonH): Consider renaming to BlockWithCommitments, for the header use
...
pub struct BlockHeader {
    // TODO(AlonH): Consider removing the block hash from the header (note it can be computed from
    ...
    // TODO(AlonH): Once all environments support these fields, remove the Option (make sure to
