...
pub enum StarknetApiError {
    ...
    #[error("Missing header commitments for block number {block_number} and version {version}")]
    MissingHeaderCommitments { block_number: BlockNumber, version: StarknetVersion },
}
