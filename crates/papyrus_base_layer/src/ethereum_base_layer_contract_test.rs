...
async fn fusaka_blob_fee_sanity_check() {
    ...
    let url = Url::parse("https://sepolia.infura.io/v3/8b40d324598a48a7967a67aa407a76b6").unwrap();
    ...
    let block_header = base_layer.get_block_header(block_number).await.unwrap().unwrap();
    ...
    let url = Url::parse("https://mainnet.infura.io/v3/8b40d324598a48a7967a67aa407a76b6").unwrap();
