...
pub struct BlockMeasurement {
    ...
    pub read_duration: u128,    // Duration of a block facts read (milliseconds).
    pub compute_duration: u128, // Duration of a block new facts computation (milliseconds).
    pub write_duration: u128,   // Duration of a block new facts write (milliseconds).
