...
trait InitialReadContextFromRoots: InputContext {
    fn from_roots(roots: StateRoots) -> Self;
}

impl InitialReadContextFromRoots for FactsDbInitialRead {
    fn from_roots(roots: StateRoots) -> Self {
        Self(roots)
    }
}

impl InitialReadContextFromRoots for IndexDbReadContext {
    fn from_roots(_roots: StateRoots) -> Self {
        Self
    }
}
    ...
    Db::InitialReadContext: InitialReadContextFromRoots,
{
    ...
    input = Input {
        ...
        initial_read_context: InitialReadContextFromRoots::from_roots(filled_forest.state_roots()),
        config: ReaderConfig::default(),
    };
