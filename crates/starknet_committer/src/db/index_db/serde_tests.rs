...
fn edge_node_short_path() -> IndexFilledNode<IndexLayoutContractState> {
    IndexFilledNode(FilledNode {
        hash: HashOutput(Felt::from(1)),
...
#[case::index_layout_edge_node_short_path(edge_node_short_path(), IndexNodeContext { is_leaf: false })]
