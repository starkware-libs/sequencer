...
fn global_contract_cache_update() {
    ...
    let mut casm = CasmContractClass::default();
    // TODO(tzahi): Remove once the default value of compiler version is of a legal value.
    casm.compiler_version = "0.1.0".to_string();
