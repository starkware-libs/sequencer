...
impl PyBlockExecutor {
    ...
    pub fn finalize(
        &mut self,
    ) -> NativeBlockifierResult<(PyStateDiff, Option<PyStateDiff>, Py<PyBytes>, PyClassesWeights)>
    {
        ...
        let py_classes_weights = PyClassesWeights { classes_weights };
        ...
        Ok((py_state_diff, py_compressed_state_diff, raw_block_weights, py_classes_weights))
    }
