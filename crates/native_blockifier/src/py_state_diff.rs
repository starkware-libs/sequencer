    ...
    fn try_from(block_info: PyBlockInfo) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            gas_prices: GasPrices::new(
                NonzeroGasPrice::new(GasPrice(block_info.l1_gas_price.price_in_wei)).map_err(
                    |_| {
                ...
                NonzeroGasPrice::new(GasPrice(block_info.l1_gas_price.price_in_fri)).map_err(
                    |_| {
                        NativeBlockifierInputError::InvalidNativeBlockifierInputError(
                ...
                NonzeroGasPrice::new(GasPrice(block_info.l1_data_gas_price.price_in_wei)).map_err(
                    |_| {
                        NativeBlockifierInputError::InvalidNativeBlockifierInputError(
                ...
                NonzeroGasPrice::new(GasPrice(block_info.l1_data_gas_price.price_in_fri)).map_err(
                    |_| {
                        NativeBlockifierInputError::InvalidNativeBlockifierInputError(
                ...
                NonzeroGasPrice::new(GasPrice(block_info.l2_gas_price.price_in_wei)).map_err(
                    |_| {
                        NativeBlockifierInputError::InvalidNativeBlockifierInputError(
                ...
                NonzeroGasPrice::new(GasPrice(block_info.l2_gas_price.price_in_fri)).map_err(
                    |_| {
                        NativeBlockifierInputError::InvalidNativeBlockifierInputError(
