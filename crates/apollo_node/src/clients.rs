...
use apollo_infra::metrics::{
    RemoteClientMetrics,
    BATCHER_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    CLASS_MANAGER_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    GATEWAY_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    L1_GAS_PRICE_PROVIDER_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    L1_PROVIDER_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    MEMPOOL_P2P_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    MEMPOOL_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    SIERRA_COMPILER_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
    STATE_SYNC_REMOTE_CLIENT_CONNECTION_ATTEMPTS,
};
...
pub fn create_node_clients(
    ...
    let batcher_remote_metrics =
        RemoteClientMetrics::new(&BATCHER_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let class_manager_remote_metrics =
        RemoteClientMetrics::new(&CLASS_MANAGER_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let gateway_remote_metrics =
        RemoteClientMetrics::new(&GATEWAY_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let l1_provider_remote_metrics =
        RemoteClientMetrics::new(&L1_PROVIDER_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let l1_gas_price_provider_remote_metrics =
        RemoteClientMetrics::new(&L1_GAS_PRICE_PROVIDER_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let mempool_remote_metrics =
        RemoteClientMetrics::new(&MEMPOOL_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let mempool_p2p_remote_metrics =
        RemoteClientMetrics::new(&MEMPOOL_P2P_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let sierra_compiler_remote_metrics =
        RemoteClientMetrics::new(&SIERRA_COMPILER_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
    ...
    let state_sync_remote_metrics =
        RemoteClientMetrics::new(&STATE_SYNC_REMOTE_CLIENT_CONNECTION_ATTEMPTS);
