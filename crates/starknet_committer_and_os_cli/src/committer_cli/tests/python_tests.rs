...
pub(crate) fn storage_serialize_test() -> CommitterPythonTestResult {
    let mut storage = StorageHashMap::new();
    for i in 0..=99_u128 {
...
fn test_storage_node(data: HashMap<String, String>) -> CommitterPythonTestResult {
    ...
    let mut rust_fact_storage = StorageHashMap::new();
    ...
    rust_fact_storage.insert(binary_rust.db_key(), binary_rust.serialize());
    ...
    rust_fact_storage.insert(edge_rust.db_key(), edge_rust.serialize());
    ...
    rust_fact_storage.insert(storage_leaf_rust.db_key(), storage_leaf_rust.serialize());
    ...
    rust_fact_storage
        .insert(contract_state_leaf_rust.db_key(), contract_state_leaf_rust.serialize());
    ...
    rust_fact_storage
        .insert(compiled_class_leaf_rust.db_key(), compiled_class_leaf_rust.serialize());
