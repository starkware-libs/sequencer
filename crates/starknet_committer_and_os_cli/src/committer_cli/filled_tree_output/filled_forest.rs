...
use starknet_committer::db::forest_trait::{ForestStorageInitializer, ForestWriter};
...
impl SerializedForest {
    pub async fn forest_to_output(&self) -> SerializationResult<Output> {
        ...
        let mut output_facts_db: FactsDb<MapStorage> =
            ForestStorageInitializer::new(MapStorage::default());
