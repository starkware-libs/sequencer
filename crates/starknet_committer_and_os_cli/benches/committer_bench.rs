...
// starknet_committer_and_os_cli/src/tests/flow_test_files_prefix. In order to update them, generate a new
// random prefix (the hash of the initial new commit can be used) and update it in the mentioned
// file. Then upload the new files to GCS with this new prefix (run e.g.,
