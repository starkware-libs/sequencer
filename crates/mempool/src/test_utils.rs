...
macro_rules! tx {
    ...
    (tip: $tip:expr, address: $address:expr, tx_nonce: $tx_nonce:expr,
    ...
    (tx_hash: $tx_hash:expr, tx_nonce: $tx_nonce:expr) => {
        tx!(tx_hash: $tx_hash, address: "0x0", tx_nonce: $tx_nonce)
    };
    (address: $address:expr, tx_nonce: $tx_nonce:expr) => {
        tx!(tx_hash: 0, address: $address, tx_nonce: $tx_nonce)
    };
    (tx_nonce: $tx_nonce:expr) => {
        tx!(address: "0x0", tx_nonce: $tx_nonce)
    };
    () => {
        tx!(tx_nonce: 0)
    };
