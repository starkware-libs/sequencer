...
impl From<MempoolContent> for Mempool {
    fn from(mempool_content: MempoolContent) -> Mempool {
        ...
        Mempool {
            ...
            _fee_escalation_percentage: fee_escalation_percentage,
        }
    }
}
...
fn test_fee_escalation() {
    ...
    // Setup.
    let input = add_tx_input!(tx_hash: 1, tip: 90, max_l2_gas_price: 90, tx_nonce: 1,
        sender_address: "0x0");
    let valid_replacement_input = add_tx_input!(tx_hash: 2, tip: 100, max_l2_gas_price: 100,
