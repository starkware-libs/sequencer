...
fn test_add_tx_insertion_sorted_by_priority(mut mempool: Mempool) {
    ...
    // Test.
    for input in
        [&input_smallest_tip_smallest_hash, &input_big_tip_small_hash, &input_small_tip_big_hash]
    {
    ...
    let expected_queue_txs = [
        &input_big_tip_small_hash.tx,
        &input_small_tip_big_hash.tx,
        &input_smallest_tip_smallest_hash.tx,
    ]
