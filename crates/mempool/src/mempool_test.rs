...
#[rstest]
fn test_get_txs_from_priority_queue_with_replenishment_between_chunks() {
    // Setup.
    ...
    let pending_tx_address_0_nonce_2 = tx!(tip: 22, tx_hash: 3, sender_address: "0x0", tx_nonce: 1,
        max_l2_gas_price: 99);
    let priority_tx_address_0_nonce_3 = tx!(tip: 23, tx_hash: 4, sender_address: "0x0", tx_nonce: 2,
