...
impl MempoolContent<FullContent> {
    fn _new<P, Q>(pool_txs: P, queue_txs: Q) -> Self
    where
...
impl MempoolContent<PartialContent> {
    ...
    // Note that this function currently represents a full state. It's a preliminary step;
    // account nonces will be added to the mempool, making it a partial state.
