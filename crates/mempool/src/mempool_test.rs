...
fn test_get_txs_replenishes_queue_only_between_chunks() {
    ...
    let pending_tx_address_0_nonce_1 = tx!(tip: 20, tx_hash: 2, sender_address: "0x0", tx_nonce: 1,
        max_l2_gas_price: 99);
    let priority_tx_address_0_nonce_2 = tx!(tip: 20, tx_hash: 3, sender_address: "0x0", tx_nonce: 2,
        max_l2_gas_price: 100);
    let priority_tx_address_1_nonce_0 = tx!(tip: 10, tx_hash: 4, sender_address: "0x1", tx_nonce: 0,
        max_l2_gas_price: 100);
