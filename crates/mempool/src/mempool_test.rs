...
#[rstest]
fn test_add_tx_correctly_places_txs_in_pool_or_queues() {
    // Setup.
    let priority_tx_input_address_0_nonce_0 = add_tx_input!(tx_hash: 1, sender_address: "0x0",
        tx_nonce: 0, account_nonce: 0, max_l2_gas_price: 100);
    let priority_tx_input_address_0_nonce_1 = add_tx_input!(tx_hash: 3, sender_address: "0x0",
        tx_nonce: 1, account_nonce: 0, max_l2_gas_price: 100);
