...
fn test_add_tx_multi_nonce_success() {
    ...
    let pending_tx_input_address_1_nonce_0 = add_tx_input!(tx_hash: 2, sender_address: "0x1", tx_nonce: 0,account_nonce: 0, max_l2_gas_price: VALID_L2_GAS_MAX_PRICE_PER_UNIT - 1);
