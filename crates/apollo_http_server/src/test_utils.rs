...
use apollo_config_manager_types::communication::MockConfigManagerClientWithChannel;
...
pub struct HttpClientServerSetupBuilder {
    ...
    mock_config_manager_client_with_channel: Option<MockConfigManagerClientWithChannel>,
...
impl HttpClientServerSetupBuilder {
    ...
    fn new_from_http_server_config(http_server_config: HttpServerConfig) -> Self {
        Self {
            http_server_config,
            mock_config_manager_client_with_channel: None,
    ...
    pub fn with_mock_config_manager_client_with_channel(
        mut self,
        mock: MockConfigManagerClientWithChannel,
    ) -> Self {
        self.mock_config_manager_client_with_channel = Some(mock);
        self
    }
    ...
    pub async fn build(self) -> HttpTestClient {
        let config_manager_client_with_channel = Arc::new(
            self.mock_config_manager_client_with_channel
                .unwrap_or_else(|| get_mock_config_manager_client_with_channel(true)),
        );
        ...
        loop {
            ...
            let mut http_server = HttpServer::new(
                ...
                config_manager_client_with_channel.clone(),
...
pub fn get_mock_config_manager_client_with_channel(
    accept_new_txs: bool,
) -> MockConfigManagerClientWithChannel {
    let mut mock = MockConfigManagerClientWithChannel::new();
