...
use apollo_config_manager_types::communication::SharedConfigManagerClientWithChannel;
...
pub struct AppState {
    ...
    config_manager_client_with_channel: SharedConfigManagerClientWithChannel,
}

impl AppState {
    fn get_dynamic_config(&self) -> HttpServerDynamicConfig {
        self.config_manager_client_with_channel.get_http_server_dynamic_config().unwrap()
    }
}
...
impl HttpServer {
    pub fn new(
        ...
        let app_state = AppState { gateway_client, config_manager_client_with_channel };
...
pub fn create_http_server(
    ...
    HttpServer::new(config, config_manager_client_with_channel, gateway_client)
}
