...
impl HttpServer {
    pub fn new(
        ...
        let app_state =
            AppState { gateway_client, config_manager_client_with_channel, dynamic_config_rx };
