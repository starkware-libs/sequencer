...
use papyrus_consensus_orchestrator::sequencer_consensus_context::{
    ProposalPartWithTxHash,
...
use papyrus_protobuf::consensus::{ConsensusMessage, StreamMessage};
...
impl ConsensusManager {
    ...
    pub async fn run(&self) -> Result<(), ConsensusError> {
        ...
        let proposals_broadcast_channels = network_manager
            .register_broadcast_topic::<StreamMessage<ProposalPartWithTxHash>>(
