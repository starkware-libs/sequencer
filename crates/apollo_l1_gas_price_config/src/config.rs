...
use apollo_config::converters::{
    ...
    serialize_optional_sensitive_list_with_url_and_headers,
    UrlAndHeaders,
};
...
pub struct ExchangeRateOracleConfig {
    #[serde(
        serialize_with = "serialize_optional_sensitive_list_with_url_and_headers",
        deserialize_with = "deserialize_optional_sensitive_list_with_url_and_headers"
    )]
