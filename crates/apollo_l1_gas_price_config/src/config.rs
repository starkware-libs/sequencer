...
/// Bounds on a pair an oracle quotes directly.
#[derive(Clone, Debug, Deserialize, Serialize, PartialEq, Validate)]
pub struct QuotedRateBoundsConfig {
    pub minimum_micro_units: u64,
    pub maximum_micro_units: u64,
}

impl QuotedRateBoundsConfig {
...
impl SerializeConfig for QuotedRateBoundsConfig {
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        BTreeMap::from_iter([
            ser_param(
                "minimum_micro_units",
...
/// Bounds on a pair derived from two quoted pairs.
#[derive(Clone, Debug, Deserialize, Serialize, PartialEq, Validate)]
pub struct DerivedRateBoundsConfig {
    pub minimum_micro_units: u64,
    pub maximum_micro_units: u64,
}

impl DerivedRateBoundsConfig {
    fn bounds(&self, pair: CurrencyPair) -> RateBounds {
        RateBounds {
            minimum_micro_units: self.minimum_micro_units,
            maximum_micro_units: self.maximum_micro_units,
...
impl SerializeConfig for DerivedRateBoundsConfig {
    fn dump(&self) -> BTreeMap<ParamPath, SerializedParam> {
        BTreeMap::from_iter([
            ser_param(
                "minimum_micro_units",
...
pub struct RateBoundsConfig {
    /// Micro-USD per ETH.
    #[validate(nested)]
    pub eth_usd: QuotedRateBoundsConfig,
    /// Micro-USD per STRK.
    #[validate(nested)]
    pub strk_usd: QuotedRateBoundsConfig,
    /// Micro-STRK per ETH.
    #[validate(nested)]
    pub eth_to_fri: DerivedRateBoundsConfig,
}
