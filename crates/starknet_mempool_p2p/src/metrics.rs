...
define_metrics!(
    MempoolP2p => {
        ...
        // Histogram
        MetricHistogram { MEMPOOL_P2P_BROADCASTED_BATCH_SIZE, "apollo_mempool_p2p_broadcast_transaction_batch_size", "The number of transactions in batches broadcasted by the mempool p2p component" }
    },
);
