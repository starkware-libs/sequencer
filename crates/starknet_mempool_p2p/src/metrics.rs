...
define_metrics!(
    MempoolP2p => {
        ...
        // Histogram
        MetricHistogram { MEMPOOL_P2P_BROADCASTED_BATCH_SIZE, "apollo_mempool_p2p_broadcast_transaction_batch_size", "A histogram of the number of transactions in each batch broadcasted by the mempool p2p component" }
    },
);
