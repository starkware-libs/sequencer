...
fn get_sierra_version_from_program<F>(sierra_program: &[F]) -> VersionId
where
...
pub(crate) fn load_sierra_program_from_file(path: &PathBuf) -> (ContractClass, Program, VersionId) {
