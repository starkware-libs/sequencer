...
# Sync the bootloader from proving-utils into starknet_tx_prover resources.
sync_bootloader() {
    ...
    local dst="${REPO_ROOT}/crates/starknet_tx_prover/resources/simple_bootloader_compiled.json"
