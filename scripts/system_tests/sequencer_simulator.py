...
def run_simulator(http_port, monitoring_port):
    cmd = [
...
def main(deployment_config_path, config_dir, node_type_str):
    ...
    exit_code = run_simulator(http_server_port, state_sync_port)
...
if __name__ == "__main__":
    ...
    main(args.deployment_config_path, args.config_dir, args.node_type)
