...
def _update_config(
    ...
    Args:
        config_values_updater: The updater to modify configuration values
        namespace_and_instruction_args: Namespace and cluster information
        service: The service to update

    Returns:
        List of dictionaries containing original and updated configs
    """
