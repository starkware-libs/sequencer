...
SEQUENCER_INTEGRATION_TEST_NAMES: List[str] = [
    ...
    # TODO(AndrewL): bring back these tests
...
class BaseCommand(Enum):
    ...
    def cmds(self, crates: Set[str], is_nightly: bool) -> List[List[str]]:
        ...
        # TODO(AndrewL): Consider removing this and compiling in the CI workflow instead
            ...
            test_list = json.dumps(SEQUENCER_INTEGRATION_TEST_NAMES)
