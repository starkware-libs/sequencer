...
PROJECT_TO_CRATES = {
    ...
    "committer": ["committer", "committer_cli", "starknet_committer", "starknet_patricia"],
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--project", choices=PROJECT_NAMES, help="The project that the changelog is generated for."
    )
