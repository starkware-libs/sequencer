...
def ist_to_utc(ist_time: datetime) -> datetime:
    ...
    Handles DST automatically using zoneinfo.
    """
    israel_tz = ZoneInfo("Asia/Jerusalem")
    ist_aware = ist_time.replace(tzinfo=israel_tz)
...
def compute_window(
    ...
    if args.near:
        near_ts = ist_to_utc(parse_rfc3339(args.near))
    ...
    if args.start or args.end:
        ...
        return ist_to_utc(parse_rfc3339(args.start)), ist_to_utc(parse_rfc3339(args.end))
