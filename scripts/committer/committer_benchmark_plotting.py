...
class BenchmarkData:
    ...
    def _create_figure(self) -> go.Figure:
        read_duration_per_read_fact = self._duration_per_fact(self.read_duration_millis, self.n_read_facts)
        read_duration_per_new_fact = self._duration_per_fact(self.read_duration_millis, self.n_new_facts)
        compute_duration_per_new_fact = self._duration_per_fact(self.compute_duration_millis, self.n_new_facts)
        write_duration_per_new_fact = self._duration_per_fact(self.write_duration_millis, self.n_new_facts)
        total_duration_per_new_fact = self._duration_per_fact(self.block_duration_millis, self.n_new_facts)
